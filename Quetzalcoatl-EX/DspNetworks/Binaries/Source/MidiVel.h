...
template <int NV>
using MidiVel_t_ = container::chain<parameter::empty, 
                                    wrap::fix<2, midi_t<NV>>, 
                                    routing::public_mod>;

// ========================| Root node initialiser class |========================

template <int NV> struct instance:  public MidiVel_impl::MidiVel_t_<NV>,
                                    public routing::public_mod_target
{
	...
	instance()
	{
		...
		auto& midi = this->getT(0);       // MidiVel_impl::midi_t<NV>
...
template <int NV>
using MidiVel = wrap::node<MidiVel_impl::instance<NV>>;
}
