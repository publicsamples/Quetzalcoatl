...
inline function onTrigMode2Control(component, value)
{
	...
	if(value == 0)
	{
//	FmGain.setAttribute(FmGain.one, 0);
...
//	FmGain.setAttribute(FmGain.one, 1);
...
inline function onsync2Control(component, value)
{
	if(value == 0)
	{
//	FmGain.setAttribute(FmGain.sync, 1);
...
const var PolyMod1 = Content.getComponent("PolyMod1");
const var PolyMod2 = Content.getComponent("PolyMod2");
const var PolyMod3 = Content.getComponent("PolyMod3");




inline function onXFbuttonControl(component, value)
{
	 PolyMod1.showControl(1);  
     PolyMod2.showControl(0);   
     PolyMod3.showControl(0); 
};

Content.getComponent("XFbutton").setControlCallback(onXFbuttonControl);


inline function onFilterModsControl(component, value)
{
	 PolyMod1.showControl(0);  
     PolyMod2.showControl(0);   
     PolyMod3.showControl(1); 
};

Content.getComponent("FilterMods").setControlCallback(onFilterModsControl);


inline function onFmGControl(component, value)
{
	PolyMod1.showControl(0);  
     PolyMod2.showControl(1);   
     PolyMod3.showControl(0); 
};

Content.getComponent("FmG").setControlCallback(onFmGControl);
