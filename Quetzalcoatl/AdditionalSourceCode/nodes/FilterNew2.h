...
DECLARE_PARAMETER_RANGE(sliderbank_c1Range, 
                        5.55112e-17, 
                        1.);

template <int NV>
using sliderbank_c1 = parameter::from0To1<pma8_t<NV>, 
                                          2, 
                                          sliderbank_c1Range>;
...
namespace FilterNew2_t_parameters
{
// Parameter list for FilterNew2_impl::FilterNew2_t ------------------------------------------------
...
template <int NV>
using _3rdParam_0 = parameter::from0To1<FilterNew2_impl::event_data_reader6_t<NV>, 
                                        0, 
                                        _3rdParam_0Range>;
...
using _3rdParam = parameter::chain<_3rdParam_InputRange, 
                                   _3rdParam_0<NV>, 
                                   parameter::plain<FilterNew2_impl::cable_table9_t<NV>, 0>, 
                                   parameter::plain<FilterNew2_impl::cable_table10_t<NV>, 0>>;
...
using _5thParam = parameter::chain<_5thParam_InputRange, 
                                   parameter::plain<FilterNew2_impl::switcher_t<NV>, 0>, 
                                   parameter::plain<FilterNew2_impl::switcher4_t<NV>, 0>>;
...
DECLARE_PARAMETER_RANGE_STEP(GlobalSrc_InputRange, 
                             ...
                             1.);
template <int NV>
using GlobalSrc_0 = parameter::from0To1<FilterNew2_impl::event_data_reader4_t<NV>, 
                                        0, 
                                        _3rdParam_0Range>;
...
using GlobalSrc = parameter::chain<GlobalSrc_InputRange, 
                                   GlobalSrc_0<NV>, 
                                   parameter::plain<FilterNew2_impl::cable_table6_t<NV>, 0>, 
                                   parameter::plain<FilterNew2_impl::cable_table5_t<NV>, 0>>;
...
DECLARE_PARAMETER_RANGE_STEP(StageModSrc_InputRange, 
                             ...
                             1.);
template <int NV>
using StageModSrc_0 = parameter::from0To1<FilterNew2_impl::event_data_reader5_t<NV>, 
                                          0, 
                                          _3rdParam_0Range>;
...
using StageModSrc = parameter::chain<StageModSrc_InputRange, 
                                     StageModSrc_0<NV>, 
                                     parameter::plain<FilterNew2_impl::cable_table7_t<NV>, 0>, 
                                     parameter::plain<FilterNew2_impl::cable_table8_t<NV>, 0>>;

template <int NV>
using Stage1 = parameter::chain<ranges::Identity, 
                                parameter::plain<FilterNew2_impl::pma10_t<NV>, 2>, 
                                parameter::plain<FilterNew2_impl::pma13_t<NV>, 2>>;

template <int NV>
using Stage2 = parameter::chain<ranges::Identity, 
                                parameter::plain<FilterNew2_impl::pma10_t<NV>, 1>, 
                                parameter::plain<FilterNew2_impl::pma13_t<NV>, 1>>;
...
DECLARE_PARAMETER_RANGE_STEP(Stage3_InputRange, 
                             ...
                             1.);
template <int NV>
using Stage3_2 = parameter::from0To1<FilterNew2_impl::event_data_reader7_t<NV>, 
                                     0, 
                                     _3rdParam_0Range>;

template <int NV>
using Stage3 = parameter::chain<Stage3_InputRange, 
                                parameter::plain<FilterNew2_impl::cable_table11_t<NV>, 0>, 
                                parameter::plain<FilterNew2_impl::cable_table12_t<NV>, 0>, 
                                Stage3_2<NV>>;

template <int NV>
using FoldSub = parameter::chain<ranges::Identity, 
                                 parameter::plain<FilterNew2_impl::branch_t<NV>, 0>, 
                                 parameter::plain<FilterNew2_impl::branch6_t<NV>, 0>>;
...
DECLARE_PARAMETER_RANGE_STEP(RangeSrx_InputRange, 
                             ...
                             1.);
template <int NV>
using RangeSrx_0 = parameter::from0To1<FilterNew2_impl::event_data_reader8_t<NV>, 
                                       0, 
                                       _3rdParam_0Range>;
...
using RangeSrx = parameter::chain<RangeSrx_InputRange, 
                                  RangeSrx_0<NV>, 
                                  parameter::plain<FilterNew2_impl::cable_table13_t<NV>, 0>, 
                                  parameter::plain<FilterNew2_impl::cable_table14_t<NV>, 0>>;

template <int NV>
using FoldSmooth = parameter::chain<ranges::Identity, 
                                    parameter::plain<FilterNew2_impl::smoothed_parameter_t<NV>, 1>, 
                                    parameter::plain<FilterNew2_impl::smoothed_parameter6_t<NV>, 1>>;

template <int NV>
using MainParam = parameter::plain<FilterNew2_impl::pma7_t<NV>, 
                                   2>;
template <int NV>
using _4thParam = parameter::plain<FilterNew2_impl::pma9_t<NV>, 
                                   1>;
template <int NV>
using Global = parameter::plain<FilterNew2_impl::pma7_t<NV>, 
                                1>;
template <int NV>
using Vel = parameter::plain<FilterNew2_impl::pma3_t<NV>, 
                             1>;
template <int NV>
using Trk = parameter::plain<FilterNew2_impl::pma4_t<NV>, 
                             1>;
template <int NV>
using MW = parameter::plain<FilterNew2_impl::pma5_t<NV>, 
                            1>;
template <int NV>
using AT = parameter::plain<FilterNew2_impl::pma6_t<NV>, 
                            1>;
template <int NV>
using StageMod = parameter::plain<FilterNew2_impl::pma8_t<NV>, 
                                  1>;
template <int NV>
using FoldOffset = parameter::plain<FilterNew2_impl::pma1_t<NV>, 
                                    2>;
using NumSliders = parameter::plain<FilterNew2_impl::pack_resizer1_t, 
                                    0>;
template <int NV>
using Fold = parameter::plain<FilterNew2_impl::pma9_t<NV>, 
                              2>;
template <int NV>
using FoldPos = parameter::plain<FilterNew2_impl::switcher1_t<NV>, 
                                 0>;
template <int NV>
using RangeMod = parameter::plain<FilterNew2_impl::pma1_t<NV>, 
                                  1>;
template <int NV>
using FreqSteps = parameter::plain<FilterNew2_impl::minmax2_t<NV>, 
                                   4>;
template <int NV>
using FilterNew2_t_plist = parameter::list<MainParam<NV>, 
                                           _2ndParam<NV>, 
                                           _3rdParam<NV>, 
                                           _4thParam<NV>, 
                                           _5thParam<NV>, 
...
template <int NV>
using FilterNew2_t_ = container::chain<FilterNew2_t_parameters::FilterNew2_t_plist<NV>, 
...
template <int NV> struct instance: public FilterNew2_impl::FilterNew2_t_<NV>
{
	...
	instance()
	{
		...
		auto& modchain = this->getT(0);                                                           // FilterNew2_impl::modchain_t<NV>
		auto& split19 = this->getT(0).getT(0);                                                    // FilterNew2_impl::split19_t<NV>
		auto& pma = this->getT(0).getT(0).getT(0);                                                // FilterNew2_impl::pma_t<NV>
		auto& split7 = this->getT(0).getT(0).getT(1);                                             // FilterNew2_impl::split7_t<NV>
		auto& chain5 = this->getT(0).getT(0).getT(1).getT(0);                                     // FilterNew2_impl::chain5_t<NV>
		auto& midi = this->getT(0).getT(0).getT(1).getT(0).getT(0);                               // FilterNew2_impl::midi_t<NV>
		auto& pma3 = this->getT(0).getT(0).getT(1).getT(0).getT(1);                               // FilterNew2_impl::pma3_t<NV>
		auto& chain6 = this->getT(0).getT(0).getT(1).getT(1);                                     // FilterNew2_impl::chain6_t<NV>
		auto& midi1 = this->getT(0).getT(0).getT(1).getT(1).getT(0);                              // FilterNew2_impl::midi1_t<NV>
		auto& pma4 = this->getT(0).getT(0).getT(1).getT(1).getT(1);                               // FilterNew2_impl::pma4_t<NV>
		auto& chain9 = this->getT(0).getT(0).getT(1).getT(2);                                     // FilterNew2_impl::chain9_t<NV>
		auto& midi_cc = this->getT(0).getT(0).getT(1).getT(2).getT(0);                            // FilterNew2_impl::midi_cc_t<NV>
		auto& pma5 = this->getT(0).getT(0).getT(1).getT(2).getT(1);                               // FilterNew2_impl::pma5_t<NV>
		auto& chain14 = this->getT(0).getT(0).getT(1).getT(3);                                    // FilterNew2_impl::chain14_t<NV>
		auto& midi_cc1 = this->getT(0).getT(0).getT(1).getT(3).getT(0);                           // FilterNew2_impl::midi_cc1_t<NV>
		auto& pma6 = this->getT(0).getT(0).getT(1).getT(3).getT(1);                               // FilterNew2_impl::pma6_t<NV>
		auto& chain10 = this->getT(0).getT(0).getT(1).getT(4);                                    // FilterNew2_impl::chain10_t<NV>
		auto& cable_table11 = this->getT(0).getT(0).getT(1).getT(4).getT(0);                      // FilterNew2_impl::cable_table11_t<NV>
		auto& cable_table12 = this->getT(0).getT(0).getT(1).getT(4).getT(1);                      // FilterNew2_impl::cable_table12_t<NV>
		auto& split6 = this->getT(0).getT(0).getT(1).getT(4).getT(2);                             // FilterNew2_impl::split6_t<NV>
		auto& event_data_reader7 = this->getT(0).getT(0).getT(1).getT(4).getT(2).getT(0);         // FilterNew2_impl::event_data_reader7_t<NV>
		auto& chain19 = this->getT(0).getT(0).getT(1).getT(4).getT(2).getT(1);                    // FilterNew2_impl::chain19_t<NV>
		auto& branch2 = this->getT(0).getT(0).getT(1).getT(4).getT(2).getT(1).getT(0);            // FilterNew2_impl::branch2_t<NV>
		auto& chain20 = this->getT(0).getT(0).getT(1).getT(4).                                    // FilterNew2_impl::chain20_t<NV>
                        getT(2).getT(1).getT(0).getT(0);
		auto& global_cable8 = this->getT(0).getT(0).getT(1).getT(4).                              // FilterNew2_impl::global_cable8_t<NV>
                              getT(2).getT(1).getT(0).getT(0).
                              getT(0);
		auto& add8 = this->getT(0).getT(0).getT(1).getT(4).                                       // math::add<NV>
                     getT(2).getT(1).getT(0).getT(0).
                     getT(1);
		auto& chain21 = this->getT(0).getT(0).getT(1).getT(4).                                    // FilterNew2_impl::chain21_t<NV>
                        getT(2).getT(1).getT(0).getT(1);
		auto& global_cable9 = this->getT(0).getT(0).getT(1).getT(4).                              // FilterNew2_impl::global_cable9_t<NV>
                              getT(2).getT(1).getT(0).getT(1).
                              getT(0);
		auto& add9 = this->getT(0).getT(0).getT(1).getT(4).                                       // math::add<NV>
                     getT(2).getT(1).getT(0).getT(1).
                     getT(1);
		auto& chain22 = this->getT(0).getT(0).getT(1).getT(4).                                    // FilterNew2_impl::chain22_t<NV>
                        getT(2).getT(1).getT(0).getT(2);
		auto& global_cable10 = this->getT(0).getT(0).getT(1).getT(4).                             // FilterNew2_impl::global_cable10_t<NV>
                               getT(2).getT(1).getT(0).getT(2).
                               getT(0);
		auto& add10 = this->getT(0).getT(0).getT(1).getT(4).                                      // math::add<NV>
                      getT(2).getT(1).getT(0).getT(2).
                      getT(1);
		auto& chain23 = this->getT(0).getT(0).getT(1).getT(4).                                    // FilterNew2_impl::chain23_t<NV>
                        getT(2).getT(1).getT(0).getT(3);
		auto& global_cable11 = this->getT(0).getT(0).getT(1).getT(4).                             // FilterNew2_impl::global_cable11_t<NV>
                               getT(2).getT(1).getT(0).getT(3).
                               getT(0);
		auto& add11 = this->getT(0).getT(0).getT(1).getT(4).                                      // math::add<NV>
                      getT(2).getT(1).getT(0).getT(3).
                      getT(1);
		auto& chain24 = this->getT(0).getT(0).getT(1).getT(4).                                    // FilterNew2_impl::chain24_t<NV>
                        getT(2).getT(1).getT(0).getT(4);
		auto& global_cable12 = this->getT(0).getT(0).getT(1).getT(4).                             // FilterNew2_impl::global_cable12_t<NV>
                               getT(2).getT(1).getT(0).getT(4).
                               getT(0);
		auto& add12 = this->getT(0).getT(0).getT(1).getT(4).                                      // math::add<NV>
                      getT(2).getT(1).getT(0).getT(4).
                      getT(1);
		auto& chain26 = this->getT(0).getT(0).getT(1).getT(4).                                    // FilterNew2_impl::chain26_t<NV>
                        getT(2).getT(1).getT(0).getT(5);
		auto& global_cable13 = this->getT(0).getT(0).getT(1).getT(4).                             // FilterNew2_impl::global_cable13_t<NV>
                               getT(2).getT(1).getT(0).getT(5).
                               getT(0);
		auto& add13 = this->getT(0).getT(0).getT(1).getT(4).                                      // math::add<NV>
                      getT(2).getT(1).getT(0).getT(5).
                      getT(1);
		auto& chain27 = this->getT(0).getT(0).getT(1).getT(4).                                    // FilterNew2_impl::chain27_t<NV>
                        getT(2).getT(1).getT(0).getT(6);
		auto& global_cable14 = this->getT(0).getT(0).getT(1).getT(4).                             // FilterNew2_impl::global_cable14_t<NV>
                               getT(2).getT(1).getT(0).getT(6).
                               getT(0);
		auto& add14 = this->getT(0).getT(0).getT(1).getT(4).                                      // math::add<NV>
                      getT(2).getT(1).getT(0).getT(6).
                      getT(1);
		auto& chain28 = this->getT(0).getT(0).getT(1).getT(4).                                    // FilterNew2_impl::chain28_t<NV>
                        getT(2).getT(1).getT(0).getT(7);
		auto& global_cable15 = this->getT(0).getT(0).getT(1).getT(4).                             // FilterNew2_impl::global_cable15_t<NV>
                               getT(2).getT(1).getT(0).getT(7).
                               getT(0);
		auto& add15 = this->getT(0).getT(0).getT(1).getT(4).                                      // math::add<NV>
                      getT(2).getT(1).getT(0).getT(7).
                      getT(1);
		auto& peak1 = this->getT(0).getT(0).getT(1).getT(4).getT(2).getT(1).getT(1);              // FilterNew2_impl::peak1_t<NV>
		auto& clear2 = this->getT(0).getT(0).getT(1).getT(4).getT(2).getT(1).getT(2);             // math::clear<NV>
		auto& input_toggle1 = this->getT(0).getT(0).getT(1).getT(4).getT(3);                      // FilterNew2_impl::input_toggle1_t<NV>
		auto& chain25 = this->getT(0).getT(0).getT(1).getT(5);                                    // FilterNew2_impl::chain25_t<NV>
		auto& chain3 = this->getT(0).getT(0).getT(1).getT(5).getT(0);                             // FilterNew2_impl::chain3_t<NV>
		auto& cable_table5 = this->getT(0).getT(0).getT(1).getT(5).getT(0).getT(0);               // FilterNew2_impl::cable_table5_t<NV>
		auto& cable_table6 = this->getT(0).getT(0).getT(1).getT(5).getT(0).getT(1);               // FilterNew2_impl::cable_table6_t<NV>
		auto& split3 = this->getT(0).getT(0).getT(1).getT(5).getT(0).getT(2);                     // FilterNew2_impl::split3_t<NV>
		auto& event_data_reader4 = this->getT(0).getT(0).getT(1).getT(5).getT(0).getT(2).getT(0); // FilterNew2_impl::event_data_reader4_t<NV>
		auto& chain38 = this->getT(0).getT(0).getT(1).getT(5).getT(0).getT(2).getT(1);            // FilterNew2_impl::chain38_t<NV>
		auto& branch4 = this->getT(0).getT(0).getT(1).getT(5).                                    // FilterNew2_impl::branch4_t<NV>
                        getT(0).getT(2).getT(1).getT(0);
		auto& chain39 = this->getT(0).getT(0).getT(1).getT(5).                             // FilterNew2_impl::chain39_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(0);
		auto& global_cable24 = this->getT(0).getT(0).getT(1).getT(5).getT(0).              // FilterNew2_impl::global_cable24_t<NV>
		...
		auto& chain40 = this->getT(0).getT(0).getT(1).getT(5).                             // FilterNew2_impl::chain40_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(1);
		auto& global_cable25 = this->getT(0).getT(0).getT(1).getT(5).getT(0).              // FilterNew2_impl::global_cable25_t<NV>
		...
		auto& chain41 = this->getT(0).getT(0).getT(1).getT(5).                             // FilterNew2_impl::chain41_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(2);
		auto& global_cable26 = this->getT(0).getT(0).getT(1).getT(5).getT(0).              // FilterNew2_impl::global_cable26_t<NV>
		...
		auto& chain42 = this->getT(0).getT(0).getT(1).getT(5).                             // FilterNew2_impl::chain42_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(3);
		auto& global_cable27 = this->getT(0).getT(0).getT(1).getT(5).getT(0).              // FilterNew2_impl::global_cable27_t<NV>
		...
		auto& chain43 = this->getT(0).getT(0).getT(1).getT(5).                             // FilterNew2_impl::chain43_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(4);
		auto& global_cable28 = this->getT(0).getT(0).getT(1).getT(5).getT(0).              // FilterNew2_impl::global_cable28_t<NV>
		...
		auto& chain44 = this->getT(0).getT(0).getT(1).getT(5).                             // FilterNew2_impl::chain44_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(5);
		auto& global_cable29 = this->getT(0).getT(0).getT(1).getT(5).getT(0).              // FilterNew2_impl::global_cable29_t<NV>
		...
		auto& chain45 = this->getT(0).getT(0).getT(1).getT(5).                             // FilterNew2_impl::chain45_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(6);
		auto& global_cable30 = this->getT(0).getT(0).getT(1).getT(5).getT(0).              // FilterNew2_impl::global_cable30_t<NV>
		...
		auto& chain46 = this->getT(0).getT(0).getT(1).getT(5).                             // FilterNew2_impl::chain46_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(7);
		auto& global_cable31 = this->getT(0).getT(0).getT(1).getT(5).getT(0).              // FilterNew2_impl::global_cable31_t<NV>
		...
		auto& peak3 = this->getT(0).getT(0).getT(1).getT(5).                               // FilterNew2_impl::peak3_t<NV>
                      getT(0).getT(2).getT(1).getT(1);
		auto& input_toggle3 = this->getT(0).getT(0).getT(1).getT(5).getT(0).getT(3);       // FilterNew2_impl::input_toggle3_t<NV>
		auto& pma7 = this->getT(0).getT(0).getT(1).getT(5).getT(1);                        // FilterNew2_impl::pma7_t<NV>
		auto& chain7 = this->getT(0).getT(0).getT(2);                                      // FilterNew2_impl::chain7_t<NV>
		auto& pack_resizer1 = this->getT(0).getT(0).getT(2).getT(0);                       // FilterNew2_impl::pack_resizer1_t
		auto& sliderbank = this->getT(0).getT(0).getT(2).getT(1);                          // FilterNew2_impl::sliderbank_t<NV>
		auto& cable_table7 = this->getT(0).getT(0).getT(2).getT(2);                        // FilterNew2_impl::cable_table7_t<NV>
		auto& cable_table8 = this->getT(0).getT(0).getT(2).getT(3);                        // FilterNew2_impl::cable_table8_t<NV>
		auto& split4 = this->getT(0).getT(0).getT(2).getT(4);                              // FilterNew2_impl::split4_t<NV>
		auto& event_data_reader5 = this->getT(0).getT(0).getT(2).getT(4).getT(0);          // FilterNew2_impl::event_data_reader5_t<NV>
		auto& chain29 = this->getT(0).getT(0).getT(2).getT(4).getT(1);                     // FilterNew2_impl::chain29_t<NV>
		auto& branch3 = this->getT(0).getT(0).getT(2).getT(4).getT(1).getT(0);             // FilterNew2_impl::branch3_t<NV>
		auto& chain30 = this->getT(0).getT(0).getT(2).getT(4).getT(1).getT(0).getT(0);     // FilterNew2_impl::chain30_t<NV>
		auto& global_cable16 = this->getT(0).getT(0).getT(2).getT(4).                      // FilterNew2_impl::global_cable16_t<NV>
                               getT(1).getT(0).getT(0).getT(0);
		auto& add16 = this->getT(0).getT(0).getT(2).getT(4).                               // math::add<NV>
                      getT(1).getT(0).getT(0).getT(1);
		auto& chain31 = this->getT(0).getT(0).getT(2).getT(4).getT(1).getT(0).getT(1);     // FilterNew2_impl::chain31_t<NV>
		auto& global_cable17 = this->getT(0).getT(0).getT(2).getT(4).                      // FilterNew2_impl::global_cable17_t<NV>
                               getT(1).getT(0).getT(1).getT(0);
		auto& add17 = this->getT(0).getT(0).getT(2).getT(4).                               // math::add<NV>
                      getT(1).getT(0).getT(1).getT(1);
		auto& chain32 = this->getT(0).getT(0).getT(2).getT(4).getT(1).getT(0).getT(2);     // FilterNew2_impl::chain32_t<NV>
		auto& global_cable18 = this->getT(0).getT(0).getT(2).getT(4).                      // FilterNew2_impl::global_cable18_t<NV>
                               getT(1).getT(0).getT(2).getT(0);
		auto& add18 = this->getT(0).getT(0).getT(2).getT(4).                               // math::add<NV>
                      getT(1).getT(0).getT(2).getT(1);
		auto& chain33 = this->getT(0).getT(0).getT(2).getT(4).getT(1).getT(0).getT(3);     // FilterNew2_impl::chain33_t<NV>
		auto& global_cable19 = this->getT(0).getT(0).getT(2).getT(4).                      // FilterNew2_impl::global_cable19_t<NV>
                               getT(1).getT(0).getT(3).getT(0);
		auto& add19 = this->getT(0).getT(0).getT(2).getT(4).                               // math::add<NV>
                      getT(1).getT(0).getT(3).getT(1);
		auto& chain34 = this->getT(0).getT(0).getT(2).getT(4).getT(1).getT(0).getT(4);     // FilterNew2_impl::chain34_t<NV>
		auto& global_cable20 = this->getT(0).getT(0).getT(2).getT(4).                      // FilterNew2_impl::global_cable20_t<NV>
                               getT(1).getT(0).getT(4).getT(0);
		auto& add20 = this->getT(0).getT(0).getT(2).getT(4).                               // math::add<NV>
                      getT(1).getT(0).getT(4).getT(1);
		auto& chain35 = this->getT(0).getT(0).getT(2).getT(4).getT(1).getT(0).getT(5);     // FilterNew2_impl::chain35_t<NV>
		auto& global_cable21 = this->getT(0).getT(0).getT(2).getT(4).                      // FilterNew2_impl::global_cable21_t<NV>
                               getT(1).getT(0).getT(5).getT(0);
		auto& add21 = this->getT(0).getT(0).getT(2).getT(4).                               // math::add<NV>
                      getT(1).getT(0).getT(5).getT(1);
		auto& chain36 = this->getT(0).getT(0).getT(2).getT(4).getT(1).getT(0).getT(6);     // FilterNew2_impl::chain36_t<NV>
		auto& global_cable22 = this->getT(0).getT(0).getT(2).getT(4).                      // FilterNew2_impl::global_cable22_t<NV>
                               getT(1).getT(0).getT(6).getT(0);
		auto& add22 = this->getT(0).getT(0).getT(2).getT(4).                               // math::add<NV>
                      getT(1).getT(0).getT(6).getT(1);
		auto& chain37 = this->getT(0).getT(0).getT(2).getT(4).getT(1).getT(0).getT(7);     // FilterNew2_impl::chain37_t<NV>
		auto& global_cable23 = this->getT(0).getT(0).getT(2).getT(4).                      // FilterNew2_impl::global_cable23_t<NV>
                               getT(1).getT(0).getT(7).getT(0);
		auto& add23 = this->getT(0).getT(0).getT(2).getT(4).                               // math::add<NV>
                      getT(1).getT(0).getT(7).getT(1);
		auto& peak2 = this->getT(0).getT(0).getT(2).getT(4).getT(1).getT(1);               // FilterNew2_impl::peak2_t<NV>
		auto& clear = this->getT(0).getT(0).getT(2).getT(4).getT(1).getT(2);               // math::clear<NV>
		auto& input_toggle4 = this->getT(0).getT(0).getT(2).getT(5);                       // FilterNew2_impl::input_toggle4_t<NV>
		auto& pma8 = this->getT(0).getT(0).getT(2).getT(6);                                // FilterNew2_impl::pma8_t<NV>
		auto& chain8 = this->getT(0).getT(0).getT(3);                                      // FilterNew2_impl::chain8_t<NV>
		auto& split5 = this->getT(0).getT(0).getT(3).getT(0);                              // FilterNew2_impl::split5_t<NV>
		auto& event_data_reader6 = this->getT(0).getT(0).getT(3).getT(0).getT(0);          // FilterNew2_impl::event_data_reader6_t<NV>
		auto& chain11 = this->getT(0).getT(0).getT(3).getT(0).getT(1);                     // FilterNew2_impl::chain11_t<NV>
		auto& cable_table9 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(0);        // FilterNew2_impl::cable_table9_t<NV>
		auto& cable_table10 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(1);       // FilterNew2_impl::cable_table10_t<NV>
		auto& branch1 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(2);             // FilterNew2_impl::branch1_t<NV>
		auto& chain = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(2).getT(0);       // FilterNew2_impl::chain_t<NV>
		auto& global_cable = this->getT(0).getT(0).getT(3).getT(0).                        // FilterNew2_impl::global_cable_t<NV>
                             getT(1).getT(2).getT(0).getT(0);
		auto& add = this->getT(0).getT(0).getT(3).getT(0).                                 // math::add<NV>
                    getT(1).getT(2).getT(0).getT(1);
		auto& chain1 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(2).getT(1);      // FilterNew2_impl::chain1_t<NV>
		auto& global_cable1 = this->getT(0).getT(0).getT(3).getT(0).                       // FilterNew2_impl::global_cable1_t<NV>
                              getT(1).getT(2).getT(1).getT(0);
		auto& add1 = this->getT(0).getT(0).getT(3).getT(0).                                // math::add<NV>
                     getT(1).getT(2).getT(1).getT(1);
		auto& chain12 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(2).getT(2);     // FilterNew2_impl::chain12_t<NV>
		auto& global_cable2 = this->getT(0).getT(0).getT(3).getT(0).                       // FilterNew2_impl::global_cable2_t<NV>
                              getT(1).getT(2).getT(2).getT(0);
		auto& add2 = this->getT(0).getT(0).getT(3).getT(0).                                // math::add<NV>
                     getT(1).getT(2).getT(2).getT(1);
		auto& chain13 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(2).getT(3);     // FilterNew2_impl::chain13_t<NV>
		auto& global_cable3 = this->getT(0).getT(0).getT(3).getT(0).                       // FilterNew2_impl::global_cable3_t<NV>
                              getT(1).getT(2).getT(3).getT(0);
		auto& add3 = this->getT(0).getT(0).getT(3).getT(0).                                // math::add<NV>
                     getT(1).getT(2).getT(3).getT(1);
		auto& chain15 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(2).getT(4);     // FilterNew2_impl::chain15_t<NV>
		auto& global_cable4 = this->getT(0).getT(0).getT(3).getT(0).                       // FilterNew2_impl::global_cable4_t<NV>
                              getT(1).getT(2).getT(4).getT(0);
		auto& add4 = this->getT(0).getT(0).getT(3).getT(0).                                // math::add<NV>
                     getT(1).getT(2).getT(4).getT(1);
		auto& chain16 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(2).getT(5);     // FilterNew2_impl::chain16_t<NV>
		auto& global_cable5 = this->getT(0).getT(0).getT(3).getT(0).                       // FilterNew2_impl::global_cable5_t<NV>
                              getT(1).getT(2).getT(5).getT(0);
		auto& add5 = this->getT(0).getT(0).getT(3).getT(0).                                // math::add<NV>
                     getT(1).getT(2).getT(5).getT(1);
		auto& chain17 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(2).getT(6);     // FilterNew2_impl::chain17_t<NV>
		auto& global_cable6 = this->getT(0).getT(0).getT(3).getT(0).                       // FilterNew2_impl::global_cable6_t<NV>
                              getT(1).getT(2).getT(6).getT(0);
		auto& add6 = this->getT(0).getT(0).getT(3).getT(0).                                // math::add<NV>
                     getT(1).getT(2).getT(6).getT(1);
		auto& chain18 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(2).getT(7);     // FilterNew2_impl::chain18_t<NV>
		auto& global_cable7 = this->getT(0).getT(0).getT(3).getT(0).                       // FilterNew2_impl::global_cable7_t<NV>
                              getT(1).getT(2).getT(7).getT(0);
		auto& add7 = this->getT(0).getT(0).getT(3).getT(0).                                // math::add<NV>
                     getT(1).getT(2).getT(7).getT(1);
		auto& peak = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(3);                // FilterNew2_impl::peak_t<NV>
		auto& clear1 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(4);              // math::clear<NV>
		auto& input_toggle = this->getT(0).getT(0).getT(3).getT(1);                        // FilterNew2_impl::input_toggle_t<NV>
		auto& chain48 = this->getT(0).getT(0).getT(4);                                     // FilterNew2_impl::chain48_t<NV>
		auto& split8 = this->getT(0).getT(0).getT(4).getT(0);                              // FilterNew2_impl::split8_t<NV>
		auto& event_data_reader8 = this->getT(0).getT(0).getT(4).getT(0).getT(0);          // FilterNew2_impl::event_data_reader8_t<NV>
		auto& chain49 = this->getT(0).getT(0).getT(4).getT(0).getT(1);                     // FilterNew2_impl::chain49_t<NV>
		auto& cable_table13 = this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(0);       // FilterNew2_impl::cable_table13_t<NV>
		auto& cable_table14 = this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(1);       // FilterNew2_impl::cable_table14_t<NV>
		auto& branch5 = this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(2);             // FilterNew2_impl::branch5_t<NV>
		auto& chain50 = this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(2).getT(0);     // FilterNew2_impl::chain50_t<NV>
		auto& global_cable32 = this->getT(0).getT(0).getT(4).getT(0).                      // FilterNew2_impl::global_cable32_t<NV>
                               getT(1).getT(2).getT(0).getT(0);
		auto& add32 = this->getT(0).getT(0).getT(4).getT(0).                               // math::add<NV>
                      getT(1).getT(2).getT(0).getT(1);
		auto& chain51 = this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(2).getT(1);     // FilterNew2_impl::chain51_t<NV>
		auto& global_cable33 = this->getT(0).getT(0).getT(4).getT(0).                      // FilterNew2_impl::global_cable33_t<NV>
                               getT(1).getT(2).getT(1).getT(0);
		auto& add33 = this->getT(0).getT(0).getT(4).getT(0).                               // math::add<NV>
                      getT(1).getT(2).getT(1).getT(1);
		auto& chain52 = this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(2).getT(2);     // FilterNew2_impl::chain52_t<NV>
		auto& global_cable34 = this->getT(0).getT(0).getT(4).getT(0).                      // FilterNew2_impl::global_cable34_t<NV>
                               getT(1).getT(2).getT(2).getT(0);
		auto& add34 = this->getT(0).getT(0).getT(4).getT(0).                               // math::add<NV>
                      getT(1).getT(2).getT(2).getT(1);
		auto& chain53 = this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(2).getT(3);     // FilterNew2_impl::chain53_t<NV>
		auto& global_cable35 = this->getT(0).getT(0).getT(4).getT(0).                      // FilterNew2_impl::global_cable35_t<NV>
                               getT(1).getT(2).getT(3).getT(0);
		auto& add35 = this->getT(0).getT(0).getT(4).getT(0).                               // math::add<NV>
                      getT(1).getT(2).getT(3).getT(1);
		auto& chain57 = this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(2).getT(4);     // FilterNew2_impl::chain57_t<NV>
		auto& global_cable36 = this->getT(0).getT(0).getT(4).getT(0).                      // FilterNew2_impl::global_cable36_t<NV>
                               getT(1).getT(2).getT(4).getT(0);
		auto& add36 = this->getT(0).getT(0).getT(4).getT(0).                               // math::add<NV>
                      getT(1).getT(2).getT(4).getT(1);
		auto& chain58 = this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(2).getT(5);     // FilterNew2_impl::chain58_t<NV>
		auto& global_cable37 = this->getT(0).getT(0).getT(4).getT(0).                      // FilterNew2_impl::global_cable37_t<NV>
                               getT(1).getT(2).getT(5).getT(0);
		auto& add37 = this->getT(0).getT(0).getT(4).getT(0).                               // math::add<NV>
                      getT(1).getT(2).getT(5).getT(1);
		auto& chain59 = this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(2).getT(6);     // FilterNew2_impl::chain59_t<NV>
		auto& global_cable38 = this->getT(0).getT(0).getT(4).getT(0).                      // FilterNew2_impl::global_cable38_t<NV>
                               getT(1).getT(2).getT(6).getT(0);
		auto& add38 = this->getT(0).getT(0).getT(4).getT(0).                               // math::add<NV>
                      getT(1).getT(2).getT(6).getT(1);
		auto& chain60 = this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(2).getT(7);     // FilterNew2_impl::chain60_t<NV>
		auto& global_cable39 = this->getT(0).getT(0).getT(4).getT(0).                      // FilterNew2_impl::global_cable39_t<NV>
                               getT(1).getT(2).getT(7).getT(0);
		auto& add39 = this->getT(0).getT(0).getT(4).getT(0).                               // math::add<NV>
                      getT(1).getT(2).getT(7).getT(1);
		auto& peak4 = this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(3);               // FilterNew2_impl::peak4_t<NV>
		auto& clear3 = this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(4);              // math::clear<NV>
		auto& input_toggle2 = this->getT(0).getT(0).getT(4).getT(1);                       // FilterNew2_impl::input_toggle2_t<NV>
		auto& pma9 = this->getT(1);                                                        // FilterNew2_impl::pma9_t<NV>
		auto& minmax2 = this->getT(2);                                                     // FilterNew2_impl::minmax2_t<NV>
		auto& pma1 = this->getT(3);                                                        // FilterNew2_impl::pma1_t<NV>
		auto& xfader = this->getT(4);                                                      // FilterNew2_impl::xfader_t<NV>
		auto& softbypass_switch3 = this->getT(5);                                          // FilterNew2_impl::softbypass_switch3_t<NV>
		auto& switcher1 = this->getT(5).getT(0);                                           // FilterNew2_impl::switcher1_t<NV>
		auto& sb_container1 = this->getT(5).getT(1);                                       // FilterNew2_impl::sb_container1_t<NV>
		auto& sb5 = this->getT(5).getT(1).getT(0);                                         // FilterNew2_impl::sb5_t<NV>
		auto& split = this->getT(5).getT(1).getT(0).getT(0);                               // FilterNew2_impl::split_t<NV>
		auto& chain4 = this->getT(5).getT(1).getT(0).getT(0).getT(0);                      // FilterNew2_impl::chain4_t<NV>
		auto& smoothed_parameter = this->getT(5).getT(1).getT(0).getT(0).getT(0).getT(0);  // FilterNew2_impl::smoothed_parameter_t<NV>
		auto& split1 = this->getT(5).getT(1).getT(0).getT(0).getT(0).getT(1);              // FilterNew2_impl::split1_t<NV>
		auto& chain2 = this->getT(5).getT(1).getT(0).getT(0).getT(0).getT(1).getT(0);      // FilterNew2_impl::chain2_t<NV>
		auto& gain1 = this->getT(5).getT(1).getT(0).getT(0).                               // core::gain<NV>
                      getT(0).getT(1).getT(0).getT(0);
		auto& chain62 = this->getT(5).getT(1).getT(0).getT(0).getT(0).getT(1).getT(1);     // FilterNew2_impl::chain62_t<NV>
		auto& branch = this->getT(5).getT(1).getT(0).getT(0).                              // FilterNew2_impl::branch_t<NV>
                       getT(0).getT(1).getT(1).getT(0);
		auto& chain47 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew2_impl::chain47_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(0);
		auto& expr2 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                       // math::expr<NV, custom::expr2>
                      getT(1).getT(1).getT(0).getT(0).getT(0);
		auto& chain61 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew2_impl::chain61_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(1);
		auto& expr = this->getT(5).getT(1).getT(0).getT(0).getT(0).                        // math::expr<NV, custom::expr>
                     getT(1).getT(1).getT(0).getT(1).getT(0);
		auto& chain63 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew2_impl::chain63_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(2);
		auto& expr1 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                       // math::expr<NV, custom::expr1>
                      getT(1).getT(1).getT(0).getT(2).getT(0);
		auto& chain64 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew2_impl::chain64_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(3);
		auto& expr3 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                       // math::expr<NV, custom::expr3>
                      getT(1).getT(1).getT(0).getT(3).getT(0);
		auto& chain65 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew2_impl::chain65_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(4);
		auto& expr4 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                       // math::expr<NV, custom::expr4>
                      getT(1).getT(1).getT(0).getT(4).getT(0);
		auto& chain66 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew2_impl::chain66_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(5);
		auto& expr6 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                       // math::expr<NV, custom::expr6>
                      getT(1).getT(1).getT(0).getT(5).getT(0);
		auto& chain71 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew2_impl::chain71_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(6);
		auto& expr11 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                      // math::expr<NV, custom::expr11>
                       getT(1).getT(1).getT(0).getT(6).getT(0);
		auto& chain70 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew2_impl::chain70_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(7);
		auto& expr10 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                      // math::expr<NV, custom::expr10>
                       getT(1).getT(1).getT(0).getT(7).getT(0);
		auto& chain73 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew2_impl::chain73_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(8);
		auto& expr13 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                      // math::expr<NV, custom::expr13>
                       getT(1).getT(1).getT(0).getT(8).getT(0);
		auto& chain72 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew2_impl::chain72_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(9);
		auto& expr12 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                      // math::expr<NV, custom::expr12>
                       getT(1).getT(1).getT(0).getT(9).getT(0);
		auto& chain69 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew2_impl::chain69_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(10);
		auto& expr9 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                       // math::expr<NV, custom::expr9>
                      getT(1).getT(1).getT(0).getT(10).getT(0);
		auto& chain68 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew2_impl::chain68_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(11);
		...
		auto& filter1 = this->getT(5).getT(1).getT(0).getT(0).getT(0).getT(2);             // FilterNew2_impl::filter1_t<NV>
		auto& dry_path = this->getT(5).getT(1).getT(0).getT(0).getT(0).getT(2).getT(0);    // FilterNew2_impl::dry_path_t<NV>
		auto& pma10 = this->getT(5).getT(1).getT(0).getT(0).                               // FilterNew2_impl::pma10_t<NV>
                      getT(0).getT(2).getT(0).getT(0);
		auto& xfader1 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew2_impl::xfader1_t<NV>
                        getT(0).getT(2).getT(0).getT(1);
		auto& gain = this->getT(5).getT(1).getT(0).getT(0).                                // core::gain<NV>
                     getT(0).getT(2).getT(0).getT(2);
		auto& wet_path = this->getT(5).getT(1).getT(0).getT(0).getT(0).getT(2).getT(1);    // FilterNew2_impl::wet_path_t<NV>
		auto& softbypass_switch5 = this->getT(5).getT(1).getT(0).getT(0).                  // FilterNew2_impl::softbypass_switch5_t<NV>
                                   getT(0).getT(2).getT(1).getT(0);
		auto& pma12 = this->getT(5).getT(1).getT(0).getT(0).                               // FilterNew2_impl::pma12_t<NV>
                      getT(0).getT(2).getT(1).getT(0).
                      getT(0);
		auto& switcher = this->getT(5).getT(1).getT(0).getT(0).                            // FilterNew2_impl::switcher_t<NV>
                         getT(0).getT(2).getT(1).getT(0).
                         getT(1);
		auto& sb_container = this->getT(5).getT(1).getT(0).getT(0).                        // FilterNew2_impl::sb_container_t<NV>
                             getT(0).getT(2).getT(1).getT(0).
                             getT(2);
		auto& sb1 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                         // FilterNew2_impl::sb1_t<NV>
                    getT(2).getT(1).getT(0).getT(2).getT(0);
		auto& svf = this->getT(5).getT(1).getT(0).getT(0).getT(0).                         // filters::svf<NV>
                    getT(2).getT(1).getT(0).getT(2).getT(0).
                    getT(0);
		auto& sb2 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                         // FilterNew2_impl::sb2_t<NV>
                    getT(2).getT(1).getT(0).getT(2).getT(1);
		auto& svf1 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                        // filters::svf<NV>
                     getT(2).getT(1).getT(0).getT(2).getT(1).
                     getT(0);
		auto& sb3 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                         // FilterNew2_impl::sb3_t<NV>
                    getT(2).getT(1).getT(0).getT(2).getT(2);
		auto& svf2 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                        // filters::svf<NV>
                     getT(2).getT(1).getT(0).getT(2).getT(2).
                     getT(0);
		auto& soft_bypass = this->getT(5).getT(1).getT(0).getT(0).getT(0).                 // FilterNew2_impl::soft_bypass_t<NV>
                            getT(2).getT(1).getT(0).getT(2).getT(3);
		auto& allpass = this->getT(5).getT(1).getT(0).getT(0).getT(0).                     // filters::allpass<NV>
                        getT(2).getT(1).getT(0).getT(2).getT(3).
                        getT(0);
		auto& soft_bypass1 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                // FilterNew2_impl::soft_bypass1_t<NV>
                             getT(2).getT(1).getT(0).getT(2).getT(4);
		auto& ring_mod = this->getT(5).getT(1).getT(0).getT(0).getT(0).                    // filters::ring_mod<NV>
                         getT(2).getT(1).getT(0).getT(2).getT(4).
                         getT(0);
		auto& sb4 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                         // FilterNew2_impl::sb4_t
                    getT(2).getT(1).getT(0).getT(2).getT(5);
		auto& gain17 = this->getT(5).getT(1).getT(0).getT(0).                              // core::gain<NV>
                       getT(0).getT(2).getT(1).getT(1);
		auto& sb6 = this->getT(5).getT(1).getT(1);                                         // FilterNew2_impl::sb6_t<NV>
		auto& split11 = this->getT(5).getT(1).getT(1).getT(0);                             // FilterNew2_impl::split11_t<NV>
		auto& chain54 = this->getT(5).getT(1).getT(1).getT(0).getT(0);                     // FilterNew2_impl::chain54_t<NV>
		auto& filter4 = this->getT(5).getT(1).getT(1).getT(0).getT(0).getT(0);             // FilterNew2_impl::filter4_t<NV>
		auto& dry_path3 = this->getT(5).getT(1).getT(1).getT(0).getT(0).getT(0).getT(0);   // FilterNew2_impl::dry_path3_t<NV>
		auto& pma13 = this->getT(5).getT(1).getT(1).getT(0).                               // FilterNew2_impl::pma13_t<NV>
                      getT(0).getT(0).getT(0).getT(0);
		auto& xfader4 = this->getT(5).getT(1).getT(1).getT(0).                             // FilterNew2_impl::xfader4_t<NV>
                        getT(0).getT(0).getT(0).getT(1);
		auto& gain11 = this->getT(5).getT(1).getT(1).getT(0).                              // core::gain<NV>
                       getT(0).getT(0).getT(0).getT(2);
		auto& wet_path3 = this->getT(5).getT(1).getT(1).getT(0).getT(0).getT(0).getT(1);   // FilterNew2_impl::wet_path3_t<NV>
		auto& softbypass_switch8 = this->getT(5).getT(1).getT(1).getT(0).                  // FilterNew2_impl::softbypass_switch8_t<NV>
                                   getT(0).getT(0).getT(1).getT(0);
		auto& pma14 = this->getT(5).getT(1).getT(1).getT(0).                               // FilterNew2_impl::pma14_t<NV>
                      getT(0).getT(0).getT(1).getT(0).
                      getT(0);
		auto& switcher4 = this->getT(5).getT(1).getT(1).getT(0).                           // FilterNew2_impl::switcher4_t<NV>
                          getT(0).getT(0).getT(1).getT(0).
                          getT(1);
		auto& sb_container4 = this->getT(5).getT(1).getT(1).getT(0).                       // FilterNew2_impl::sb_container4_t<NV>
                              getT(0).getT(0).getT(1).getT(0).
                              getT(2);
		auto& sb15 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                        // FilterNew2_impl::sb15_t<NV>
                     getT(0).getT(1).getT(0).getT(2).getT(0);
		auto& svf9 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                        // filters::svf<NV>
                     getT(0).getT(1).getT(0).getT(2).getT(0).
                     getT(0);
		auto& sb16 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                        // FilterNew2_impl::sb16_t<NV>
                     getT(0).getT(1).getT(0).getT(2).getT(1);
		auto& svf10 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                       // filters::svf<NV>
                      getT(0).getT(1).getT(0).getT(2).getT(1).
                      getT(0);
		auto& sb17 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                        // FilterNew2_impl::sb17_t<NV>
                     getT(0).getT(1).getT(0).getT(2).getT(2);
		auto& svf11 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                       // filters::svf<NV>
                      getT(0).getT(1).getT(0).getT(2).getT(2).
                      getT(0);
		auto& soft_bypass6 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                // FilterNew2_impl::soft_bypass6_t<NV>
                             getT(0).getT(1).getT(0).getT(2).getT(3);
		auto& allpass3 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                    // filters::allpass<NV>
                         getT(0).getT(1).getT(0).getT(2).getT(3).
                         getT(0);
		auto& soft_bypass7 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                // FilterNew2_impl::soft_bypass7_t<NV>
                             getT(0).getT(1).getT(0).getT(2).getT(4);
		auto& ring_mod3 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                   // filters::ring_mod<NV>
                          getT(0).getT(1).getT(0).getT(2).getT(4).
                          getT(0);
		auto& sb18 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                        // FilterNew2_impl::sb18_t
                     getT(0).getT(1).getT(0).getT(2).getT(5);
		auto& gain20 = this->getT(5).getT(1).getT(1).getT(0).                              // core::gain<NV>
                       getT(0).getT(0).getT(1).getT(1);
		auto& smoothed_parameter6 = this->getT(5).getT(1).getT(1).getT(0).getT(0).getT(1); // FilterNew2_impl::smoothed_parameter6_t<NV>
		auto& split12 = this->getT(5).getT(1).getT(1).getT(0).getT(0).getT(2);             // FilterNew2_impl::split12_t<NV>
		auto& chain55 = this->getT(5).getT(1).getT(1).getT(0).getT(0).getT(2).getT(0);     // FilterNew2_impl::chain55_t<NV>
		auto& gain9 = this->getT(5).getT(1).getT(1).getT(0).                               // core::gain<NV>
                      getT(0).getT(2).getT(0).getT(0);
		auto& chain56 = this->getT(5).getT(1).getT(1).getT(0).getT(0).getT(2).getT(1); // FilterNew2_impl::chain56_t<NV>
		auto& branch6 = this->getT(5).getT(1).getT(1).getT(0).                         // FilterNew2_impl::branch6_t<NV>
                        getT(0).getT(2).getT(1).getT(0);
		auto& chain75 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew2_impl::chain75_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(0);
		auto& expr14 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr14>
                       getT(2).getT(1).getT(0).getT(0).getT(0);
		auto& chain76 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew2_impl::chain76_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(1);
		auto& expr15 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr15>
                       getT(2).getT(1).getT(0).getT(1).getT(0);
		auto& chain77 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew2_impl::chain77_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(2);
		auto& expr16 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr16>
                       getT(2).getT(1).getT(0).getT(2).getT(0);
		auto& chain78 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew2_impl::chain78_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(3);
		auto& expr17 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr17>
                       getT(2).getT(1).getT(0).getT(3).getT(0);
		auto& chain87 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew2_impl::chain87_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(4);
		auto& expr26 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr26>
                       getT(2).getT(1).getT(0).getT(4).getT(0);
		auto& chain80 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew2_impl::chain80_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(5);
		auto& expr19 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr19>
                       getT(2).getT(1).getT(0).getT(5).getT(0);
		auto& chain81 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew2_impl::chain81_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(6);
		auto& expr20 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr20>
                       getT(2).getT(1).getT(0).getT(6).getT(0);
		auto& chain82 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew2_impl::chain82_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(7);
		auto& expr21 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr21>
                       getT(2).getT(1).getT(0).getT(7).getT(0);
		auto& chain83 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew2_impl::chain83_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(8);
		auto& expr22 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr22>
                       getT(2).getT(1).getT(0).getT(8).getT(0);
		auto& chain84 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew2_impl::chain84_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(9);
		auto& expr23 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr23>
                       getT(2).getT(1).getT(0).getT(9).getT(0);
		auto& chain85 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew2_impl::chain85_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(10);
		auto& expr24 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr24>
                       getT(2).getT(1).getT(0).getT(10).getT(0);
		auto& chain86 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew2_impl::chain86_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(11);
		...
		sliderbank_p.getParameterT(1).connectT(0, pma8);                      // sliderbank -> pma8::Add
	...
	void connectToRuntimeTarget(bool addConnection, const runtime_target::connection& c)
	{
		...
		this->getT(0).getT(0).getT(1).getT(4).          // FilterNew2_impl::global_cable8_t<NV>
        getT(2).getT(1).getT(0).getT(0).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(4).          // FilterNew2_impl::global_cable9_t<NV>
        getT(2).getT(1).getT(0).getT(1).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(4).          // FilterNew2_impl::global_cable10_t<NV>
        getT(2).getT(1).getT(0).getT(2).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(4).          // FilterNew2_impl::global_cable11_t<NV>
        getT(2).getT(1).getT(0).getT(3).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(4).          // FilterNew2_impl::global_cable12_t<NV>
        getT(2).getT(1).getT(0).getT(4).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(4).          // FilterNew2_impl::global_cable13_t<NV>
        getT(2).getT(1).getT(0).getT(5).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(4).          // FilterNew2_impl::global_cable14_t<NV>
        getT(2).getT(1).getT(0).getT(6).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(4).          // FilterNew2_impl::global_cable15_t<NV>
        getT(2).getT(1).getT(0).getT(7).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(5).getT(0).  // FilterNew2_impl::global_cable24_t<NV>
        getT(2).getT(1).getT(0).getT(0).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(5).getT(0).  // FilterNew2_impl::global_cable25_t<NV>
        getT(2).getT(1).getT(0).getT(1).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(5).getT(0).  // FilterNew2_impl::global_cable26_t<NV>
        getT(2).getT(1).getT(0).getT(2).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(5).getT(0).  // FilterNew2_impl::global_cable27_t<NV>
        getT(2).getT(1).getT(0).getT(3).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(5).getT(0).  // FilterNew2_impl::global_cable28_t<NV>
        getT(2).getT(1).getT(0).getT(4).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(5).getT(0).  // FilterNew2_impl::global_cable29_t<NV>
        getT(2).getT(1).getT(0).getT(5).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(5).getT(0).  // FilterNew2_impl::global_cable30_t<NV>
        getT(2).getT(1).getT(0).getT(6).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(5).getT(0).  // FilterNew2_impl::global_cable31_t<NV>
        getT(2).getT(1).getT(0).getT(7).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(2).getT(4).  // FilterNew2_impl::global_cable16_t<NV>
        getT(1).getT(0).getT(0).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(2).getT(4).  // FilterNew2_impl::global_cable17_t<NV>
        getT(1).getT(0).getT(1).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(2).getT(4).  // FilterNew2_impl::global_cable18_t<NV>
        getT(1).getT(0).getT(2).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(2).getT(4).  // FilterNew2_impl::global_cable19_t<NV>
        getT(1).getT(0).getT(3).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(2).getT(4).  // FilterNew2_impl::global_cable20_t<NV>
        getT(1).getT(0).getT(4).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(2).getT(4).  // FilterNew2_impl::global_cable21_t<NV>
        getT(1).getT(0).getT(5).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(2).getT(4).  // FilterNew2_impl::global_cable22_t<NV>
        getT(1).getT(0).getT(6).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(2).getT(4).  // FilterNew2_impl::global_cable23_t<NV>
        getT(1).getT(0).getT(7).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(0).  // FilterNew2_impl::global_cable_t<NV>
        getT(1).getT(2).getT(0).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(0).  // FilterNew2_impl::global_cable1_t<NV>
        getT(1).getT(2).getT(1).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(0).  // FilterNew2_impl::global_cable2_t<NV>
        getT(1).getT(2).getT(2).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(0).  // FilterNew2_impl::global_cable3_t<NV>
        getT(1).getT(2).getT(3).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(0).  // FilterNew2_impl::global_cable4_t<NV>
        getT(1).getT(2).getT(4).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(0).  // FilterNew2_impl::global_cable5_t<NV>
        getT(1).getT(2).getT(5).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(0).  // FilterNew2_impl::global_cable6_t<NV>
        getT(1).getT(2).getT(6).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(0).  // FilterNew2_impl::global_cable7_t<NV>
        getT(1).getT(2).getT(7).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(4).getT(0).  // FilterNew2_impl::global_cable32_t<NV>
        getT(1).getT(2).getT(0).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(4).getT(0).  // FilterNew2_impl::global_cable33_t<NV>
        getT(1).getT(2).getT(1).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(4).getT(0).  // FilterNew2_impl::global_cable34_t<NV>
        getT(1).getT(2).getT(2).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(4).getT(0).  // FilterNew2_impl::global_cable35_t<NV>
        getT(1).getT(2).getT(3).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(4).getT(0).  // FilterNew2_impl::global_cable36_t<NV>
        getT(1).getT(2).getT(4).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(4).getT(0).  // FilterNew2_impl::global_cable37_t<NV>
        getT(1).getT(2).getT(5).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(4).getT(0).  // FilterNew2_impl::global_cable38_t<NV>
        getT(1).getT(2).getT(6).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(4).getT(0).  // FilterNew2_impl::global_cable39_t<NV>
        getT(1).getT(2).getT(7).getT(0).connectToRuntimeTarget(addConnection, c);
	}
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(0).getT(0).getT(1).getT(4).getT(0).setExternalData(b, index);                 // FilterNew2_impl::cable_table11_t<NV>
		this->getT(0).getT(0).getT(1).getT(4).getT(1).setExternalData(b, index);                 // FilterNew2_impl::cable_table12_t<NV>
		this->getT(0).getT(0).getT(1).getT(4).getT(2).getT(1).getT(1).setExternalData(b, index); // FilterNew2_impl::peak1_t<NV>
		this->getT(0).getT(0).getT(1).getT(5).getT(0).getT(0).setExternalData(b, index);         // FilterNew2_impl::cable_table5_t<NV>
		this->getT(0).getT(0).getT(1).getT(5).getT(0).getT(1).setExternalData(b, index);         // FilterNew2_impl::cable_table6_t<NV>
		this->getT(0).getT(0).getT(1).getT(5).                                                   // FilterNew2_impl::peak3_t<NV>
        getT(0).getT(2).getT(1).getT(1).setExternalData(b, index);
		this->getT(0).getT(0).getT(2).getT(0).setExternalData(b, index);                 // FilterNew2_impl::pack_resizer1_t
		this->getT(0).getT(0).getT(2).getT(1).setExternalData(b, index);                 // FilterNew2_impl::sliderbank_t<NV>
		this->getT(0).getT(0).getT(2).getT(2).setExternalData(b, index);                 // FilterNew2_impl::cable_table7_t<NV>
		this->getT(0).getT(0).getT(2).getT(3).setExternalData(b, index);                 // FilterNew2_impl::cable_table8_t<NV>
		this->getT(0).getT(0).getT(2).getT(4).getT(1).getT(1).setExternalData(b, index); // FilterNew2_impl::peak2_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(0).setExternalData(b, index); // FilterNew2_impl::cable_table9_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(1).setExternalData(b, index); // FilterNew2_impl::cable_table10_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(3).setExternalData(b, index); // FilterNew2_impl::peak_t<NV>
		this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(0).setExternalData(b, index); // FilterNew2_impl::cable_table13_t<NV>
		this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(1).setExternalData(b, index); // FilterNew2_impl::cable_table14_t<NV>
		this->getT(0).getT(0).getT(4).getT(0).getT(1).getT(3).setExternalData(b, index); // FilterNew2_impl::peak4_t<NV>
	}
};
}
...
template <int NV>
using FilterNew2 = wrap::node<FilterNew2_impl::instance<NV>>;
}
