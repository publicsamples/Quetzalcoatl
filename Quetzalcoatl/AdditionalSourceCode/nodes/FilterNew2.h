...
template <int NV>
using _3rdParam_2 = parameter::from0To1<FilterNew2_impl::event_data_reader6_t<NV>, 
                                        0, 
                                        _3rdParam_2Range>;
...
using FoldRes = parameter::from0To1<project::FoldTests<NV>, 
                                    2, 
                                    FilterNew2_impl::pma9_mod_1Range>;

template <int NV>
using MainParam = parameter::plain<FilterNew2_impl::pma7_t<NV>, 
                                   2>;
template <int NV>
using _2ndParam = parameter::plain<FilterNew2_impl::pma9_t<NV>, 
                                   2>;
template <int NV>
using _4thParam = parameter::plain<FilterNew2_impl::pma9_t<NV>, 
                                   1>;
template <int NV>
using Poly = parameter::plain<FilterNew2_impl::pma_t<NV>, 
                              1>;
template <int NV>
...
using StageMod = parameter::plain<FilterNew2_impl::pma8_t<NV>, 
                                  1>;
template <int NV>
using Stage1 = parameter::plain<FilterNew2_impl::pma10_t<NV>, 
                                2>;
template <int NV>
using Stage2 = parameter::plain<FilterNew2_impl::pma10_t<NV>, 
                                1>;
template <int NV>
...
template <int NV> struct instance: public FilterNew2_impl::FilterNew2_t_<NV>
{
	...
	instance()
	{
		...
		auto& pma8 = this->getT(0).getT(0).getT(3).getT(0);                                 // FilterNew2_impl::pma8_t<NV>
		auto& cable_table9 = this->getT(0).getT(0).getT(3).getT(1);                         // FilterNew2_impl::cable_table9_t<NV>
		auto& cable_table10 = this->getT(0).getT(0).getT(3).getT(2);                        // FilterNew2_impl::cable_table10_t<NV>
		auto& split5 = this->getT(0).getT(0).getT(3).getT(3);                               // FilterNew2_impl::split5_t<NV>
		auto& event_data_reader6 = this->getT(0).getT(0).getT(3).getT(3).getT(0);           // FilterNew2_impl::event_data_reader6_t<NV>
		auto& chain11 = this->getT(0).getT(0).getT(3).getT(3).getT(1);                      // FilterNew2_impl::chain11_t<NV>
		auto& branch1 = this->getT(0).getT(0).getT(3).getT(3).getT(1).getT(0);              // FilterNew2_impl::branch1_t<NV>
		auto& chain = this->getT(0).getT(0).getT(3).getT(3).getT(1).getT(0).getT(0);        // FilterNew2_impl::chain_t<NV>
		auto& global_cable = this->getT(0).getT(0).getT(3).getT(3).                         // FilterNew2_impl::global_cable_t<NV>
                             getT(1).getT(0).getT(0).getT(0);
		auto& add = this->getT(0).getT(0).getT(3).getT(3).                                  // math::add<NV>
                    getT(1).getT(0).getT(0).getT(1);
		auto& chain1 = this->getT(0).getT(0).getT(3).getT(3).getT(1).getT(0).getT(1);       // FilterNew2_impl::chain1_t<NV>
		auto& global_cable1 = this->getT(0).getT(0).getT(3).getT(3).                        // FilterNew2_impl::global_cable1_t<NV>
                              getT(1).getT(0).getT(1).getT(0);
		auto& add1 = this->getT(0).getT(0).getT(3).getT(3).                                 // math::add<NV>
                     getT(1).getT(0).getT(1).getT(1);
		auto& chain12 = this->getT(0).getT(0).getT(3).getT(3).getT(1).getT(0).getT(2);      // FilterNew2_impl::chain12_t<NV>
		auto& global_cable2 = this->getT(0).getT(0).getT(3).getT(3).                        // FilterNew2_impl::global_cable2_t<NV>
                              getT(1).getT(0).getT(2).getT(0);
		auto& add2 = this->getT(0).getT(0).getT(3).getT(3).                                 // math::add<NV>
                     getT(1).getT(0).getT(2).getT(1);
		auto& chain13 = this->getT(0).getT(0).getT(3).getT(3).getT(1).getT(0).getT(3);      // FilterNew2_impl::chain13_t<NV>
		auto& global_cable3 = this->getT(0).getT(0).getT(3).getT(3).                        // FilterNew2_impl::global_cable3_t<NV>
                              getT(1).getT(0).getT(3).getT(0);
		auto& add3 = this->getT(0).getT(0).getT(3).getT(3).                                 // math::add<NV>
                     getT(1).getT(0).getT(3).getT(1);
		auto& chain15 = this->getT(0).getT(0).getT(3).getT(3).getT(1).getT(0).getT(4);      // FilterNew2_impl::chain15_t<NV>
		auto& global_cable4 = this->getT(0).getT(0).getT(3).getT(3).                        // FilterNew2_impl::global_cable4_t<NV>
                              getT(1).getT(0).getT(4).getT(0);
		auto& add4 = this->getT(0).getT(0).getT(3).getT(3).                                 // math::add<NV>
                     getT(1).getT(0).getT(4).getT(1);
		auto& chain16 = this->getT(0).getT(0).getT(3).getT(3).getT(1).getT(0).getT(5);      // FilterNew2_impl::chain16_t<NV>
		auto& global_cable5 = this->getT(0).getT(0).getT(3).getT(3).                        // FilterNew2_impl::global_cable5_t<NV>
                              getT(1).getT(0).getT(5).getT(0);
		auto& add5 = this->getT(0).getT(0).getT(3).getT(3).                                 // math::add<NV>
                     getT(1).getT(0).getT(5).getT(1);
		auto& chain17 = this->getT(0).getT(0).getT(3).getT(3).getT(1).getT(0).getT(6);      // FilterNew2_impl::chain17_t<NV>
		auto& global_cable6 = this->getT(0).getT(0).getT(3).getT(3).                        // FilterNew2_impl::global_cable6_t<NV>
                              getT(1).getT(0).getT(6).getT(0);
		auto& add6 = this->getT(0).getT(0).getT(3).getT(3).                                 // math::add<NV>
                     getT(1).getT(0).getT(6).getT(1);
		auto& chain18 = this->getT(0).getT(0).getT(3).getT(3).getT(1).getT(0).getT(7);      // FilterNew2_impl::chain18_t<NV>
		auto& global_cable7 = this->getT(0).getT(0).getT(3).getT(3).                        // FilterNew2_impl::global_cable7_t<NV>
                              getT(1).getT(0).getT(7).getT(0);
		auto& add7 = this->getT(0).getT(0).getT(3).getT(3).                                 // math::add<NV>
                     getT(1).getT(0).getT(7).getT(1);
		auto& peak = this->getT(0).getT(0).getT(3).getT(3).getT(1).getT(1);                 // FilterNew2_impl::peak_t<NV>
		auto& clear1 = this->getT(0).getT(0).getT(3).getT(3).getT(1).getT(2);               // math::clear<NV>
		auto& input_toggle = this->getT(0).getT(0).getT(3).getT(4);                         // FilterNew2_impl::input_toggle_t<NV>
		auto& split = this->getT(1);                                                        // FilterNew2_impl::split_t<NV>
		auto& chain4 = this->getT(1).getT(0);                                               // FilterNew2_impl::chain4_t<NV>
		auto& filter1 = this->getT(1).getT(0).getT(0);                                      // FilterNew2_impl::filter1_t<NV>
		auto& dry_path = this->getT(1).getT(0).getT(0).getT(0);                             // FilterNew2_impl::dry_path_t<NV>
		auto& pma10 = this->getT(1).getT(0).getT(0).getT(0).getT(0);                        // FilterNew2_impl::pma10_t<NV>
		auto& xfader1 = this->getT(1).getT(0).getT(0).getT(0).getT(1);                      // FilterNew2_impl::xfader1_t<NV>
		auto& gain = this->getT(1).getT(0).getT(0).getT(0).getT(2);                         // core::gain<NV>
		auto& wet_path = this->getT(1).getT(0).getT(0).getT(1);                             // FilterNew2_impl::wet_path_t<NV>
		auto& pma9 = this->getT(1).getT(0).getT(0).getT(1).getT(0);                         // FilterNew2_impl::pma9_t<NV>
		auto& softbypass_switch5 = this->getT(1).getT(0).getT(0).getT(1).getT(1);           // FilterNew2_impl::softbypass_switch5_t<NV>
		auto& switcher = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(0);             // FilterNew2_impl::switcher_t<NV>
		auto& sb_container = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(1);         // FilterNew2_impl::sb_container_t<NV>
		auto& sb1 = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(1).getT(0);          // FilterNew2_impl::sb1_t<NV>
		auto& svf = this->getT(1).getT(0).getT(0).getT(1).                                  // filters::svf<NV>
                    getT(1).getT(1).getT(0).getT(0);
		auto& sb2 = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(1).getT(1);          // FilterNew2_impl::sb2_t<NV>
		auto& svf1 = this->getT(1).getT(0).getT(0).getT(1).                                 // filters::svf<NV>
                     getT(1).getT(1).getT(1).getT(0);
		auto& sb3 = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(1).getT(2);          // FilterNew2_impl::sb3_t<NV>
		auto& svf2 = this->getT(1).getT(0).getT(0).getT(1).                                 // filters::svf<NV>
                     getT(1).getT(1).getT(2).getT(0);
		auto& soft_bypass = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(1).getT(3);  // FilterNew2_impl::soft_bypass_t<NV>
		auto& allpass = this->getT(1).getT(0).getT(0).getT(1).                              // filters::allpass<NV>
                        getT(1).getT(1).getT(3).getT(0);
		auto& soft_bypass1 = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(1).getT(4); // FilterNew2_impl::soft_bypass1_t<NV>
		auto& ring_mod = this->getT(1).getT(0).getT(0).getT(1).                             // filters::ring_mod<NV>
                         getT(1).getT(1).getT(4).getT(0);
		auto& sb4 = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(1).getT(5); // FilterNew2_impl::sb4_t<NV>
	...
	void connectToRuntimeTarget(bool addConnection, const runtime_target::connection& c)
	{
		...
		this->getT(0).getT(0).getT(3).getT(3).  // FilterNew2_impl::global_cable_t<NV>
        getT(1).getT(0).getT(0).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(3).  // FilterNew2_impl::global_cable1_t<NV>
        getT(1).getT(0).getT(1).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(3).  // FilterNew2_impl::global_cable2_t<NV>
        getT(1).getT(0).getT(2).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(3).  // FilterNew2_impl::global_cable3_t<NV>
        getT(1).getT(0).getT(3).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(3).  // FilterNew2_impl::global_cable4_t<NV>
        getT(1).getT(0).getT(4).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(3).  // FilterNew2_impl::global_cable5_t<NV>
        getT(1).getT(0).getT(5).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(3).  // FilterNew2_impl::global_cable6_t<NV>
        getT(1).getT(0).getT(6).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(3).getT(3).  // FilterNew2_impl::global_cable7_t<NV>
        getT(1).getT(0).getT(7).getT(0).connectToRuntimeTarget(addConnection, c);
	}
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(0).getT(0).getT(3).getT(1).setExternalData(b, index);                 // FilterNew2_impl::cable_table9_t<NV>
		this->getT(0).getT(0).getT(3).getT(2).setExternalData(b, index);                 // FilterNew2_impl::cable_table10_t<NV>
		this->getT(0).getT(0).getT(3).getT(3).getT(1).getT(1).setExternalData(b, index); // FilterNew2_impl::peak_t<NV>
	}
};
}
