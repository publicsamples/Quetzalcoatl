...
namespace Mod9_t_parameters
{
// Parameter list for Mod9_impl::Mod9_t ------------------------------------------------------------
...
template <int NV>
using multi_0 = parameter::from0To1<Mod9_impl::tempo_sync_t<NV>, 
                                    1, 
                                    multi_0Range>;
...
using packs_0 = parameter::from0To1<Mod9_impl::pack_resizer_t, 
                                    0, 
                                    packs_0Range>;
...
using onshot = parameter::chain<ranges::Identity, 
                                parameter::plain<Mod9_impl::ramp_t<NV>, 1>, 
                                parameter::plain<Mod9_impl::input_toggle_t<NV>, 0>>;

template <int NV>
using tempo = parameter::plain<Mod9_impl::tempo_sync_t<NV>, 
                               0>;
template <int NV>
using type = parameter::plain<Mod9_impl::branch_t<NV>, 
                              0>;
template <int NV>
using a = parameter::plain<Mod9_impl::ahdsr_t<NV>, 0>;
template <int NV>
using d = parameter::plain<Mod9_impl::ahdsr_t<NV>, 3>;
template <int NV>
using s = parameter::plain<Mod9_impl::ahdsr_t<NV>, 4>;
template <int NV>
using r = parameter::plain<Mod9_impl::ahdsr_t<NV>, 5>;
template <int NV>
using h = parameter::plain<Mod9_impl::ahdsr_t<NV>, 2>;
template <int NV>
using crv = parameter::plain<Mod9_impl::ahdsr_t<NV>, 6>;
template <int NV>
using Mod9_t_plist = parameter::list<tempo<NV>, 
                                     multi<NV>, 
                                     packs, 
                                     type<NV>, 
                                     onshot<NV>, 
...
template <int NV>
using Mod9_t_ = container::chain<Mod9_t_parameters::Mod9_t_plist<NV>, 
                                 wrap::fix<2, modchain_t<NV>>>;

// =================================| Root node initialiser class |=================================

template <int NV> struct instance: public Mod9_impl::Mod9_t_<NV>
{
	...
	instance()
	{
		...
		auto& modchain = this->getT(0);                             // Mod9_impl::modchain_t<NV>
		auto& chain = this->getT(0).getT(0);                        // Mod9_impl::chain_t<NV>
		auto& tempo_sync = this->getT(0).getT(0).getT(0);           // Mod9_impl::tempo_sync_t<NV>
		auto& ramp = this->getT(0).getT(0).getT(1);                 // Mod9_impl::ramp_t<NV>
		auto& clear = this->getT(0).getT(0).getT(2);                // math::clear<NV>
		auto& branch = this->getT(0).getT(1);                       // Mod9_impl::branch_t<NV>
		auto& chain3 = this->getT(0).getT(1).getT(0);               // Mod9_impl::chain3_t<NV>
		auto& pack_resizer = this->getT(0).getT(1).getT(0).getT(0); // Mod9_impl::pack_resizer_t
		auto& cable_pack = this->getT(0).getT(1).getT(0).getT(1);   // Mod9_impl::cable_pack_t<NV>
		auto& add1 = this->getT(0).getT(1).getT(0).getT(2);         // math::add<NV>
		auto& chain4 = this->getT(0).getT(1).getT(1);               // Mod9_impl::chain4_t<NV>
		auto& cable_table = this->getT(0).getT(1).getT(1).getT(0);  // Mod9_impl::cable_table_t<NV>
		auto& add2 = this->getT(0).getT(1).getT(1).getT(1);         // math::add<NV>
		auto& chain5 = this->getT(0).getT(1).getT(2);               // Mod9_impl::chain5_t<NV>
		auto& add4 = this->getT(0).getT(1).getT(2).getT(0);         // math::add<NV>
		auto& rect = this->getT(0).getT(1).getT(2).getT(1);         // math::rect<NV>
		auto& peak1 = this->getT(0).getT(1).getT(2).getT(2);        // Mod9_impl::peak1_t<NV>
		auto& input_toggle = this->getT(0).getT(1).getT(2).getT(3); // Mod9_impl::input_toggle_t<NV>
		auto& clear1 = this->getT(0).getT(1).getT(2).getT(4);       // math::clear<NV>
		auto& ahdsr = this->getT(0).getT(1).getT(2).getT(5);        // Mod9_impl::ahdsr_t<NV>
		auto& add3 = this->getT(0).getT(1).getT(2).getT(6);         // math::add<NV>
		auto& peak = this->getT(0).getT(2);                         // Mod9_impl::peak_t<NV>
		auto& event_data_writer = this->getT(0).getT(3);            // routing::event_data_writer<NV>
		auto& chain1 = this->getT(0).getT(4);                       // Mod9_impl::chain1_t<NV>
		auto& ahdsr1 = this->getT(0).getT(4).getT(0);               // Mod9_impl::ahdsr1_t<NV>
		...
		event_data_writer.setParameterT(0, 4.); // routing::event_data_writer::SlotIndex
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(0).getT(0).getT(1).setExternalData(b, index);         // Mod9_impl::ramp_t<NV>
		this->getT(0).getT(1).getT(0).getT(0).setExternalData(b, index); // Mod9_impl::pack_resizer_t
		this->getT(0).getT(1).getT(0).getT(1).setExternalData(b, index); // Mod9_impl::cable_pack_t<NV>
		this->getT(0).getT(1).getT(1).getT(0).setExternalData(b, index); // Mod9_impl::cable_table_t<NV>
		this->getT(0).getT(1).getT(2).getT(2).setExternalData(b, index); // Mod9_impl::peak1_t<NV>
		this->getT(0).getT(1).getT(2).getT(5).setExternalData(b, index); // Mod9_impl::ahdsr_t<NV>
		this->getT(0).getT(2).setExternalData(b, index);                 // Mod9_impl::peak_t<NV>
		this->getT(0).getT(4).getT(0).setExternalData(b, index);         // Mod9_impl::ahdsr1_t<NV>
	}
};
}
...
template <int NV>
using Mod9 = wrap::node<Mod9_impl::instance<NV>>;
}
