...
using FoldSub = parameter::chain<ranges::Identity, 
                                 parameter::plain<FilterNew5_impl::smoothed_parameter6_t<NV>, 0>, 
                                 parameter::plain<FilterNew5_impl::smoothed_parameter_t<NV>, 0>>;
...
using FoldSmooth = parameter::chain<ranges::Identity, 
                                    parameter::plain<FilterNew5_impl::smoothed_parameter1_t<NV>, 1>, 
                                    parameter::plain<FilterNew5_impl::smoothed_parameter7_t<NV>, 1>>;
...
template <int NV> struct instance: public FilterNew5_impl::FilterNew5_t_<NV>
{
	...
	instance()
	{
		...
		auto& pma1 = this->getT(2);                                                        // FilterNew5_impl::pma1_t<NV>
		auto& xfader = this->getT(3);                                                      // FilterNew5_impl::xfader_t<NV>
		auto& softbypass_switch3 = this->getT(4);                                          // FilterNew5_impl::softbypass_switch3_t<NV>
		auto& switcher1 = this->getT(4).getT(0);                                           // FilterNew5_impl::switcher1_t<NV>
		auto& sb_container1 = this->getT(4).getT(1);                                       // FilterNew5_impl::sb_container1_t<NV>
		auto& sb5 = this->getT(4).getT(1).getT(0);                                         // FilterNew5_impl::sb5_t<NV>
		auto& split = this->getT(4).getT(1).getT(0).getT(0);                               // FilterNew5_impl::split_t<NV>
		auto& chain4 = this->getT(4).getT(1).getT(0).getT(0).getT(0);                      // FilterNew5_impl::chain4_t<NV>
		auto& smoothed_parameter = this->getT(4).getT(1).getT(0).getT(0).getT(0).getT(0);  // FilterNew5_impl::smoothed_parameter_t<NV>
		auto& smoothed_parameter1 = this->getT(4).getT(1).getT(0).getT(0).getT(0).getT(1); // FilterNew5_impl::smoothed_parameter1_t<NV>
		auto& split1 = this->getT(4).getT(1).getT(0).getT(0).getT(0).getT(2);              // FilterNew5_impl::split1_t<NV>
		auto& chain2 = this->getT(4).getT(1).getT(0).getT(0).getT(0).getT(2).getT(0);      // FilterNew5_impl::chain2_t<NV>
		auto& gain1 = this->getT(4).getT(1).getT(0).getT(0).                               // core::gain<NV>
                      getT(0).getT(2).getT(0).getT(0);
		auto& chain47 = this->getT(4).getT(1).getT(0).getT(0).getT(0).getT(2).getT(1);     // FilterNew5_impl::chain47_t<NV>
		...
		auto& filter1 = this->getT(4).getT(1).getT(0).getT(0).getT(0).getT(3);             // FilterNew5_impl::filter1_t<NV>
		auto& dry_path = this->getT(4).getT(1).getT(0).getT(0).getT(0).getT(3).getT(0);    // FilterNew5_impl::dry_path_t<NV>
		auto& pma10 = this->getT(4).getT(1).getT(0).getT(0).                               // FilterNew5_impl::pma10_t<NV>
                      getT(0).getT(3).getT(0).getT(0);
		auto& xfader1 = this->getT(4).getT(1).getT(0).getT(0).                             // FilterNew5_impl::xfader1_t<NV>
                        getT(0).getT(3).getT(0).getT(1);
		auto& gain = this->getT(4).getT(1).getT(0).getT(0).                                // core::gain<NV>
                     getT(0).getT(3).getT(0).getT(2);
		auto& wet_path = this->getT(4).getT(1).getT(0).getT(0).getT(0).getT(3).getT(1);    // FilterNew5_impl::wet_path_t<NV>
		auto& softbypass_switch5 = this->getT(4).getT(1).getT(0).getT(0).                  // FilterNew5_impl::softbypass_switch5_t<NV>
                                   getT(0).getT(3).getT(1).getT(0);
		auto& switcher = this->getT(4).getT(1).getT(0).getT(0).                            // FilterNew5_impl::switcher_t<NV>
                         getT(0).getT(3).getT(1).getT(0).
                         getT(0);
		auto& sb_container = this->getT(4).getT(1).getT(0).getT(0).                        // FilterNew5_impl::sb_container_t<NV>
                             getT(0).getT(3).getT(1).getT(0).
                             getT(1);
		auto& sb1 = this->getT(4).getT(1).getT(0).getT(0).getT(0).                         // FilterNew5_impl::sb1_t<NV>
                    getT(3).getT(1).getT(0).getT(1).getT(0);
		auto& svf = this->getT(4).getT(1).getT(0).getT(0).getT(0).                         // filters::svf<NV>
                    getT(3).getT(1).getT(0).getT(1).getT(0).
                    getT(0);
		auto& sb2 = this->getT(4).getT(1).getT(0).getT(0).getT(0).                         // FilterNew5_impl::sb2_t<NV>
                    getT(3).getT(1).getT(0).getT(1).getT(1);
		auto& svf1 = this->getT(4).getT(1).getT(0).getT(0).getT(0).                        // filters::svf<NV>
                     getT(3).getT(1).getT(0).getT(1).getT(1).
                     getT(0);
		auto& sb3 = this->getT(4).getT(1).getT(0).getT(0).getT(0).                         // FilterNew5_impl::sb3_t<NV>
                    getT(3).getT(1).getT(0).getT(1).getT(2);
		auto& svf2 = this->getT(4).getT(1).getT(0).getT(0).getT(0).                        // filters::svf<NV>
                     getT(3).getT(1).getT(0).getT(1).getT(2).
                     getT(0);
		auto& soft_bypass = this->getT(4).getT(1).getT(0).getT(0).getT(0).                 // FilterNew5_impl::soft_bypass_t<NV>
                            getT(3).getT(1).getT(0).getT(1).getT(3);
		auto& allpass = this->getT(4).getT(1).getT(0).getT(0).getT(0).                     // filters::allpass<NV>
                        getT(3).getT(1).getT(0).getT(1).getT(3).
                        getT(0);
		auto& soft_bypass1 = this->getT(4).getT(1).getT(0).getT(0).getT(0).                // FilterNew5_impl::soft_bypass1_t<NV>
                             getT(3).getT(1).getT(0).getT(1).getT(4);
		auto& ring_mod = this->getT(4).getT(1).getT(0).getT(0).getT(0).                    // filters::ring_mod<NV>
                         getT(3).getT(1).getT(0).getT(1).getT(4).
                         getT(0);
		auto& sb4 = this->getT(4).getT(1).getT(0).getT(0).getT(0).                         // FilterNew5_impl::sb4_t
                    getT(3).getT(1).getT(0).getT(1).getT(5);
		auto& gain17 = this->getT(4).getT(1).getT(0).getT(0).                              // core::gain<NV>
                       getT(0).getT(3).getT(1).getT(1);
		auto& sb6 = this->getT(4).getT(1).getT(1);                                         // FilterNew5_impl::sb6_t<NV>
		auto& split11 = this->getT(4).getT(1).getT(1).getT(0);                             // FilterNew5_impl::split11_t<NV>
		auto& chain54 = this->getT(4).getT(1).getT(1).getT(0).getT(0);                     // FilterNew5_impl::chain54_t<NV>
		auto& filter4 = this->getT(4).getT(1).getT(1).getT(0).getT(0).getT(0);             // FilterNew5_impl::filter4_t<NV>
		auto& dry_path3 = this->getT(4).getT(1).getT(1).getT(0).getT(0).getT(0).getT(0);   // FilterNew5_impl::dry_path3_t<NV>
		auto& pma13 = this->getT(4).getT(1).getT(1).getT(0).                               // FilterNew5_impl::pma13_t<NV>
                      getT(0).getT(0).getT(0).getT(0);
		auto& xfader4 = this->getT(4).getT(1).getT(1).getT(0).                             // FilterNew5_impl::xfader4_t<NV>
                        getT(0).getT(0).getT(0).getT(1);
		auto& gain11 = this->getT(4).getT(1).getT(1).getT(0).                              // core::gain<NV>
                       getT(0).getT(0).getT(0).getT(2);
		auto& wet_path3 = this->getT(4).getT(1).getT(1).getT(0).getT(0).getT(0).getT(1);   // FilterNew5_impl::wet_path3_t<NV>
		auto& softbypass_switch8 = this->getT(4).getT(1).getT(1).getT(0).                  // FilterNew5_impl::softbypass_switch8_t<NV>
                                   getT(0).getT(0).getT(1).getT(0);
		auto& switcher4 = this->getT(4).getT(1).getT(1).getT(0).                           // FilterNew5_impl::switcher4_t<NV>
                          getT(0).getT(0).getT(1).getT(0).
                          getT(0);
		auto& sb_container4 = this->getT(4).getT(1).getT(1).getT(0).                       // FilterNew5_impl::sb_container4_t<NV>
                              getT(0).getT(0).getT(1).getT(0).
                              getT(1);
		auto& sb15 = this->getT(4).getT(1).getT(1).getT(0).getT(0).                        // FilterNew5_impl::sb15_t<NV>
                     getT(0).getT(1).getT(0).getT(1).getT(0);
		auto& svf9 = this->getT(4).getT(1).getT(1).getT(0).getT(0).                        // filters::svf<NV>
                     getT(0).getT(1).getT(0).getT(1).getT(0).
                     getT(0);
		auto& sb16 = this->getT(4).getT(1).getT(1).getT(0).getT(0).                        // FilterNew5_impl::sb16_t<NV>
                     getT(0).getT(1).getT(0).getT(1).getT(1);
		auto& svf10 = this->getT(4).getT(1).getT(1).getT(0).getT(0).                       // filters::svf<NV>
                      getT(0).getT(1).getT(0).getT(1).getT(1).
                      getT(0);
		auto& sb17 = this->getT(4).getT(1).getT(1).getT(0).getT(0).                        // FilterNew5_impl::sb17_t<NV>
                     getT(0).getT(1).getT(0).getT(1).getT(2);
		auto& svf11 = this->getT(4).getT(1).getT(1).getT(0).getT(0).                       // filters::svf<NV>
                      getT(0).getT(1).getT(0).getT(1).getT(2).
                      getT(0);
		auto& soft_bypass6 = this->getT(4).getT(1).getT(1).getT(0).getT(0).                // FilterNew5_impl::soft_bypass6_t<NV>
                             getT(0).getT(1).getT(0).getT(1).getT(3);
		auto& allpass3 = this->getT(4).getT(1).getT(1).getT(0).getT(0).                    // filters::allpass<NV>
                         getT(0).getT(1).getT(0).getT(1).getT(3).
                         getT(0);
		auto& soft_bypass7 = this->getT(4).getT(1).getT(1).getT(0).getT(0).                // FilterNew5_impl::soft_bypass7_t<NV>
                             getT(0).getT(1).getT(0).getT(1).getT(4);
		auto& ring_mod3 = this->getT(4).getT(1).getT(1).getT(0).getT(0).                   // filters::ring_mod<NV>
                          getT(0).getT(1).getT(0).getT(1).getT(4).
                          getT(0);
		auto& sb18 = this->getT(4).getT(1).getT(1).getT(0).getT(0).                        // FilterNew5_impl::sb18_t
                     getT(0).getT(1).getT(0).getT(1).getT(5);
		auto& gain20 = this->getT(4).getT(1).getT(1).getT(0).                              // core::gain<NV>
                       getT(0).getT(0).getT(1).getT(1);
		auto& smoothed_parameter6 = this->getT(4).getT(1).getT(1).getT(0).getT(0).getT(1); // FilterNew5_impl::smoothed_parameter6_t<NV>
		auto& smoothed_parameter7 = this->getT(4).getT(1).getT(1).getT(0).getT(0).getT(2); // FilterNew5_impl::smoothed_parameter7_t<NV>
		auto& split12 = this->getT(4).getT(1).getT(1).getT(0).getT(0).getT(3);             // FilterNew5_impl::split12_t<NV>
		auto& chain55 = this->getT(4).getT(1).getT(1).getT(0).getT(0).getT(3).getT(0);     // FilterNew5_impl::chain55_t<NV>
		auto& gain9 = this->getT(4).getT(1).getT(1).getT(0).                               // core::gain<NV>
                      getT(0).getT(3).getT(0).getT(0);
		auto& chain56 = this->getT(4).getT(1).getT(1).getT(0).getT(0).getT(3).getT(1); // FilterNew5_impl::chain56_t<NV>
