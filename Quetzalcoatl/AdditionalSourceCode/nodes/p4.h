...
using global_cable9_t_index = runtime_target::indexers::fix_hash<3449329>;
...
namespace p4_t_parameters
{
// Parameter list for p4_impl::p4_t ----------------------------------------------------------------
...
using ModSrc = parameter::chain<ModSrc_InputRange, 
                                parameter::plain<p4_impl::cable_table1_t<NV>, 0>, 
                                parameter::plain<p4_impl::cable_table15_t<NV>, 0>, 
                                parameter::plain<p4_impl::cable_table16_t<NV>, 0>>;

template <int NV>
using Mod = parameter::plain<p4_impl::pma1_t<NV>, 1>;
template <int NV>
using p4_t_plist = parameter::list<Mod<NV>, ModSrc<NV>>;
}

template <int NV>
using p4_t_ = container::chain<p4_t_parameters::p4_t_plist<NV>, 
                               wrap::fix<2, modchain_t<NV>>, 
                               chain40_t<NV>>;

// =================================| Root node initialiser class |=================================

template <int NV> struct instance: public p4_impl::p4_t_<NV>
{
	...
	instance()
	{
		...
		auto& modchain = this->getT(0);                                                // p4_impl::modchain_t<NV>
		auto& chain = this->getT(0).getT(0);                                           // p4_impl::chain_t<NV>
		auto& chain30 = this->getT(0).getT(0).getT(0);                                 // p4_impl::chain30_t<NV>
		auto& cable_table1 = this->getT(0).getT(0).getT(0).getT(0);                    // p4_impl::cable_table1_t<NV>
		auto& cable_table15 = this->getT(0).getT(0).getT(0).getT(1);                   // p4_impl::cable_table15_t<NV>
		auto& cable_table16 = this->getT(0).getT(0).getT(0).getT(2);                   // p4_impl::cable_table16_t<NV>
		auto& split9 = this->getT(0).getT(0).getT(0).getT(3);                          // p4_impl::split9_t<NV>
		auto& event_data_reader10 = this->getT(0).getT(0).getT(0).getT(3).getT(0);     // p4_impl::event_data_reader10_t<NV>
		auto& chain31 = this->getT(0).getT(0).getT(0).getT(3).getT(1);                 // p4_impl::chain31_t<NV>
		auto& branch3 = this->getT(0).getT(0).getT(0).getT(3).getT(1).getT(0);         // p4_impl::branch3_t<NV>
		auto& chain32 = this->getT(0).getT(0).getT(0).getT(3).getT(1).getT(0).getT(0); // p4_impl::chain32_t<NV>
		auto& global_cable7 = this->getT(0).getT(0).getT(0).getT(3).                   // p4_impl::global_cable7_t<NV>
                              getT(1).getT(0).getT(0).getT(0);
		auto& add24 = this->getT(0).getT(0).getT(0).getT(3).                           // math::add<NV>
                      getT(1).getT(0).getT(0).getT(1);
		auto& chain33 = this->getT(0).getT(0).getT(0).getT(3).getT(1).getT(0).getT(1); // p4_impl::chain33_t<NV>
		auto& global_cable8 = this->getT(0).getT(0).getT(0).getT(3).                   // p4_impl::global_cable8_t<NV>
                              getT(1).getT(0).getT(1).getT(0);
		auto& add25 = this->getT(0).getT(0).getT(0).getT(3).                           // math::add<NV>
                      getT(1).getT(0).getT(1).getT(1);
		auto& chain34 = this->getT(0).getT(0).getT(0).getT(3).getT(1).getT(0).getT(2); // p4_impl::chain34_t<NV>
		auto& global_cable28 = this->getT(0).getT(0).getT(0).getT(3).                  // p4_impl::global_cable28_t<NV>
                               getT(1).getT(0).getT(2).getT(0);
		auto& add26 = this->getT(0).getT(0).getT(0).getT(3).                           // math::add<NV>
                      getT(1).getT(0).getT(2).getT(1);
		auto& chain35 = this->getT(0).getT(0).getT(0).getT(3).getT(1).getT(0).getT(3); // p4_impl::chain35_t<NV>
		auto& global_cable29 = this->getT(0).getT(0).getT(0).getT(3).                  // p4_impl::global_cable29_t<NV>
                               getT(1).getT(0).getT(3).getT(0);
		auto& add27 = this->getT(0).getT(0).getT(0).getT(3).                           // math::add<NV>
                      getT(1).getT(0).getT(3).getT(1);
		auto& chain36 = this->getT(0).getT(0).getT(0).getT(3).getT(1).getT(0).getT(4); // p4_impl::chain36_t<NV>
		auto& global_cable30 = this->getT(0).getT(0).getT(0).getT(3).                  // p4_impl::global_cable30_t<NV>
                               getT(1).getT(0).getT(4).getT(0);
		auto& add28 = this->getT(0).getT(0).getT(0).getT(3).                           // math::add<NV>
                      getT(1).getT(0).getT(4).getT(1);
		auto& chain37 = this->getT(0).getT(0).getT(0).getT(3).getT(1).getT(0).getT(5); // p4_impl::chain37_t<NV>
		auto& global_cable31 = this->getT(0).getT(0).getT(0).getT(3).                  // p4_impl::global_cable31_t<NV>
                               getT(1).getT(0).getT(5).getT(0);
		auto& add29 = this->getT(0).getT(0).getT(0).getT(3).                           // math::add<NV>
                      getT(1).getT(0).getT(5).getT(1);
		auto& chain38 = this->getT(0).getT(0).getT(0).getT(3).getT(1).getT(0).getT(6); // p4_impl::chain38_t<NV>
		auto& global_cable32 = this->getT(0).getT(0).getT(0).getT(3).                  // p4_impl::global_cable32_t<NV>
                               getT(1).getT(0).getT(6).getT(0);
		auto& add30 = this->getT(0).getT(0).getT(0).getT(3).                           // math::add<NV>
                      getT(1).getT(0).getT(6).getT(1);
		auto& chain39 = this->getT(0).getT(0).getT(0).getT(3).getT(1).getT(0).getT(7); // p4_impl::chain39_t<NV>
		auto& global_cable33 = this->getT(0).getT(0).getT(0).getT(3).                  // p4_impl::global_cable33_t<NV>
                               getT(1).getT(0).getT(7).getT(0);
		auto& add31 = this->getT(0).getT(0).getT(0).getT(3).                 // math::add<NV>
                      getT(1).getT(0).getT(7).getT(1);
		auto& peak3 = this->getT(0).getT(0).getT(0).getT(3).getT(1).getT(1); // p4_impl::peak3_t<NV>
		auto& clear = this->getT(0).getT(0).getT(0).getT(3).getT(1).getT(2); // math::clear<NV>
		auto& input_toggle3 = this->getT(0).getT(0).getT(0).getT(4);         // p4_impl::input_toggle3_t<NV>
		auto& chain40 = this->getT(1);                                       // p4_impl::chain40_t<NV>
		auto& global_cable9 = this->getT(1).getT(0);                         // p4_impl::global_cable9_t<NV>
		auto& pma1 = this->getT(1).getT(1);                                  // p4_impl::pma1_t<NV>
	...
	void connectToRuntimeTarget(bool addConnection, const runtime_target::connection& c)
	{
		...
		this->getT(0).getT(0).getT(0).getT(3).                          // p4_impl::global_cable7_t<NV>
        getT(1).getT(0).getT(0).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(0).getT(3).                          // p4_impl::global_cable8_t<NV>
        getT(1).getT(0).getT(1).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(0).getT(3).                          // p4_impl::global_cable28_t<NV>
        getT(1).getT(0).getT(2).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(0).getT(3).                          // p4_impl::global_cable29_t<NV>
        getT(1).getT(0).getT(3).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(0).getT(3).                          // p4_impl::global_cable30_t<NV>
        getT(1).getT(0).getT(4).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(0).getT(3).                          // p4_impl::global_cable31_t<NV>
        getT(1).getT(0).getT(5).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(0).getT(3).                          // p4_impl::global_cable32_t<NV>
        getT(1).getT(0).getT(6).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(0).getT(3).                          // p4_impl::global_cable33_t<NV>
        getT(1).getT(0).getT(7).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(1).getT(0).connectToRuntimeTarget(addConnection, c); // p4_impl::global_cable9_t<NV>
	}
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(0).getT(0).getT(0).getT(0).setExternalData(b, index);                 // p4_impl::cable_table1_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).setExternalData(b, index);                 // p4_impl::cable_table15_t<NV>
		this->getT(0).getT(0).getT(0).getT(2).setExternalData(b, index);                 // p4_impl::cable_table16_t<NV>
		this->getT(0).getT(0).getT(0).getT(3).getT(1).getT(1).setExternalData(b, index); // p4_impl::peak3_t<NV>
	}
};
}
...
template <int NV>
using p4 = wrap::node<p4_impl::instance<NV>>;
}
