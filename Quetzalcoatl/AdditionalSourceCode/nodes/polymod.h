...
template <int NV>
using A_0 = parameter::from0To1<polymod_impl::simple_ar_t<NV>, 
                                0, 
                                A_0Range>;

template <int NV>
using A = parameter::chain<A_InputRange, A_0<NV>>;

DECLARE_PARAMETER_RANGE_SKEW(H_InputRange, 
                             0., 
                             10000., 
                             0.197672);

template <int NV>
using H = parameter::chain<H_InputRange, 
                           parameter::plain<polymod_impl::simple_ar_t<NV>, 3>>;
...
DECLARE_PARAMETER_RANGE_SKEW(R_InputRange, 
                             ...
                             0.197672);
template <int NV>
using R_0 = parameter::from0To1<polymod_impl::simple_ar_t<NV>, 
                                1, 
                                A_0Range>;

template <int NV>
using R = parameter::chain<R_InputRange, R_0<NV>>;
...
using etrig = parameter::plain<polymod_impl::input_toggle_t<NV>, 
                               0>;
using inputpeak = parameter::empty;
                                    ...
                                    public routing::public_mod_target
{
	...
	instance()
	{
		...
		auto& no_midi = this->getT(0).getT(1);                                               // polymod_impl::no_midi_t<NV>
		auto& tempo_sync = this->getT(0).getT(1).getT(0);                                    // polymod_impl::tempo_sync_t<NV>
		auto& ramp = this->getT(0).getT(1).getT(1);                                          // polymod_impl::ramp_t<NV>
		auto& clear6 = this->getT(0).getT(2);                                                // math::clear<NV>
		auto& softbypass_switch6 = this->getT(0).getT(3);                                    // polymod_impl::softbypass_switch6_t<NV>
		auto& cable_table1 = this->getT(0).getT(3).getT(0);                                  // polymod_impl::cable_table1_t<NV>
		auto& switcher = this->getT(0).getT(3).getT(1);                                      // polymod_impl::switcher_t<NV>
		auto& clear1 = this->getT(0).getT(3).getT(2);                                        // math::clear<NV>
		auto& sb_container = this->getT(0).getT(3).getT(3);                                  // polymod_impl::sb_container_t<NV>
		auto& sb1 = this->getT(0).getT(3).getT(3).getT(0);                                   // polymod_impl::sb1_t<NV>
		auto& minmax = this->getT(0).getT(3).getT(3).getT(0).getT(0);                        // polymod_impl::minmax_t<NV>
		auto& clear5 = this->getT(0).getT(3).getT(3).getT(0).getT(1);                        // math::clear<NV>
		auto& input_toggle = this->getT(0).getT(3).getT(3).getT(0).getT(2);                  // polymod_impl::input_toggle_t<NV>
		auto& ahdsr3 = this->getT(0).getT(3).getT(3).getT(0).getT(3);                        // polymod_impl::ahdsr3_t<NV>
		auto& add12 = this->getT(0).getT(3).getT(3).getT(0).getT(4);                         // math::add<NV>
		auto& sb2 = this->getT(0).getT(3).getT(3).getT(1);                                   // polymod_impl::sb2_t<NV>
		auto& cable_table = this->getT(0).getT(3).getT(3).getT(1).getT(0);                   // polymod_impl::cable_table_t<NV>
		auto& add1 = this->getT(0).getT(3).getT(3).getT(1).getT(1);                          // math::add<NV>
		auto& sb6 = this->getT(0).getT(3).getT(3).getT(2);                                   // polymod_impl::sb6_t<NV>
		auto& split2 = this->getT(0).getT(3).getT(3).getT(2).getT(0);                        // polymod_impl::split2_t<NV>
		auto& chain = this->getT(0).getT(3).getT(3).getT(2).getT(0).getT(0);                 // polymod_impl::chain_t<NV>
		auto& pack8_writer = this->getT(0).getT(3).getT(3).getT(2).getT(0).getT(0).getT(0);  // polymod_impl::pack8_writer_t
		auto& cable_table8 = this->getT(0).getT(3).getT(3).getT(2).getT(0).getT(0).getT(1);  // polymod_impl::cable_table8_t
		auto& clear4 = this->getT(0).getT(3).getT(3).getT(2).getT(0).getT(0).getT(2);        // math::clear<NV>
		auto& cable_pack = this->getT(0).getT(3).getT(3).getT(2).getT(0).getT(0).getT(3);    // polymod_impl::cable_pack_t<NV>
		auto& add8 = this->getT(0).getT(3).getT(3).getT(2).getT(1);                          // math::add<NV>
		auto& soft_bypass = this->getT(0).getT(3).getT(3).getT(3);                           // polymod_impl::soft_bypass_t<NV>
		auto& split6 = this->getT(0).getT(3).getT(3).getT(3).getT(0);                        // polymod_impl::split6_t<NV>
		auto& chain7 = this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(0);                // polymod_impl::chain7_t<NV>
		auto& cable_table4 = this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(0).getT(0);  // polymod_impl::cable_table4_t<NV>
		auto& pack8_writer2 = this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(0).getT(1); // polymod_impl::pack8_writer2_t
		auto& cable_pack3 = this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(0).getT(2);   // polymod_impl::cable_pack3_t<NV>
		auto& add7 = this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(0).getT(3);          // math::add<NV>
		auto& chain11 = this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(1);               // polymod_impl::chain11_t<NV>
		auto& cable_table7 = this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(1).getT(0);  // polymod_impl::cable_table7_t<NV>
		auto& pack8_writer5 = this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(1).getT(1); // polymod_impl::pack8_writer5_t
		auto& cable_pack6 = this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(1).getT(2);   // polymod_impl::cable_pack6_t<NV>
		auto& add10 = this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(1).getT(3);         // math::add<NV>
		auto& peak2 = this->getT(0).getT(3).getT(3).getT(3).getT(1);                         // polymod_impl::peak2_t<NV>
		auto& clear2 = this->getT(0).getT(3).getT(3).getT(3).getT(2);                        // math::clear<NV>
		auto& no_midi1 = this->getT(0).getT(3).getT(3).getT(3).getT(3);                      // polymod_impl::no_midi1_t<NV>
		auto& simple_ar = this->getT(0).getT(3).getT(3).getT(3).getT(3).getT(0);             // polymod_impl::simple_ar_t<NV>
		auto& add2 = this->getT(0).getT(3).getT(3).getT(3).getT(3).getT(1);                  // wrap::no_process<math::add<NV>>
		auto& add13 = this->getT(0).getT(3).getT(3).getT(3).getT(3).getT(2);                 // math::add<NV>
		auto& peak1 = this->getT(0).getT(4);                                                 // polymod_impl::peak1_t
		auto& public_mod = this->getT(0).getT(5);                                            // routing::public_mod
		...
		add2.setParameterT(0, 0.); // math::add::Value
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(0).getT(1).getT(1).setExternalData(b, index);                                 // polymod_impl::ramp_t<NV>
		this->getT(0).getT(3).getT(0).setExternalData(b, index);                                 // polymod_impl::cable_table1_t<NV>
		this->getT(0).getT(3).getT(3).getT(0).getT(3).setExternalData(b, index);                 // polymod_impl::ahdsr3_t<NV>
		this->getT(0).getT(3).getT(3).getT(1).getT(0).setExternalData(b, index);                 // polymod_impl::cable_table_t<NV>
		this->getT(0).getT(3).getT(3).getT(2).getT(0).getT(0).getT(0).setExternalData(b, index); // polymod_impl::pack8_writer_t
		this->getT(0).getT(3).getT(3).getT(2).getT(0).getT(0).getT(1).setExternalData(b, index); // polymod_impl::cable_table8_t
		this->getT(0).getT(3).getT(3).getT(2).getT(0).getT(0).getT(3).setExternalData(b, index); // polymod_impl::cable_pack_t<NV>
		this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(0).getT(0).setExternalData(b, index); // polymod_impl::cable_table4_t<NV>
		this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(0).getT(1).setExternalData(b, index); // polymod_impl::pack8_writer2_t
		this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(0).getT(2).setExternalData(b, index); // polymod_impl::cable_pack3_t<NV>
		this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(1).getT(0).setExternalData(b, index); // polymod_impl::cable_table7_t<NV>
		this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(1).getT(1).setExternalData(b, index); // polymod_impl::pack8_writer5_t
		this->getT(0).getT(3).getT(3).getT(3).getT(0).getT(1).getT(2).setExternalData(b, index); // polymod_impl::cable_pack6_t<NV>
		this->getT(0).getT(3).getT(3).getT(3).getT(1).setExternalData(b, index);                 // polymod_impl::peak2_t<NV>
		this->getT(0).getT(3).getT(3).getT(3).getT(3).getT(0).setExternalData(b, index);         // polymod_impl::simple_ar_t<NV>
		this->getT(0).getT(4).setExternalData(b, index);                                         // polymod_impl::peak1_t
	}
};
}
