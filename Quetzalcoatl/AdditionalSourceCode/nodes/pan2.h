...
using global_cable_t_index = runtime_target::indexers::fix_hash<3433269>;
...
template <int NV>
using pan2_t_ = container::chain<parameter::empty, 
                                 wrap::fix<2, chain_t<NV>>, 
                                 core::gain<NV>>;

// =================================| Root node initialiser class |=================================

template <int NV> struct instance: public pan2_impl::pan2_t_<NV>
{
	...
	instance()
	{
		...
		auto& chain = this->getT(0);                // pan2_impl::chain_t<NV>
		auto& global_cable = this->getT(0).getT(0); // pan2_impl::global_cable_t<NV>
	...
	void connectToRuntimeTarget(bool addConnection, const runtime_target::connection& c)
	{
		...
		this->getT(0).getT(0).connectToRuntimeTarget(addConnection, c); // pan2_impl::global_cable_t<NV>
	}
};
}
...
template <int NV>
using pan2 = wrap::node<pan2_impl::instance<NV>>;
}
