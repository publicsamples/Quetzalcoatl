...
template <int NV>
using peak14_t = wrap::mod<parameter::plain<routing::event_data_writer<NV>, 1>, 
                           wrap::no_data<core::peak>>;
...
template <int NV> using peak15_t = peak14_t<NV>;

template <int NV>
using chain71_t = container::chain<parameter::empty, 
                                   wrap::fix<1, peak15_t<NV>>>;

template <int NV> using peak16_t = peak14_t<NV>;

template <int NV>
using chain72_t = container::chain<parameter::empty, 
                                   wrap::fix<1, peak16_t<NV>>>;

template <int NV> using peak17_t = peak14_t<NV>;

template <int NV>
using chain73_t = container::chain<parameter::empty, 
                                   wrap::fix<1, peak17_t<NV>>>;

template <int NV> using peak18_t = peak14_t<NV>;

template <int NV>
using chain74_t = container::chain<parameter::empty, 
                                   wrap::fix<1, peak18_t<NV>>>;

template <int NV> using peak19_t = peak14_t<NV>;

template <int NV>
using chain75_t = container::chain<parameter::empty, 
                                   wrap::fix<1, peak19_t<NV>>>;

template <int NV> using peak20_t = peak14_t<NV>;

template <int NV>
using chain76_t = container::chain<parameter::empty, 
                                   wrap::fix<1, peak20_t<NV>>>;

template <int NV> using peak21_t = peak14_t<NV>;
...
template <int NV>
using Shape_0 = parameter::from0To1<modtest2_impl::branch_t<NV>, 
                                    0, 
                                    Shape_0Range>;
...
template <int NV>
using Modifiers_0 = parameter::from0To1<modtest2_impl::branch1_t<NV>, 
                                        0, 
                                        Modifiers_0Range>;
...
template <int NV>
using ModiferShape = parameter::from0To1<modtest2_impl::pma_t<NV>, 
                                         2, 
                                         Tempo_0Range>;
...
template <int NV>
using trigmode_0 = parameter::from0To1<modtest2_impl::branch6_t<NV>, 
                                       0, 
                                       trigmode_0Range>;
...
template <int NV>
using TempoMod = parameter::plain<modtest2_impl::pma1_t<NV>, 
                                  1>;
template <int NV>
using TempoSrc = parameter::plain<modtest2_impl::branch3_t<NV>, 
                                  0>;
template <int NV>
using Div = parameter::plain<modtest2_impl::tempo_sync_t<NV>, 
                             1>;
template <int NV>
using ModifierShapeMod = parameter::plain<modtest2_impl::pma_t<NV>, 
                                          1>;
template <int NV>
using ModifierShapeModSrc = parameter::plain<modtest2_impl::branch5_t<NV>, 
                                             0>;
using out = parameter::empty;
template <int NV>
using oneshot = parameter::plain<modtest2_impl::ramp_t<NV>, 
                                 1>;
using OUTPUT = out;
template <int NV>
...
template <int NV> struct instance: public modtest2_impl::modtest2_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ENCODED_PARAMETERS(224)
		{
            ...
            0x4170, 0x0000, 0x0000, 0x0000, 0x3F80, 0x0000, 0x3F80, 0x0B5B, 
	...
	instance()
	{
		...
		auto& modchain = this->getT(0);                                                // modtest2_impl::modchain_t<NV>
		auto& chain12 = this->getT(0).getT(0);                                         // modtest2_impl::chain12_t<NV>
		auto& branch3 = this->getT(0).getT(0).getT(0);                                 // modtest2_impl::branch3_t<NV>
		auto& chain = this->getT(0).getT(0).getT(0).getT(0);                           // modtest2_impl::chain_t<NV>
		auto& global_cable1 = this->getT(0).getT(0).getT(0).getT(0).getT(0);           // modtest2_impl::global_cable1_t<NV>
		auto& add2 = this->getT(0).getT(0).getT(0).getT(0).getT(1);                    // math::add<NV>
		auto& chain2 = this->getT(0).getT(0).getT(0).getT(1);                          // modtest2_impl::chain2_t<NV>
		auto& global_cable2 = this->getT(0).getT(0).getT(0).getT(1).getT(0);           // modtest2_impl::global_cable2_t<NV>
		auto& add4 = this->getT(0).getT(0).getT(0).getT(1).getT(1);                    // math::add<NV>
		auto& chain3 = this->getT(0).getT(0).getT(0).getT(2);                          // modtest2_impl::chain3_t<NV>
		auto& global_cable3 = this->getT(0).getT(0).getT(0).getT(2).getT(0);           // modtest2_impl::global_cable3_t<NV>
		auto& add5 = this->getT(0).getT(0).getT(0).getT(2).getT(1);                    // math::add<NV>
		auto& chain4 = this->getT(0).getT(0).getT(0).getT(3);                          // modtest2_impl::chain4_t<NV>
		auto& global_cable4 = this->getT(0).getT(0).getT(0).getT(3).getT(0);           // modtest2_impl::global_cable4_t<NV>
		auto& add6 = this->getT(0).getT(0).getT(0).getT(3).getT(1);                    // math::add<NV>
		auto& chain6 = this->getT(0).getT(0).getT(0).getT(4);                          // modtest2_impl::chain6_t<NV>
		auto& global_cable5 = this->getT(0).getT(0).getT(0).getT(4).getT(0);           // modtest2_impl::global_cable5_t<NV>
		auto& add7 = this->getT(0).getT(0).getT(0).getT(4).getT(1);                    // math::add<NV>
		auto& chain7 = this->getT(0).getT(0).getT(0).getT(5);                          // modtest2_impl::chain7_t<NV>
		auto& global_cable6 = this->getT(0).getT(0).getT(0).getT(5).getT(0);           // modtest2_impl::global_cable6_t<NV>
		auto& add8 = this->getT(0).getT(0).getT(0).getT(5).getT(1);                    // math::add<NV>
		auto& chain9 = this->getT(0).getT(0).getT(0).getT(6);                          // modtest2_impl::chain9_t<NV>
		auto& global_cable7 = this->getT(0).getT(0).getT(0).getT(6).getT(0);           // modtest2_impl::global_cable7_t<NV>
		auto& add9 = this->getT(0).getT(0).getT(0).getT(6).getT(1);                    // math::add<NV>
		auto& chain10 = this->getT(0).getT(0).getT(0).getT(7);                         // modtest2_impl::chain10_t<NV>
		auto& global_cable8 = this->getT(0).getT(0).getT(0).getT(7).getT(0);           // modtest2_impl::global_cable8_t<NV>
		auto& add10 = this->getT(0).getT(0).getT(0).getT(7).getT(1);                   // math::add<NV>
		auto& chain14 = this->getT(0).getT(0).getT(0).getT(8);                         // modtest2_impl::chain14_t<NV>
		auto& global_cable10 = this->getT(0).getT(0).getT(0).getT(8).getT(0);          // modtest2_impl::global_cable10_t<NV>
		auto& add12 = this->getT(0).getT(0).getT(0).getT(8).getT(1);                   // math::add<NV>
		auto& chain15 = this->getT(0).getT(0).getT(0).getT(9);                         // modtest2_impl::chain15_t<NV>
		auto& global_cable11 = this->getT(0).getT(0).getT(0).getT(9).getT(0);          // modtest2_impl::global_cable11_t<NV>
		auto& add13 = this->getT(0).getT(0).getT(0).getT(9).getT(1);                   // math::add<NV>
		auto& chain25 = this->getT(0).getT(0).getT(0).getT(10);                        // modtest2_impl::chain25_t<NV>
		auto& global_cable12 = this->getT(0).getT(0).getT(0).getT(10).getT(0);         // modtest2_impl::global_cable12_t<NV>
		auto& add14 = this->getT(0).getT(0).getT(0).getT(10).getT(1);                  // math::add<NV>
		auto& chain17 = this->getT(0).getT(0).getT(0).getT(11);                        // modtest2_impl::chain17_t<NV>
		auto& global_cable13 = this->getT(0).getT(0).getT(0).getT(11).getT(0);         // modtest2_impl::global_cable13_t<NV>
		auto& add15 = this->getT(0).getT(0).getT(0).getT(11).getT(1);                  // math::add<NV>
		auto& chain18 = this->getT(0).getT(0).getT(0).getT(12);                        // modtest2_impl::chain18_t<NV>
		auto& global_cable14 = this->getT(0).getT(0).getT(0).getT(12).getT(0);         // modtest2_impl::global_cable14_t<NV>
		auto& add16 = this->getT(0).getT(0).getT(0).getT(12).getT(1);                  // math::add<NV>
		auto& chain19 = this->getT(0).getT(0).getT(0).getT(13);                        // modtest2_impl::chain19_t<NV>
		auto& global_cable15 = this->getT(0).getT(0).getT(0).getT(13).getT(0);         // modtest2_impl::global_cable15_t<NV>
		auto& add17 = this->getT(0).getT(0).getT(0).getT(13).getT(1);                  // math::add<NV>
		auto& chain21 = this->getT(0).getT(0).getT(0).getT(14);                        // modtest2_impl::chain21_t<NV>
		auto& global_cable16 = this->getT(0).getT(0).getT(0).getT(14).getT(0);         // modtest2_impl::global_cable16_t<NV>
		auto& add18 = this->getT(0).getT(0).getT(0).getT(14).getT(1);                  // math::add<NV>
		auto& chain22 = this->getT(0).getT(0).getT(0).getT(15);                        // modtest2_impl::chain22_t<NV>
		auto& global_cable17 = this->getT(0).getT(0).getT(0).getT(15).getT(0);         // modtest2_impl::global_cable17_t<NV>
		auto& add19 = this->getT(0).getT(0).getT(0).getT(15).getT(1);                  // math::add<NV>
		auto& peak1 = this->getT(0).getT(0).getT(1);                                   // modtest2_impl::peak1_t<NV>
		auto& clear = this->getT(0).getT(0).getT(2);                                   // math::clear<NV>
		auto& chain27 = this->getT(0).getT(0).getT(3);                                 // modtest2_impl::chain27_t<NV>
		auto& branch5 = this->getT(0).getT(0).getT(3).getT(0);                         // modtest2_impl::branch5_t<NV>
		auto& chain28 = this->getT(0).getT(0).getT(3).getT(0).getT(0);                 // modtest2_impl::chain28_t<NV>
		auto& global_cable19 = this->getT(0).getT(0).getT(3).getT(0).getT(0).getT(0);  // modtest2_impl::global_cable19_t<NV>
		auto& add21 = this->getT(0).getT(0).getT(3).getT(0).getT(0).getT(1);           // math::add<NV>
		auto& chain30 = this->getT(0).getT(0).getT(3).getT(0).getT(1);                 // modtest2_impl::chain30_t<NV>
		auto& global_cable20 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(0);  // modtest2_impl::global_cable20_t<NV>
		auto& add22 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(1);           // math::add<NV>
		auto& chain31 = this->getT(0).getT(0).getT(3).getT(0).getT(2);                 // modtest2_impl::chain31_t<NV>
		auto& global_cable21 = this->getT(0).getT(0).getT(3).getT(0).getT(2).getT(0);  // modtest2_impl::global_cable21_t<NV>
		auto& add23 = this->getT(0).getT(0).getT(3).getT(0).getT(2).getT(1);           // math::add<NV>
		auto& chain33 = this->getT(0).getT(0).getT(3).getT(0).getT(3);                 // modtest2_impl::chain33_t<NV>
		auto& global_cable22 = this->getT(0).getT(0).getT(3).getT(0).getT(3).getT(0);  // modtest2_impl::global_cable22_t<NV>
		auto& add24 = this->getT(0).getT(0).getT(3).getT(0).getT(3).getT(1);           // math::add<NV>
		auto& chain34 = this->getT(0).getT(0).getT(3).getT(0).getT(4);                 // modtest2_impl::chain34_t<NV>
		auto& global_cable23 = this->getT(0).getT(0).getT(3).getT(0).getT(4).getT(0);  // modtest2_impl::global_cable23_t<NV>
		auto& add25 = this->getT(0).getT(0).getT(3).getT(0).getT(4).getT(1);           // math::add<NV>
		auto& chain36 = this->getT(0).getT(0).getT(3).getT(0).getT(5);                 // modtest2_impl::chain36_t<NV>
		auto& global_cable24 = this->getT(0).getT(0).getT(3).getT(0).getT(5).getT(0);  // modtest2_impl::global_cable24_t<NV>
		auto& add26 = this->getT(0).getT(0).getT(3).getT(0).getT(5).getT(1);           // math::add<NV>
		auto& chain37 = this->getT(0).getT(0).getT(3).getT(0).getT(6);                 // modtest2_impl::chain37_t<NV>
		auto& global_cable25 = this->getT(0).getT(0).getT(3).getT(0).getT(6).getT(0);  // modtest2_impl::global_cable25_t<NV>
		auto& add27 = this->getT(0).getT(0).getT(3).getT(0).getT(6).getT(1);           // math::add<NV>
		auto& chain38 = this->getT(0).getT(0).getT(3).getT(0).getT(7);                 // modtest2_impl::chain38_t<NV>
		auto& global_cable26 = this->getT(0).getT(0).getT(3).getT(0).getT(7).getT(0);  // modtest2_impl::global_cable26_t<NV>
		auto& add28 = this->getT(0).getT(0).getT(3).getT(0).getT(7).getT(1);           // math::add<NV>
		auto& chain39 = this->getT(0).getT(0).getT(3).getT(0).getT(8);                 // modtest2_impl::chain39_t<NV>
		auto& global_cable27 = this->getT(0).getT(0).getT(3).getT(0).getT(8).getT(0);  // modtest2_impl::global_cable27_t<NV>
		auto& add29 = this->getT(0).getT(0).getT(3).getT(0).getT(8).getT(1);           // math::add<NV>
		auto& chain40 = this->getT(0).getT(0).getT(3).getT(0).getT(9);                 // modtest2_impl::chain40_t<NV>
		auto& global_cable28 = this->getT(0).getT(0).getT(3).getT(0).getT(9).getT(0);  // modtest2_impl::global_cable28_t<NV>
		auto& add30 = this->getT(0).getT(0).getT(3).getT(0).getT(9).getT(1);           // math::add<NV>
		auto& chain42 = this->getT(0).getT(0).getT(3).getT(0).getT(10);                // modtest2_impl::chain42_t<NV>
		auto& global_cable29 = this->getT(0).getT(0).getT(3).getT(0).getT(10).getT(0); // modtest2_impl::global_cable29_t<NV>
		auto& add31 = this->getT(0).getT(0).getT(3).getT(0).getT(10).getT(1);          // math::add<NV>
		auto& chain43 = this->getT(0).getT(0).getT(3).getT(0).getT(11);                // modtest2_impl::chain43_t<NV>
		auto& global_cable30 = this->getT(0).getT(0).getT(3).getT(0).getT(11).getT(0); // modtest2_impl::global_cable30_t<NV>
		auto& add32 = this->getT(0).getT(0).getT(3).getT(0).getT(11).getT(1);          // math::add<NV>
		auto& chain52 = this->getT(0).getT(0).getT(3).getT(0).getT(12);                // modtest2_impl::chain52_t<NV>
		auto& global_cable31 = this->getT(0).getT(0).getT(3).getT(0).getT(12).getT(0); // modtest2_impl::global_cable31_t<NV>
		auto& add33 = this->getT(0).getT(0).getT(3).getT(0).getT(12).getT(1);          // math::add<NV>
		auto& chain53 = this->getT(0).getT(0).getT(3).getT(0).getT(13);                // modtest2_impl::chain53_t<NV>
		auto& global_cable32 = this->getT(0).getT(0).getT(3).getT(0).getT(13).getT(0); // modtest2_impl::global_cable32_t<NV>
		auto& add34 = this->getT(0).getT(0).getT(3).getT(0).getT(13).getT(1);          // math::add<NV>
		auto& chain54 = this->getT(0).getT(0).getT(3).getT(0).getT(14);                // modtest2_impl::chain54_t<NV>
		auto& global_cable33 = this->getT(0).getT(0).getT(3).getT(0).getT(14).getT(0); // modtest2_impl::global_cable33_t<NV>
		auto& add35 = this->getT(0).getT(0).getT(3).getT(0).getT(14).getT(1);          // math::add<NV>
		auto& chain55 = this->getT(0).getT(0).getT(3).getT(0).getT(15);                // modtest2_impl::chain55_t<NV>
		auto& global_cable34 = this->getT(0).getT(0).getT(3).getT(0).getT(15).getT(0); // modtest2_impl::global_cable34_t<NV>
		auto& add36 = this->getT(0).getT(0).getT(3).getT(0).getT(15).getT(1);          // math::add<NV>
		auto& peak4 = this->getT(0).getT(0).getT(3).getT(1);                           // modtest2_impl::peak4_t<NV>
		auto& clear6 = this->getT(0).getT(1);                                          // math::clear<NV>
		auto& chain46 = this->getT(0).getT(2);                                         // modtest2_impl::chain46_t<NV>
		auto& clear2 = this->getT(0).getT(2).getT(0);                                  // math::clear<NV>
		auto& branch6 = this->getT(0).getT(2).getT(1);                                 // modtest2_impl::branch6_t<NV>
		auto& chain13 = this->getT(0).getT(2).getT(1).getT(0);                         // modtest2_impl::chain13_t
		auto& chain47 = this->getT(0).getT(2).getT(1).getT(1);                         // modtest2_impl::chain47_t<NV>
		auto& global_cable48 = this->getT(0).getT(2).getT(1).getT(1).getT(0);          // modtest2_impl::global_cable48_t<NV>
		auto& add37 = this->getT(0).getT(2).getT(1).getT(1).getT(1);                   // math::add<NV>
		auto& chain48 = this->getT(0).getT(2).getT(1).getT(2);                         // modtest2_impl::chain48_t<NV>
		auto& global_cable49 = this->getT(0).getT(2).getT(1).getT(2).getT(0);          // modtest2_impl::global_cable49_t<NV>
		auto& add38 = this->getT(0).getT(2).getT(1).getT(2).getT(1);                   // math::add<NV>
		auto& chain49 = this->getT(0).getT(2).getT(1).getT(3);                         // modtest2_impl::chain49_t<NV>
		auto& global_cable50 = this->getT(0).getT(2).getT(1).getT(3).getT(0);          // modtest2_impl::global_cable50_t<NV>
		auto& add39 = this->getT(0).getT(2).getT(1).getT(3).getT(1);                   // math::add<NV>
		auto& chain56 = this->getT(0).getT(2).getT(1).getT(4);                         // modtest2_impl::chain56_t<NV>
		auto& global_cable51 = this->getT(0).getT(2).getT(1).getT(4).getT(0);          // modtest2_impl::global_cable51_t<NV>
		auto& add40 = this->getT(0).getT(2).getT(1).getT(4).getT(1);                   // math::add<NV>
		auto& chain57 = this->getT(0).getT(2).getT(1).getT(5);                         // modtest2_impl::chain57_t<NV>
		auto& global_cable52 = this->getT(0).getT(2).getT(1).getT(5).getT(0);          // modtest2_impl::global_cable52_t<NV>
		auto& add41 = this->getT(0).getT(2).getT(1).getT(5).getT(1);                   // math::add<NV>
		auto& chain58 = this->getT(0).getT(2).getT(1).getT(6);                         // modtest2_impl::chain58_t<NV>
		auto& global_cable53 = this->getT(0).getT(2).getT(1).getT(6).getT(0);          // modtest2_impl::global_cable53_t<NV>
		auto& add42 = this->getT(0).getT(2).getT(1).getT(6).getT(1);                   // math::add<NV>
		auto& chain62 = this->getT(0).getT(2).getT(1).getT(7);                         // modtest2_impl::chain62_t<NV>
		auto& global_cable57 = this->getT(0).getT(2).getT(1).getT(7).getT(0);          // modtest2_impl::global_cable57_t<NV>
		auto& add46 = this->getT(0).getT(2).getT(1).getT(7).getT(1);                   // math::add<NV>
		auto& chain63 = this->getT(0).getT(2).getT(1).getT(8);                         // modtest2_impl::chain63_t<NV>
		auto& global_cable58 = this->getT(0).getT(2).getT(1).getT(8).getT(0);          // modtest2_impl::global_cable58_t<NV>
		auto& add47 = this->getT(0).getT(2).getT(1).getT(8).getT(1);                   // math::add<NV>
		auto& chain64 = this->getT(0).getT(2).getT(1).getT(9);                         // modtest2_impl::chain64_t<NV>
		auto& global_cable59 = this->getT(0).getT(2).getT(1).getT(9).getT(0);          // modtest2_impl::global_cable59_t<NV>
		auto& add48 = this->getT(0).getT(2).getT(1).getT(9).getT(1);                   // math::add<NV>
		auto& chain65 = this->getT(0).getT(2).getT(1).getT(10);                        // modtest2_impl::chain65_t<NV>
		auto& global_cable60 = this->getT(0).getT(2).getT(1).getT(10).getT(0);         // modtest2_impl::global_cable60_t<NV>
		auto& add49 = this->getT(0).getT(2).getT(1).getT(10).getT(1);                  // math::add<NV>
		auto& chain66 = this->getT(0).getT(2).getT(1).getT(11);                        // modtest2_impl::chain66_t<NV>
		auto& global_cable61 = this->getT(0).getT(2).getT(1).getT(11).getT(0);         // modtest2_impl::global_cable61_t<NV>
		auto& add50 = this->getT(0).getT(2).getT(1).getT(11).getT(1);                  // math::add<NV>
		auto& chain67 = this->getT(0).getT(2).getT(1).getT(12);                        // modtest2_impl::chain67_t<NV>
		auto& global_cable62 = this->getT(0).getT(2).getT(1).getT(12).getT(0);         // modtest2_impl::global_cable62_t<NV>
		auto& add51 = this->getT(0).getT(2).getT(1).getT(12).getT(1);                  // math::add<NV>
		auto& chain68 = this->getT(0).getT(2).getT(1).getT(13);                        // modtest2_impl::chain68_t<NV>
		auto& global_cable63 = this->getT(0).getT(2).getT(1).getT(13).getT(0);         // modtest2_impl::global_cable63_t<NV>
		auto& add52 = this->getT(0).getT(2).getT(1).getT(13).getT(1);                  // math::add<NV>
		auto& chain70 = this->getT(0).getT(2).getT(1).getT(14);                        // modtest2_impl::chain70_t<NV>
		auto& global_cable64 = this->getT(0).getT(2).getT(1).getT(14).getT(0);         // modtest2_impl::global_cable64_t<NV>
		auto& add53 = this->getT(0).getT(2).getT(1).getT(14).getT(1);                  // math::add<NV>
		auto& peak6 = this->getT(0).getT(2).getT(2);                                   // modtest2_impl::peak6_t<NV>
		auto& clear7 = this->getT(0).getT(2).getT(3);                                  // math::clear<NV>
		auto& pma1 = this->getT(0).getT(3);                                            // modtest2_impl::pma1_t<NV>
		auto& tempo_sync = this->getT(0).getT(4);                                      // modtest2_impl::tempo_sync_t<NV>
		auto& ramp = this->getT(0).getT(5);                                            // modtest2_impl::ramp_t<NV>
		auto& fmod1 = this->getT(0).getT(6);                                           // wrap::no_process<math::fmod<NV>>
		auto& branch = this->getT(0).getT(7);                                          // modtest2_impl::branch_t<NV>
		auto& chain23 = this->getT(0).getT(7).getT(0);                                 // modtest2_impl::chain23_t<NV>
		auto& pi5 = this->getT(0).getT(7).getT(0).getT(0);                             // math::pi<NV>
		auto& sin5 = this->getT(0).getT(7).getT(0).getT(1);                            // math::sin<NV>
		auto& chain8 = this->getT(0).getT(7).getT(1);                                  // modtest2_impl::chain8_t<NV>
		auto& rect1 = this->getT(0).getT(7).getT(1).getT(0);                           // math::rect<NV>
		auto& chain5 = this->getT(0).getT(7).getT(2);                                  // modtest2_impl::chain5_t
		auto& chain41 = this->getT(0).getT(7).getT(3);                                 // modtest2_impl::chain41_t<NV>
		auto& clear13 = this->getT(0).getT(7).getT(3).getT(0);                         // wrap::no_process<math::clear<NV>>
		auto& expr7 = this->getT(0).getT(7).getT(3).getT(1);                           // math::expr<NV, custom::expr7>
		auto& sig2mod9 = this->getT(0).getT(7).getT(3).getT(2);                        // math::sig2mod<NV>
		auto& peak5 = this->getT(0).getT(7).getT(3).getT(3);                           // modtest2_impl::peak5_t
		auto& chain32 = this->getT(0).getT(7).getT(4);                                 // modtest2_impl::chain32_t<NV>
		auto& oscillator = this->getT(0).getT(7).getT(4).getT(0);                      // modtest2_impl::oscillator_t<NV>
		auto& pi = this->getT(0).getT(7).getT(4).getT(1);                              // wrap::no_process<math::pi<NV>>
		auto& sampleandhold1 = this->getT(0).getT(7).getT(4).getT(2);                  // fx::sampleandhold<NV>
		auto& sig2mod7 = this->getT(0).getT(7).getT(4).getT(3);                        // math::sig2mod<NV>
		auto& chain20 = this->getT(0).getT(7).getT(5);                                 // modtest2_impl::chain20_t<NV>
		auto& clear15 = this->getT(0).getT(7).getT(5).getT(0);                         // math::clear<NV>
		auto& cable_table = this->getT(0).getT(7).getT(5).getT(1);                     // modtest2_impl::cable_table_t<NV>
		auto& add = this->getT(0).getT(7).getT(5).getT(2);                             // math::add<NV>
		auto& chain26 = this->getT(0).getT(7).getT(6);                                 // modtest2_impl::chain26_t<NV>
		auto& clear5 = this->getT(0).getT(7).getT(6).getT(0);                          // math::clear<NV>
		auto& cable_pack = this->getT(0).getT(7).getT(6).getT(1);                      // modtest2_impl::cable_pack_t<NV>
		auto& add1 = this->getT(0).getT(7).getT(6).getT(2);                            // math::add<NV>
		auto& peak = this->getT(0).getT(8);                                            // modtest2_impl::peak_t
		auto& pma = this->getT(0).getT(9);                                             // modtest2_impl::pma_t<NV>
		auto& branch1 = this->getT(0).getT(10);                                        // modtest2_impl::branch1_t<NV>
		auto& chain1 = this->getT(0).getT(10).getT(0);                                 // modtest2_impl::chain1_t
		auto& chain29 = this->getT(0).getT(10).getT(1);                                // modtest2_impl::chain29_t<NV>
		auto& expr3 = this->getT(0).getT(10).getT(1).getT(0);                          // math::expr<NV, custom::expr3>
		auto& chain35 = this->getT(0).getT(10).getT(2);                                // modtest2_impl::chain35_t<NV>
		auto& expr5 = this->getT(0).getT(10).getT(2).getT(0);                          // math::expr<NV, custom::expr5>
		auto& chain44 = this->getT(0).getT(10).getT(3);                                // modtest2_impl::chain44_t<NV>
		auto& expr8 = this->getT(0).getT(10).getT(3).getT(0);                          // math::expr<NV, custom::expr8>
		auto& chain45 = this->getT(0).getT(10).getT(4);                                // modtest2_impl::chain45_t<NV>
		auto& expr9 = this->getT(0).getT(10).getT(4).getT(0);                          // math::expr<NV, custom::expr9>
		auto& peak2 = this->getT(0).getT(11);                                          // modtest2_impl::peak2_t
		auto& add3 = this->getT(0).getT(12);                                           // wrap::no_process<math::add<NV>>
		auto& chain79 = this->getT(0).getT(13);                                        // modtest2_impl::chain79_t<NV>
		auto& branch4 = this->getT(0).getT(13).getT(0);                                // modtest2_impl::branch4_t<NV>
		auto& chain61 = this->getT(0).getT(13).getT(0).getT(0);                        // modtest2_impl::chain61_t<NV>
		auto& peak14 = this->getT(0).getT(13).getT(0).getT(0).getT(0);                 // modtest2_impl::peak14_t<NV>
		auto& chain71 = this->getT(0).getT(13).getT(0).getT(1);                        // modtest2_impl::chain71_t<NV>
		auto& peak15 = this->getT(0).getT(13).getT(0).getT(1).getT(0);                 // modtest2_impl::peak15_t<NV>
		auto& chain72 = this->getT(0).getT(13).getT(0).getT(2);                        // modtest2_impl::chain72_t<NV>
		auto& peak16 = this->getT(0).getT(13).getT(0).getT(2).getT(0);                 // modtest2_impl::peak16_t<NV>
		auto& chain73 = this->getT(0).getT(13).getT(0).getT(3);                        // modtest2_impl::chain73_t<NV>
		auto& peak17 = this->getT(0).getT(13).getT(0).getT(3).getT(0);                 // modtest2_impl::peak17_t<NV>
		auto& chain74 = this->getT(0).getT(13).getT(0).getT(4);                        // modtest2_impl::chain74_t<NV>
		auto& peak18 = this->getT(0).getT(13).getT(0).getT(4).getT(0);                 // modtest2_impl::peak18_t<NV>
		auto& chain75 = this->getT(0).getT(13).getT(0).getT(5);                        // modtest2_impl::chain75_t<NV>
		auto& peak19 = this->getT(0).getT(13).getT(0).getT(5).getT(0);                 // modtest2_impl::peak19_t<NV>
		auto& chain76 = this->getT(0).getT(13).getT(0).getT(6);                        // modtest2_impl::chain76_t<NV>
		auto& peak20 = this->getT(0).getT(13).getT(0).getT(6).getT(0);                 // modtest2_impl::peak20_t<NV>
		auto& chain77 = this->getT(0).getT(13).getT(0).getT(7);                        // modtest2_impl::chain77_t<NV>
		auto& add43 = this->getT(0).getT(13).getT(0).getT(7).getT(0);                  // math::add<NV>
		auto& peak21 = this->getT(0).getT(13).getT(0).getT(7).getT(1);                 // modtest2_impl::peak21_t<NV>
		auto& split1 = this->getT(0).getT(13).getT(1);                                 // modtest2_impl::split1_t<NV>
		auto& event_data_writer = this->getT(0).getT(13).getT(1).getT(0);              // routing::event_data_writer<NV>
		auto& event_data_writer5 = this->getT(0).getT(13).getT(1).getT(1);             // routing::event_data_writer<NV>
		auto& event_data_writer4 = this->getT(0).getT(13).getT(1).getT(2);             // routing::event_data_writer<NV>
		auto& event_data_writer3 = this->getT(0).getT(13).getT(1).getT(3);             // routing::event_data_writer<NV>
		auto& event_data_writer2 = this->getT(0).getT(13).getT(1).getT(4);             // routing::event_data_writer<NV>
		auto& event_data_writer1 = this->getT(0).getT(13).getT(1).getT(5);             // routing::event_data_writer<NV>
		auto& event_data_writer7 = this->getT(0).getT(13).getT(1).getT(6);             // routing::event_data_writer<NV>
		auto& event_data_writer6 = this->getT(0).getT(13).getT(1).getT(7);             // routing::event_data_writer<NV>
		auto& chain78 = this->getT(0).getT(13).getT(2);                                // modtest2_impl::chain78_t<NV>
		auto& ahdsr1 = this->getT(0).getT(13).getT(2).getT(0);                         // modtest2_impl::ahdsr1_t<NV>
		auto& voice_manager2 = this->getT(0).getT(13).getT(2).getT(1);                 // envelope::voice_manager
		...
		peak14.getParameter().connectT(0, event_data_writer);                // peak14 -> event_data_writer::Value
		peak15.getParameter().connectT(0, event_data_writer5);               // peak15 -> event_data_writer5::Value
		peak16.getParameter().connectT(0, event_data_writer4);               // peak16 -> event_data_writer4::Value
		peak17.getParameter().connectT(0, event_data_writer3);               // peak17 -> event_data_writer3::Value
		peak18.getParameter().connectT(0, event_data_writer2);               // peak18 -> event_data_writer2::Value
		peak19.getParameter().connectT(0, event_data_writer1);               // peak19 -> event_data_writer1::Value
		peak20.getParameter().connectT(0, event_data_writer7);               // peak20 -> event_data_writer7::Value
		peak21.getParameter().connectT(0, event_data_writer6);               // peak21 -> event_data_writer6::Value
		...
		branch4.setParameterT(0, 0.); // container::branch::Index
		...
		; // voice_manager2::KillVoice is automated
	...
	void connectToRuntimeTarget(bool addConnection, const runtime_target::connection& c)
	{
		...
		this->getT(0).getT(0).getT(0).getT(0).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable1_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable2_t<NV>
		this->getT(0).getT(0).getT(0).getT(2).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable3_t<NV>
		this->getT(0).getT(0).getT(0).getT(3).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable4_t<NV>
		this->getT(0).getT(0).getT(0).getT(4).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable5_t<NV>
		this->getT(0).getT(0).getT(0).getT(5).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable6_t<NV>
		this->getT(0).getT(0).getT(0).getT(6).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable7_t<NV>
		this->getT(0).getT(0).getT(0).getT(7).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable8_t<NV>
		this->getT(0).getT(0).getT(0).getT(8).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable10_t<NV>
		this->getT(0).getT(0).getT(0).getT(9).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable11_t<NV>
		this->getT(0).getT(0).getT(0).getT(10).getT(0).connectToRuntimeTarget(addConnection, c);         // modtest2_impl::global_cable12_t<NV>
		this->getT(0).getT(0).getT(0).getT(11).getT(0).connectToRuntimeTarget(addConnection, c);         // modtest2_impl::global_cable13_t<NV>
		this->getT(0).getT(0).getT(0).getT(12).getT(0).connectToRuntimeTarget(addConnection, c);         // modtest2_impl::global_cable14_t<NV>
		this->getT(0).getT(0).getT(0).getT(13).getT(0).connectToRuntimeTarget(addConnection, c);         // modtest2_impl::global_cable15_t<NV>
		this->getT(0).getT(0).getT(0).getT(14).getT(0).connectToRuntimeTarget(addConnection, c);         // modtest2_impl::global_cable16_t<NV>
		this->getT(0).getT(0).getT(0).getT(15).getT(0).connectToRuntimeTarget(addConnection, c);         // modtest2_impl::global_cable17_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(0).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest2_impl::global_cable19_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest2_impl::global_cable20_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(2).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest2_impl::global_cable21_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(3).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest2_impl::global_cable22_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(4).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest2_impl::global_cable23_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(5).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest2_impl::global_cable24_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(6).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest2_impl::global_cable25_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(7).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest2_impl::global_cable26_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(8).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest2_impl::global_cable27_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(9).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest2_impl::global_cable28_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(10).getT(0).connectToRuntimeTarget(addConnection, c); // modtest2_impl::global_cable29_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(11).getT(0).connectToRuntimeTarget(addConnection, c); // modtest2_impl::global_cable30_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(12).getT(0).connectToRuntimeTarget(addConnection, c); // modtest2_impl::global_cable31_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(13).getT(0).connectToRuntimeTarget(addConnection, c); // modtest2_impl::global_cable32_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(14).getT(0).connectToRuntimeTarget(addConnection, c); // modtest2_impl::global_cable33_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).getT(15).getT(0).connectToRuntimeTarget(addConnection, c); // modtest2_impl::global_cable34_t<NV>
		this->getT(0).getT(2).getT(1).getT(1).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable48_t<NV>
		this->getT(0).getT(2).getT(1).getT(2).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable49_t<NV>
		this->getT(0).getT(2).getT(1).getT(3).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable50_t<NV>
		this->getT(0).getT(2).getT(1).getT(4).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable51_t<NV>
		this->getT(0).getT(2).getT(1).getT(5).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable52_t<NV>
		this->getT(0).getT(2).getT(1).getT(6).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable53_t<NV>
		this->getT(0).getT(2).getT(1).getT(7).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable57_t<NV>
		this->getT(0).getT(2).getT(1).getT(8).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable58_t<NV>
		this->getT(0).getT(2).getT(1).getT(9).getT(0).connectToRuntimeTarget(addConnection, c);          // modtest2_impl::global_cable59_t<NV>
		this->getT(0).getT(2).getT(1).getT(10).getT(0).connectToRuntimeTarget(addConnection, c);         // modtest2_impl::global_cable60_t<NV>
		this->getT(0).getT(2).getT(1).getT(11).getT(0).connectToRuntimeTarget(addConnection, c);         // modtest2_impl::global_cable61_t<NV>
		this->getT(0).getT(2).getT(1).getT(12).getT(0).connectToRuntimeTarget(addConnection, c);         // modtest2_impl::global_cable62_t<NV>
		this->getT(0).getT(2).getT(1).getT(13).getT(0).connectToRuntimeTarget(addConnection, c);         // modtest2_impl::global_cable63_t<NV>
		this->getT(0).getT(2).getT(1).getT(14).getT(0).connectToRuntimeTarget(addConnection, c);         // modtest2_impl::global_cable64_t<NV>
	}
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(0).getT(0).getT(1).setExternalData(b, index);                  // modtest2_impl::peak1_t<NV>
		this->getT(0).getT(0).getT(3).getT(1).setExternalData(b, index);          // modtest2_impl::peak4_t<NV>
		this->getT(0).getT(2).getT(2).setExternalData(b, index);                  // modtest2_impl::peak6_t<NV>
		this->getT(0).getT(5).setExternalData(b, index);                          // modtest2_impl::ramp_t<NV>
		this->getT(0).getT(7).getT(3).getT(3).setExternalData(b, index);          // modtest2_impl::peak5_t
		this->getT(0).getT(7).getT(4).getT(0).setExternalData(b, index);          // modtest2_impl::oscillator_t<NV>
		this->getT(0).getT(7).getT(5).getT(1).setExternalData(b, index);          // modtest2_impl::cable_table_t<NV>
		this->getT(0).getT(7).getT(6).getT(1).setExternalData(b, index);          // modtest2_impl::cable_pack_t<NV>
		this->getT(0).getT(8).setExternalData(b, index);                          // modtest2_impl::peak_t
		this->getT(0).getT(11).setExternalData(b, index);                         // modtest2_impl::peak2_t
		this->getT(0).getT(13).getT(0).getT(0).getT(0).setExternalData(b, index); // modtest2_impl::peak14_t<NV>
		this->getT(0).getT(13).getT(0).getT(1).getT(0).setExternalData(b, index); // modtest2_impl::peak15_t<NV>
		this->getT(0).getT(13).getT(0).getT(2).getT(0).setExternalData(b, index); // modtest2_impl::peak16_t<NV>
		this->getT(0).getT(13).getT(0).getT(3).getT(0).setExternalData(b, index); // modtest2_impl::peak17_t<NV>
		this->getT(0).getT(13).getT(0).getT(4).getT(0).setExternalData(b, index); // modtest2_impl::peak18_t<NV>
		this->getT(0).getT(13).getT(0).getT(5).getT(0).setExternalData(b, index); // modtest2_impl::peak19_t<NV>
		this->getT(0).getT(13).getT(0).getT(6).getT(0).setExternalData(b, index); // modtest2_impl::peak20_t<NV>
		this->getT(0).getT(13).getT(0).getT(7).getT(1).setExternalData(b, index); // modtest2_impl::peak21_t<NV>
		this->getT(0).getT(13).getT(2).getT(0).setExternalData(b, index);         // modtest2_impl::ahdsr1_t<NV>
	}
};
}
