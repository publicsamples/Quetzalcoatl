...
template <int NV>
using input_toggle108_t = control::input_toggle<parameter::plain<pma_t<NV>, 2>>;
template <int NV>
...
template <int NV>
using sw1_t = container::chain<parameter::empty, 
                               wrap::fix<2, cable_table105_t<NV>>, 
                               cable_table107_t<NV>, 
                               cable_table106_t<NV>, 
                               split72_t<NV>>;

namespace Switcher8_t_parameters
{
// Parameter list for HarmFade_impl::Switcher8_t ---------------------------------------------------

template <int NV>
using Value1 = parameter::plain<HarmFade_impl::input_toggle106_t<NV>, 
                                1>;
template <int NV>
using Value2 = parameter::plain<HarmFade_impl::input_toggle106_t<NV>, 
                                2>;
template <int NV>
using Value3 = parameter::plain<HarmFade_impl::input_toggle107_t<NV>, 
                                1>;
template <int NV>
using Value4 = parameter::plain<HarmFade_impl::input_toggle107_t<NV>, 
                                2>;
template <int NV>
using Switcher8_t_plist = parameter::list<Value1<NV>, 
                                          Value2<NV>, 
                                          Value3<NV>, 
                                          Value4<NV>>;
}
...
template <int NV>
using Switcher8_t = container::chain<Switcher8_t_parameters::Switcher8_t_plist<NV>, 
                                     wrap::fix<2, sw1_t<NV>>>;
...
template <int NV>
using input_toggle128_t = control::input_toggle<parameter::plain<pma2_t<NV>, 2>>;
template <int NV>
using input_toggle127_t = control::input_toggle<parameter::plain<input_toggle128_t<NV>, 1>>;

struct cable_table126_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table126_t = wrap::data<control::cable_table<parameter::plain<input_toggle127_t<NV>, 0>>, 
                                    data::embedded::table<cable_table126_t_data>>;

struct cable_table127_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table127_t = wrap::data<control::cable_table<parameter::plain<input_toggle128_t<NV>, 0>>, 
                                    data::embedded::table<cable_table127_t_data>>;

template <int NV>
using input_toggle129_t = control::input_toggle<parameter::plain<input_toggle128_t<NV>, 2>>;

struct cable_table128_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table128_t = wrap::data<control::cable_table<parameter::plain<input_toggle129_t<NV>, 0>>, 
                                    data::embedded::table<cable_table128_t_data>>;

template <int NV>
using split79_t = container::split<parameter::empty, 
                                   wrap::fix<2, input_toggle127_t<NV>>, 
                                   input_toggle128_t<NV>, 
                                   input_toggle129_t<NV>>;

template <int NV>
using sw2_t = container::chain<parameter::empty, 
                               wrap::fix<2, cable_table126_t<NV>>, 
                               cable_table127_t<NV>, 
                               cable_table128_t<NV>, 
                               split79_t<NV>>;

namespace Switcher15_t_parameters
{
// Parameter list for HarmFade_impl::Switcher15_t --------------------------------------------------

template <int NV>
using Value1 = parameter::plain<HarmFade_impl::input_toggle127_t<NV>, 
                                1>;
template <int NV>
using Value2 = parameter::plain<HarmFade_impl::input_toggle127_t<NV>, 
                                2>;
template <int NV>
using Value3 = parameter::plain<HarmFade_impl::input_toggle129_t<NV>, 
                                1>;
template <int NV>
using Value4 = parameter::plain<HarmFade_impl::input_toggle129_t<NV>, 
                                2>;
template <int NV>
using Switcher15_t_plist = parameter::list<Value1<NV>, 
                                           Value2<NV>, 
                                           Value3<NV>, 
                                           Value4<NV>>;
}
...
template <int NV>
using Switcher15_t = container::chain<Switcher15_t_parameters::Switcher15_t_plist<NV>, 
                                      wrap::fix<2, sw2_t<NV>>>;
...
template <int NV>
using input_toggle125_t = control::input_toggle<parameter::plain<pma3_t<NV>, 2>>;
template <int NV>
using input_toggle124_t = control::input_toggle<parameter::plain<input_toggle125_t<NV>, 1>>;

struct cable_table123_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table123_t = wrap::data<control::cable_table<parameter::plain<input_toggle124_t<NV>, 0>>, 
                                    data::embedded::table<cable_table123_t_data>>;

struct cable_table124_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table124_t = wrap::data<control::cable_table<parameter::plain<input_toggle125_t<NV>, 0>>, 
                                    data::embedded::table<cable_table124_t_data>>;

template <int NV>
using input_toggle126_t = control::input_toggle<parameter::plain<input_toggle125_t<NV>, 2>>;

struct cable_table125_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table125_t = wrap::data<control::cable_table<parameter::plain<input_toggle126_t<NV>, 0>>, 
                                    data::embedded::table<cable_table125_t_data>>;

template <int NV>
using split78_t = container::split<parameter::empty, 
                                   wrap::fix<2, input_toggle124_t<NV>>, 
                                   input_toggle125_t<NV>, 
                                   input_toggle126_t<NV>>;

template <int NV>
using sw3_t = container::chain<parameter::empty, 
                               wrap::fix<2, cable_table123_t<NV>>, 
                               cable_table124_t<NV>, 
                               cable_table125_t<NV>, 
                               split78_t<NV>>;

namespace Switcher14_t_parameters
{
// Parameter list for HarmFade_impl::Switcher14_t --------------------------------------------------

template <int NV>
using Value1 = parameter::plain<HarmFade_impl::input_toggle124_t<NV>, 
                                1>;
template <int NV>
using Value2 = parameter::plain<HarmFade_impl::input_toggle124_t<NV>, 
                                2>;
template <int NV>
using Value3 = parameter::plain<HarmFade_impl::input_toggle126_t<NV>, 
                                1>;
template <int NV>
using Value4 = parameter::plain<HarmFade_impl::input_toggle126_t<NV>, 
                                2>;
template <int NV>
using Switcher14_t_plist = parameter::list<Value1<NV>, 
                                           Value2<NV>, 
                                           Value3<NV>, 
                                           Value4<NV>>;
}
...
template <int NV>
using Switcher14_t = container::chain<Switcher14_t_parameters::Switcher14_t_plist<NV>, 
                                      wrap::fix<2, sw3_t<NV>>>;
...
template <int NV>
using input_toggle122_t = control::input_toggle<parameter::plain<pma4_t<NV>, 2>>;
template <int NV>
using input_toggle121_t = control::input_toggle<parameter::plain<input_toggle122_t<NV>, 1>>;

struct cable_table120_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table120_t = wrap::data<control::cable_table<parameter::plain<input_toggle121_t<NV>, 0>>, 
                                    data::embedded::table<cable_table120_t_data>>;

struct cable_table121_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table121_t = wrap::data<control::cable_table<parameter::plain<input_toggle122_t<NV>, 0>>, 
                                    data::embedded::table<cable_table121_t_data>>;

template <int NV>
using input_toggle123_t = control::input_toggle<parameter::plain<input_toggle122_t<NV>, 2>>;

struct cable_table122_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table122_t = wrap::data<control::cable_table<parameter::plain<input_toggle123_t<NV>, 0>>, 
                                    data::embedded::table<cable_table122_t_data>>;

template <int NV>
using split77_t = container::split<parameter::empty, 
                                   wrap::fix<2, input_toggle121_t<NV>>, 
                                   input_toggle122_t<NV>, 
                                   input_toggle123_t<NV>>;

template <int NV>
using sw4_t = container::chain<parameter::empty, 
                               wrap::fix<2, cable_table120_t<NV>>, 
                               cable_table121_t<NV>, 
                               cable_table122_t<NV>, 
                               split77_t<NV>>;

namespace Switcher13_t_parameters
{
// Parameter list for HarmFade_impl::Switcher13_t --------------------------------------------------

template <int NV>
using Value1 = parameter::plain<HarmFade_impl::input_toggle121_t<NV>, 
                                1>;
template <int NV>
using Value2 = parameter::plain<HarmFade_impl::input_toggle121_t<NV>, 
                                2>;
template <int NV>
using Value3 = parameter::plain<HarmFade_impl::input_toggle123_t<NV>, 
                                1>;
template <int NV>
using Value4 = parameter::plain<HarmFade_impl::input_toggle123_t<NV>, 
                                2>;
template <int NV>
using Switcher13_t_plist = parameter::list<Value1<NV>, 
                                           Value2<NV>, 
                                           Value3<NV>, 
                                           Value4<NV>>;
}
...
template <int NV>
using Switcher13_t = container::chain<Switcher13_t_parameters::Switcher13_t_plist<NV>, 
                                      wrap::fix<2, sw4_t<NV>>>;
...
template <int NV>
using input_toggle119_t = control::input_toggle<parameter::plain<pma5_t<NV>, 2>>;
template <int NV>
using input_toggle118_t = control::input_toggle<parameter::plain<input_toggle119_t<NV>, 1>>;

struct cable_table117_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table117_t = wrap::data<control::cable_table<parameter::plain<input_toggle118_t<NV>, 0>>, 
                                    data::embedded::table<cable_table117_t_data>>;

struct cable_table118_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table118_t = wrap::data<control::cable_table<parameter::plain<input_toggle119_t<NV>, 0>>, 
                                    data::embedded::table<cable_table118_t_data>>;

template <int NV>
using input_toggle120_t = control::input_toggle<parameter::plain<input_toggle119_t<NV>, 2>>;

struct cable_table119_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table119_t = wrap::data<control::cable_table<parameter::plain<input_toggle120_t<NV>, 0>>, 
                                    data::embedded::table<cable_table119_t_data>>;

template <int NV>
using split76_t = container::split<parameter::empty, 
                                   wrap::fix<2, input_toggle118_t<NV>>, 
                                   input_toggle119_t<NV>, 
                                   input_toggle120_t<NV>>;

template <int NV>
using sw5_t = container::chain<parameter::empty, 
                               wrap::fix<2, cable_table117_t<NV>>, 
                               cable_table118_t<NV>, 
                               cable_table119_t<NV>, 
                               split76_t<NV>>;

namespace Switcher12_t_parameters
{
// Parameter list for HarmFade_impl::Switcher12_t --------------------------------------------------

template <int NV>
using Value1 = parameter::plain<HarmFade_impl::input_toggle118_t<NV>, 
                                1>;
template <int NV>
using Value2 = parameter::plain<HarmFade_impl::input_toggle118_t<NV>, 
                                2>;
template <int NV>
using Value3 = parameter::plain<HarmFade_impl::input_toggle120_t<NV>, 
                                1>;
template <int NV>
using Value4 = parameter::plain<HarmFade_impl::input_toggle120_t<NV>, 
                                2>;
template <int NV>
using Switcher12_t_plist = parameter::list<Value1<NV>, 
                                           Value2<NV>, 
                                           Value3<NV>, 
                                           Value4<NV>>;
}
...
template <int NV>
using Switcher12_t = container::chain<Switcher12_t_parameters::Switcher12_t_plist<NV>, 
                                      wrap::fix<2, sw5_t<NV>>>;
...
template <int NV>
using input_toggle116_t = control::input_toggle<parameter::plain<pma6_t<NV>, 2>>;
template <int NV>
using input_toggle115_t = control::input_toggle<parameter::plain<input_toggle116_t<NV>, 1>>;

struct cable_table114_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table114_t = wrap::data<control::cable_table<parameter::plain<input_toggle115_t<NV>, 0>>, 
                                    data::embedded::table<cable_table114_t_data>>;

struct cable_table115_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table115_t = wrap::data<control::cable_table<parameter::plain<input_toggle116_t<NV>, 0>>, 
                                    data::embedded::table<cable_table115_t_data>>;

template <int NV>
using input_toggle117_t = control::input_toggle<parameter::plain<input_toggle116_t<NV>, 2>>;

struct cable_table116_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table116_t = wrap::data<control::cable_table<parameter::plain<input_toggle117_t<NV>, 0>>, 
                                    data::embedded::table<cable_table116_t_data>>;

template <int NV>
using split75_t = container::split<parameter::empty, 
                                   wrap::fix<2, input_toggle115_t<NV>>, 
                                   input_toggle116_t<NV>, 
                                   input_toggle117_t<NV>>;

template <int NV>
using sw6_t = container::chain<parameter::empty, 
                               wrap::fix<2, cable_table114_t<NV>>, 
                               cable_table115_t<NV>, 
                               cable_table116_t<NV>, 
                               split75_t<NV>>;

namespace Switcher11_t_parameters
{
// Parameter list for HarmFade_impl::Switcher11_t --------------------------------------------------

template <int NV>
using Value1 = parameter::plain<HarmFade_impl::input_toggle115_t<NV>, 
                                1>;
template <int NV>
using Value2 = parameter::plain<HarmFade_impl::input_toggle115_t<NV>, 
                                2>;
template <int NV>
using Value3 = parameter::plain<HarmFade_impl::input_toggle117_t<NV>, 
                                1>;
template <int NV>
using Value4 = parameter::plain<HarmFade_impl::input_toggle117_t<NV>, 
                                2>;
template <int NV>
using Switcher11_t_plist = parameter::list<Value1<NV>, 
                                           Value2<NV>, 
                                           Value3<NV>, 
                                           Value4<NV>>;
}
...
template <int NV>
using Switcher11_t = container::chain<Switcher11_t_parameters::Switcher11_t_plist<NV>, 
                                      wrap::fix<2, sw6_t<NV>>>;
...
template <int NV>
using input_toggle113_t = control::input_toggle<parameter::plain<pma7_t<NV>, 2>>;
template <int NV>
using input_toggle112_t = control::input_toggle<parameter::plain<input_toggle113_t<NV>, 1>>;

struct cable_table111_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table111_t = wrap::data<control::cable_table<parameter::plain<input_toggle112_t<NV>, 0>>, 
                                    data::embedded::table<cable_table111_t_data>>;

struct cable_table112_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table112_t = wrap::data<control::cable_table<parameter::plain<input_toggle113_t<NV>, 0>>, 
                                    data::embedded::table<cable_table112_t_data>>;

template <int NV>
using input_toggle114_t = control::input_toggle<parameter::plain<input_toggle113_t<NV>, 2>>;

struct cable_table113_t_data
{
	span<float, 512> data =
	{
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
...
template <int NV>
using cable_table113_t = wrap::data<control::cable_table<parameter::plain<input_toggle114_t<NV>, 0>>, 
                                    data::embedded::table<cable_table113_t_data>>;

template <int NV>
using split74_t = container::split<parameter::empty, 
                                   wrap::fix<2, input_toggle112_t<NV>>, 
                                   input_toggle113_t<NV>, 
                                   input_toggle114_t<NV>>;

template <int NV>
using sw7_t = container::chain<parameter::empty, 
                               wrap::fix<2, cable_table111_t<NV>>, 
                               cable_table112_t<NV>, 
                               cable_table113_t<NV>, 
                               split74_t<NV>>;

namespace Switcher10_t_parameters
{
// Parameter list for HarmFade_impl::Switcher10_t --------------------------------------------------

template <int NV>
using Value1 = parameter::plain<HarmFade_impl::input_toggle112_t<NV>, 
                                1>;
template <int NV>
using Value2 = parameter::plain<HarmFade_impl::input_toggle112_t<NV>, 
                                2>;
template <int NV>
using Value3 = parameter::plain<HarmFade_impl::input_toggle114_t<NV>, 
                                1>;
template <int NV>
using Value4 = parameter::plain<HarmFade_impl::input_toggle114_t<NV>, 
                                2>;
template <int NV>
using Switcher10_t_plist = parameter::list<Value1<NV>, 
                                           Value2<NV>, 
                                           Value3<NV>, 
                                           Value4<NV>>;
}
...
template <int NV>
using Switcher10_t = container::chain<Switcher10_t_parameters::Switcher10_t_plist<NV>, 
                                      wrap::fix<2, sw7_t<NV>>>;
...
template <int NV>
using input_toggle110_t = control::input_toggle<parameter::plain<pma1_t<NV>, 2>>;
template <int NV>
...
template <int NV>
using sw8_t = container::chain<parameter::empty, 
                               wrap::fix<2, cable_table108_t<NV>>, 
                               cable_table109_t<NV>, 
                               cable_table110_t<NV>, 
                               split73_t<NV>>;

namespace Switcher9_t_parameters
{
// Parameter list for HarmFade_impl::Switcher9_t ---------------------------------------------------

template <int NV>
using Value1 = parameter::plain<HarmFade_impl::input_toggle109_t<NV>, 
                                1>;
template <int NV>
using Value2 = parameter::plain<HarmFade_impl::input_toggle109_t<NV>, 
                                2>;
template <int NV>
using Value3 = parameter::plain<HarmFade_impl::input_toggle111_t<NV>, 
                                1>;
template <int NV>
using Value4 = parameter::plain<HarmFade_impl::input_toggle111_t<NV>, 
                                2>;
template <int NV>
using Switcher9_t_plist = parameter::list<Value1<NV>, 
                                          Value2<NV>, 
                                          Value3<NV>, 
                                          Value4<NV>>;
}
...
template <int NV>
using Switcher9_t = container::chain<Switcher9_t_parameters::Switcher9_t_plist<NV>, 
                                     wrap::fix<2, sw8_t<NV>>>;
template <int NV>
using xfader3_multimod = parameter::list<parameter::plain<Switcher8_t<NV>, 0>, 
                                         ...
                                         parameter::plain<Switcher9_t<NV>, 0>>;

template <int NV>
using xfader3_t = control::xfader<xfader3_multimod<NV>, faders::switcher>;

template <int NV>
using xfader5_multimod = parameter::list<parameter::plain<Switcher8_t<NV>, 1>, 
                                         parameter::plain<Switcher15_t<NV>, 1>, 
                                         parameter::plain<Switcher14_t<NV>, 1>, 
                                         parameter::plain<Switcher13_t<NV>, 1>, 
                                         parameter::plain<Switcher12_t<NV>, 1>, 
                                         parameter::plain<Switcher11_t<NV>, 1>, 
                                         parameter::plain<Switcher10_t<NV>, 1>, 
                                         parameter::plain<Switcher9_t<NV>, 1>>;

template <int NV>
using xfader5_t = control::xfader<xfader5_multimod<NV>, faders::rms>;

template <int NV>
using xfader4_multimod = parameter::list<parameter::plain<Switcher8_t<NV>, 2>, 
                                         parameter::plain<Switcher15_t<NV>, 2>, 
                                         parameter::plain<Switcher14_t<NV>, 2>, 
                                         parameter::plain<Switcher13_t<NV>, 2>, 
                                         parameter::plain<Switcher12_t<NV>, 2>, 
                                         parameter::plain<Switcher11_t<NV>, 2>, 
                                         parameter::plain<Switcher10_t<NV>, 2>, 
                                         parameter::plain<Switcher9_t<NV>, 2>>;

template <int NV>
using xfader4_t = control::xfader<xfader4_multimod<NV>, faders::cosine_half>;

template <int NV>
using xfader_multimod = parameter::list<parameter::plain<Switcher8_t<NV>, 3>, 
                                        parameter::plain<Switcher15_t<NV>, 3>, 
                                        parameter::plain<Switcher14_t<NV>, 3>, 
                                        parameter::plain<Switcher13_t<NV>, 3>, 
                                        parameter::plain<Switcher12_t<NV>, 3>, 
                                        parameter::plain<Switcher11_t<NV>, 3>, 
                                        parameter::plain<Switcher10_t<NV>, 3>, 
                                        parameter::plain<Switcher9_t<NV>, 3>>;
...
DECLARE_PARAMETER_RANGE(xfinput_InputRange, 
                        0., 
                        5.);

template <int NV>
using xfinput = parameter::chain<xfinput_InputRange, 
                                 parameter::plain<HarmFade_impl::cable_table105_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table107_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table106_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table126_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table127_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table128_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table123_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table124_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table125_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table120_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table121_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table122_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table117_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table118_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table119_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table114_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table115_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table116_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table111_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table112_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table113_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table108_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table109_t<NV>, 0>, 
                                 parameter::plain<HarmFade_impl::cable_table110_t<NV>, 0>>;
...
using xfade = parameter::chain<ranges::Identity, 
                               ...
                               parameter::plain<HarmFade_impl::xfader5_t<NV>, 0>, 
                               parameter::plain<HarmFade_impl::xfader4_t<NV>, 0>>;
...
template <int NV> struct instance: public HarmFade_impl::HarmFade_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ENCODED_PARAMETERS(210)
		{
            ...
            0x0000, 0xA000, 0x0040, 0x0000, 0x0000, 0x8000, 0x003F, 0x0000, 
	...
	instance()
	{
		...
		auto& xfader3 = this->getT(0).getT(0).getT(0).getT(0).getT(0).getT(0);                // HarmFade_impl::xfader3_t<NV>
		auto& xfader5 = this->getT(0).getT(0).getT(0).getT(0).getT(0).getT(1);                // HarmFade_impl::xfader5_t<NV>
		auto& xfader4 = this->getT(0).getT(0).getT(0).getT(0).getT(0).getT(2);                // HarmFade_impl::xfader4_t<NV>
		auto& xfader = this->getT(0).getT(0).getT(0).getT(0).getT(0).getT(3);                 // HarmFade_impl::xfader_t<NV>
		auto& split4 = this->getT(0).getT(0).getT(0).getT(1);                                 // HarmFade_impl::split4_t<NV>
		auto& Switcher8 = this->getT(0).getT(0).getT(0).getT(1).getT(0);                      // HarmFade_impl::Switcher8_t<NV>
		auto& sw1 = this->getT(0).getT(0).getT(0).getT(1).getT(0).getT(0);                    // HarmFade_impl::sw1_t<NV>
		auto& cable_table105 = this->getT(0).getT(0).getT(0).getT(1).getT(0).getT(0).getT(0); // HarmFade_impl::cable_table105_t<NV>
		auto& cable_table107 = this->getT(0).getT(0).getT(0).getT(1).getT(0).getT(0).getT(1); // HarmFade_impl::cable_table107_t<NV>
		auto& cable_table106 = this->getT(0).getT(0).getT(0).getT(1).getT(0).getT(0).getT(2); // HarmFade_impl::cable_table106_t<NV>
		auto& split72 = this->getT(0).getT(0).getT(0).getT(1).getT(0).getT(0).getT(3);        // HarmFade_impl::split72_t<NV>
		auto& input_toggle106 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle106_t<NV>
                                getT(0).getT(0).getT(3).getT(0);
		auto& input_toggle108 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle108_t<NV>
                                getT(0).getT(0).getT(3).getT(1);
		auto& input_toggle107 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle107_t<NV>
                                getT(0).getT(0).getT(3).getT(2);
		auto& Switcher15 = this->getT(0).getT(0).getT(0).getT(1).getT(1);                     // HarmFade_impl::Switcher15_t<NV>
		auto& sw2 = this->getT(0).getT(0).getT(0).getT(1).getT(1).getT(0);                    // HarmFade_impl::sw2_t<NV>
		auto& cable_table126 = this->getT(0).getT(0).getT(0).getT(1).getT(1).getT(0).getT(0); // HarmFade_impl::cable_table126_t<NV>
		auto& cable_table127 = this->getT(0).getT(0).getT(0).getT(1).getT(1).getT(0).getT(1); // HarmFade_impl::cable_table127_t<NV>
		auto& cable_table128 = this->getT(0).getT(0).getT(0).getT(1).getT(1).getT(0).getT(2); // HarmFade_impl::cable_table128_t<NV>
		auto& split79 = this->getT(0).getT(0).getT(0).getT(1).getT(1).getT(0).getT(3);        // HarmFade_impl::split79_t<NV>
		auto& input_toggle127 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle127_t<NV>
                                getT(1).getT(0).getT(3).getT(0);
		auto& input_toggle128 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle128_t<NV>
                                getT(1).getT(0).getT(3).getT(1);
		auto& input_toggle129 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle129_t<NV>
                                getT(1).getT(0).getT(3).getT(2);
		auto& Switcher14 = this->getT(0).getT(0).getT(0).getT(1).getT(2);                     // HarmFade_impl::Switcher14_t<NV>
		auto& sw3 = this->getT(0).getT(0).getT(0).getT(1).getT(2).getT(0);                    // HarmFade_impl::sw3_t<NV>
		auto& cable_table123 = this->getT(0).getT(0).getT(0).getT(1).getT(2).getT(0).getT(0); // HarmFade_impl::cable_table123_t<NV>
		auto& cable_table124 = this->getT(0).getT(0).getT(0).getT(1).getT(2).getT(0).getT(1); // HarmFade_impl::cable_table124_t<NV>
		auto& cable_table125 = this->getT(0).getT(0).getT(0).getT(1).getT(2).getT(0).getT(2); // HarmFade_impl::cable_table125_t<NV>
		auto& split78 = this->getT(0).getT(0).getT(0).getT(1).getT(2).getT(0).getT(3);        // HarmFade_impl::split78_t<NV>
		auto& input_toggle124 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle124_t<NV>
                                getT(2).getT(0).getT(3).getT(0);
		auto& input_toggle125 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle125_t<NV>
                                getT(2).getT(0).getT(3).getT(1);
		auto& input_toggle126 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle126_t<NV>
                                getT(2).getT(0).getT(3).getT(2);
		auto& Switcher13 = this->getT(0).getT(0).getT(0).getT(1).getT(3);                     // HarmFade_impl::Switcher13_t<NV>
		auto& sw4 = this->getT(0).getT(0).getT(0).getT(1).getT(3).getT(0);                    // HarmFade_impl::sw4_t<NV>
		auto& cable_table120 = this->getT(0).getT(0).getT(0).getT(1).getT(3).getT(0).getT(0); // HarmFade_impl::cable_table120_t<NV>
		auto& cable_table121 = this->getT(0).getT(0).getT(0).getT(1).getT(3).getT(0).getT(1); // HarmFade_impl::cable_table121_t<NV>
		auto& cable_table122 = this->getT(0).getT(0).getT(0).getT(1).getT(3).getT(0).getT(2); // HarmFade_impl::cable_table122_t<NV>
		auto& split77 = this->getT(0).getT(0).getT(0).getT(1).getT(3).getT(0).getT(3);        // HarmFade_impl::split77_t<NV>
		auto& input_toggle121 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle121_t<NV>
                                getT(3).getT(0).getT(3).getT(0);
		auto& input_toggle122 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle122_t<NV>
                                getT(3).getT(0).getT(3).getT(1);
		auto& input_toggle123 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle123_t<NV>
                                getT(3).getT(0).getT(3).getT(2);
		auto& Switcher12 = this->getT(0).getT(0).getT(0).getT(1).getT(4);                     // HarmFade_impl::Switcher12_t<NV>
		auto& sw5 = this->getT(0).getT(0).getT(0).getT(1).getT(4).getT(0);                    // HarmFade_impl::sw5_t<NV>
		auto& cable_table117 = this->getT(0).getT(0).getT(0).getT(1).getT(4).getT(0).getT(0); // HarmFade_impl::cable_table117_t<NV>
		auto& cable_table118 = this->getT(0).getT(0).getT(0).getT(1).getT(4).getT(0).getT(1); // HarmFade_impl::cable_table118_t<NV>
		auto& cable_table119 = this->getT(0).getT(0).getT(0).getT(1).getT(4).getT(0).getT(2); // HarmFade_impl::cable_table119_t<NV>
		auto& split76 = this->getT(0).getT(0).getT(0).getT(1).getT(4).getT(0).getT(3);        // HarmFade_impl::split76_t<NV>
		auto& input_toggle118 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle118_t<NV>
                                getT(4).getT(0).getT(3).getT(0);
		auto& input_toggle119 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle119_t<NV>
                                getT(4).getT(0).getT(3).getT(1);
		auto& input_toggle120 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle120_t<NV>
                                getT(4).getT(0).getT(3).getT(2);
		auto& Switcher11 = this->getT(0).getT(0).getT(0).getT(1).getT(5);                     // HarmFade_impl::Switcher11_t<NV>
		auto& sw6 = this->getT(0).getT(0).getT(0).getT(1).getT(5).getT(0);                    // HarmFade_impl::sw6_t<NV>
		auto& cable_table114 = this->getT(0).getT(0).getT(0).getT(1).getT(5).getT(0).getT(0); // HarmFade_impl::cable_table114_t<NV>
		auto& cable_table115 = this->getT(0).getT(0).getT(0).getT(1).getT(5).getT(0).getT(1); // HarmFade_impl::cable_table115_t<NV>
		auto& cable_table116 = this->getT(0).getT(0).getT(0).getT(1).getT(5).getT(0).getT(2); // HarmFade_impl::cable_table116_t<NV>
		auto& split75 = this->getT(0).getT(0).getT(0).getT(1).getT(5).getT(0).getT(3);        // HarmFade_impl::split75_t<NV>
		auto& input_toggle115 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle115_t<NV>
                                getT(5).getT(0).getT(3).getT(0);
		auto& input_toggle116 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle116_t<NV>
                                getT(5).getT(0).getT(3).getT(1);
		auto& input_toggle117 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle117_t<NV>
                                getT(5).getT(0).getT(3).getT(2);
		auto& Switcher10 = this->getT(0).getT(0).getT(0).getT(1).getT(6);                     // HarmFade_impl::Switcher10_t<NV>
		auto& sw7 = this->getT(0).getT(0).getT(0).getT(1).getT(6).getT(0);                    // HarmFade_impl::sw7_t<NV>
		auto& cable_table111 = this->getT(0).getT(0).getT(0).getT(1).getT(6).getT(0).getT(0); // HarmFade_impl::cable_table111_t<NV>
		auto& cable_table112 = this->getT(0).getT(0).getT(0).getT(1).getT(6).getT(0).getT(1); // HarmFade_impl::cable_table112_t<NV>
		auto& cable_table113 = this->getT(0).getT(0).getT(0).getT(1).getT(6).getT(0).getT(2); // HarmFade_impl::cable_table113_t<NV>
		auto& split74 = this->getT(0).getT(0).getT(0).getT(1).getT(6).getT(0).getT(3);        // HarmFade_impl::split74_t<NV>
		auto& input_toggle112 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle112_t<NV>
                                getT(6).getT(0).getT(3).getT(0);
		auto& input_toggle113 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle113_t<NV>
                                getT(6).getT(0).getT(3).getT(1);
		auto& input_toggle114 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle114_t<NV>
                                getT(6).getT(0).getT(3).getT(2);
		auto& Switcher9 = this->getT(0).getT(0).getT(0).getT(1).getT(7);                      // HarmFade_impl::Switcher9_t<NV>
		auto& sw8 = this->getT(0).getT(0).getT(0).getT(1).getT(7).getT(0);                    // HarmFade_impl::sw8_t<NV>
		auto& cable_table108 = this->getT(0).getT(0).getT(0).getT(1).getT(7).getT(0).getT(0); // HarmFade_impl::cable_table108_t<NV>
		auto& cable_table109 = this->getT(0).getT(0).getT(0).getT(1).getT(7).getT(0).getT(1); // HarmFade_impl::cable_table109_t<NV>
		auto& cable_table110 = this->getT(0).getT(0).getT(0).getT(1).getT(7).getT(0).getT(2); // HarmFade_impl::cable_table110_t<NV>
		auto& split73 = this->getT(0).getT(0).getT(0).getT(1).getT(7).getT(0).getT(3);        // HarmFade_impl::split73_t<NV>
		auto& input_toggle109 = this->getT(0).getT(0).getT(0).getT(1).                        // HarmFade_impl::input_toggle109_t<NV>
                                getT(7).getT(0).getT(3).getT(0);
		auto& input_toggle110 = this->getT(0).getT(0).getT(0).getT(1).                       // HarmFade_impl::input_toggle110_t<NV>
                                getT(7).getT(0).getT(3).getT(1);
		auto& input_toggle111 = this->getT(0).getT(0).getT(0).getT(1).                       // HarmFade_impl::input_toggle111_t<NV>
                                getT(7).getT(0).getT(3).getT(2);
		...
		Switcher8.getParameterT(0).connectT(0, input_toggle106); // Value1 -> input_toggle106::Value1
		
		Switcher8.getParameterT(1).connectT(0, input_toggle106); // Value2 -> input_toggle106::Value2
		
		Switcher8.getParameterT(2).connectT(0, input_toggle107); // Value3 -> input_toggle107::Value1
		
		Switcher8.getParameterT(3).connectT(0, input_toggle107);  // Value4 -> input_toggle107::Value2
		Switcher15.getParameterT(0).connectT(0, input_toggle127); // Value1 -> input_toggle127::Value1
		
		Switcher15.getParameterT(1).connectT(0, input_toggle127); // Value2 -> input_toggle127::Value2
		
		Switcher15.getParameterT(2).connectT(0, input_toggle129); // Value3 -> input_toggle129::Value1
		
		Switcher15.getParameterT(3).connectT(0, input_toggle129); // Value4 -> input_toggle129::Value2
		Switcher14.getParameterT(0).connectT(0, input_toggle124); // Value1 -> input_toggle124::Value1
		
		Switcher14.getParameterT(1).connectT(0, input_toggle124); // Value2 -> input_toggle124::Value2
		
		Switcher14.getParameterT(2).connectT(0, input_toggle126); // Value3 -> input_toggle126::Value1
		
		Switcher14.getParameterT(3).connectT(0, input_toggle126); // Value4 -> input_toggle126::Value2
		Switcher13.getParameterT(0).connectT(0, input_toggle121); // Value1 -> input_toggle121::Value1
		
		Switcher13.getParameterT(1).connectT(0, input_toggle121); // Value2 -> input_toggle121::Value2
		
		Switcher13.getParameterT(2).connectT(0, input_toggle123); // Value3 -> input_toggle123::Value1
		
		Switcher13.getParameterT(3).connectT(0, input_toggle123); // Value4 -> input_toggle123::Value2
		Switcher12.getParameterT(0).connectT(0, input_toggle118); // Value1 -> input_toggle118::Value1
		
		Switcher12.getParameterT(1).connectT(0, input_toggle118); // Value2 -> input_toggle118::Value2
		
		Switcher12.getParameterT(2).connectT(0, input_toggle120); // Value3 -> input_toggle120::Value1
		
		Switcher12.getParameterT(3).connectT(0, input_toggle120); // Value4 -> input_toggle120::Value2
		Switcher11.getParameterT(0).connectT(0, input_toggle115); // Value1 -> input_toggle115::Value1
		
		Switcher11.getParameterT(1).connectT(0, input_toggle115); // Value2 -> input_toggle115::Value2
		
		Switcher11.getParameterT(2).connectT(0, input_toggle117); // Value3 -> input_toggle117::Value1
		
		Switcher11.getParameterT(3).connectT(0, input_toggle117); // Value4 -> input_toggle117::Value2
		Switcher10.getParameterT(0).connectT(0, input_toggle112); // Value1 -> input_toggle112::Value1
		
		Switcher10.getParameterT(1).connectT(0, input_toggle112); // Value2 -> input_toggle112::Value2
		
		Switcher10.getParameterT(2).connectT(0, input_toggle114); // Value3 -> input_toggle114::Value1
		
		Switcher10.getParameterT(3).connectT(0, input_toggle114); // Value4 -> input_toggle114::Value2
		Switcher9.getParameterT(0).connectT(0, input_toggle109);  // Value1 -> input_toggle109::Value1
		
		Switcher9.getParameterT(1).connectT(0, input_toggle109); // Value2 -> input_toggle109::Value2
		
		Switcher9.getParameterT(2).connectT(0, input_toggle111); // Value3 -> input_toggle111::Value1
		
		Switcher9.getParameterT(3).connectT(0, input_toggle111); // Value4 -> input_toggle111::Value2
		Switcher8.getParameterT(0).connectT(0, input_toggle106); // Value1 -> input_toggle106::Value1
		...
		xfinput_p.connectT(0, cable_table105);  // xfinput -> cable_table105::Value
		xfinput_p.connectT(1, cable_table107);  // xfinput -> cable_table107::Value
		xfinput_p.connectT(2, cable_table106);  // xfinput -> cable_table106::Value
		xfinput_p.connectT(3, cable_table126);  // xfinput -> cable_table126::Value
		xfinput_p.connectT(4, cable_table127);  // xfinput -> cable_table127::Value
		xfinput_p.connectT(5, cable_table128);  // xfinput -> cable_table128::Value
		xfinput_p.connectT(6, cable_table123);  // xfinput -> cable_table123::Value
		xfinput_p.connectT(7, cable_table124);  // xfinput -> cable_table124::Value
		xfinput_p.connectT(8, cable_table125);  // xfinput -> cable_table125::Value
		xfinput_p.connectT(9, cable_table120);  // xfinput -> cable_table120::Value
		xfinput_p.connectT(10, cable_table121); // xfinput -> cable_table121::Value
		xfinput_p.connectT(11, cable_table122); // xfinput -> cable_table122::Value
		xfinput_p.connectT(12, cable_table117); // xfinput -> cable_table117::Value
		xfinput_p.connectT(13, cable_table118); // xfinput -> cable_table118::Value
		xfinput_p.connectT(14, cable_table119); // xfinput -> cable_table119::Value
		xfinput_p.connectT(15, cable_table114); // xfinput -> cable_table114::Value
		xfinput_p.connectT(16, cable_table115); // xfinput -> cable_table115::Value
		xfinput_p.connectT(17, cable_table116); // xfinput -> cable_table116::Value
		xfinput_p.connectT(18, cable_table111); // xfinput -> cable_table111::Value
		xfinput_p.connectT(19, cable_table112); // xfinput -> cable_table112::Value
		xfinput_p.connectT(20, cable_table113); // xfinput -> cable_table113::Value
		xfinput_p.connectT(21, cable_table108); // xfinput -> cable_table108::Value
		xfinput_p.connectT(22, cable_table109); // xfinput -> cable_table109::Value
		xfinput_p.connectT(23, cable_table110); // xfinput -> cable_table110::Value
		...
		xfade_p.connectT(2, xfader5); // xfade -> xfader5::Value
		xfade_p.connectT(3, xfader4); // xfade -> xfader4::Value
		...
		input_toggle108.getWrappedObject().getParameter().connectT(0, pma);             // input_toggle108 -> pma::Add
		...
		input_toggle128.getWrappedObject().getParameter().connectT(0, pma2);            // input_toggle128 -> pma2::Add
		input_toggle127.getWrappedObject().getParameter().connectT(0, input_toggle128); // input_toggle127 -> input_toggle128::Value1
		cable_table126.getWrappedObject().getParameter().connectT(0, input_toggle127);  // cable_table126 -> input_toggle127::Input
		cable_table127.getWrappedObject().getParameter().connectT(0, input_toggle128);  // cable_table127 -> input_toggle128::Input
		input_toggle129.getWrappedObject().getParameter().connectT(0, input_toggle128); // input_toggle129 -> input_toggle128::Value2
		cable_table128.getWrappedObject().getParameter().connectT(0, input_toggle129);  // cable_table128 -> input_toggle129::Input
		...
		input_toggle125.getWrappedObject().getParameter().connectT(0, pma3);            // input_toggle125 -> pma3::Add
		input_toggle124.getWrappedObject().getParameter().connectT(0, input_toggle125); // input_toggle124 -> input_toggle125::Value1
		cable_table123.getWrappedObject().getParameter().connectT(0, input_toggle124);  // cable_table123 -> input_toggle124::Input
		cable_table124.getWrappedObject().getParameter().connectT(0, input_toggle125);  // cable_table124 -> input_toggle125::Input
		input_toggle126.getWrappedObject().getParameter().connectT(0, input_toggle125); // input_toggle126 -> input_toggle125::Value2
		cable_table125.getWrappedObject().getParameter().connectT(0, input_toggle126);  // cable_table125 -> input_toggle126::Input
		...
		input_toggle122.getWrappedObject().getParameter().connectT(0, pma4);            // input_toggle122 -> pma4::Add
		input_toggle121.getWrappedObject().getParameter().connectT(0, input_toggle122); // input_toggle121 -> input_toggle122::Value1
		cable_table120.getWrappedObject().getParameter().connectT(0, input_toggle121);  // cable_table120 -> input_toggle121::Input
		cable_table121.getWrappedObject().getParameter().connectT(0, input_toggle122);  // cable_table121 -> input_toggle122::Input
		input_toggle123.getWrappedObject().getParameter().connectT(0, input_toggle122); // input_toggle123 -> input_toggle122::Value2
		cable_table122.getWrappedObject().getParameter().connectT(0, input_toggle123);  // cable_table122 -> input_toggle123::Input
		...
		input_toggle119.getWrappedObject().getParameter().connectT(0, pma5);            // input_toggle119 -> pma5::Add
		input_toggle118.getWrappedObject().getParameter().connectT(0, input_toggle119); // input_toggle118 -> input_toggle119::Value1
		cable_table117.getWrappedObject().getParameter().connectT(0, input_toggle118);  // cable_table117 -> input_toggle118::Input
		cable_table118.getWrappedObject().getParameter().connectT(0, input_toggle119);  // cable_table118 -> input_toggle119::Input
		input_toggle120.getWrappedObject().getParameter().connectT(0, input_toggle119); // input_toggle120 -> input_toggle119::Value2
		cable_table119.getWrappedObject().getParameter().connectT(0, input_toggle120);  // cable_table119 -> input_toggle120::Input
		...
		input_toggle116.getWrappedObject().getParameter().connectT(0, pma6);            // input_toggle116 -> pma6::Add
		input_toggle115.getWrappedObject().getParameter().connectT(0, input_toggle116); // input_toggle115 -> input_toggle116::Value1
		cable_table114.getWrappedObject().getParameter().connectT(0, input_toggle115);  // cable_table114 -> input_toggle115::Input
		cable_table115.getWrappedObject().getParameter().connectT(0, input_toggle116);  // cable_table115 -> input_toggle116::Input
		input_toggle117.getWrappedObject().getParameter().connectT(0, input_toggle116); // input_toggle117 -> input_toggle116::Value2
		cable_table116.getWrappedObject().getParameter().connectT(0, input_toggle117);  // cable_table116 -> input_toggle117::Input
		...
		input_toggle113.getWrappedObject().getParameter().connectT(0, pma7);            // input_toggle113 -> pma7::Add
		input_toggle112.getWrappedObject().getParameter().connectT(0, input_toggle113); // input_toggle112 -> input_toggle113::Value1
		cable_table111.getWrappedObject().getParameter().connectT(0, input_toggle112);  // cable_table111 -> input_toggle112::Input
		cable_table112.getWrappedObject().getParameter().connectT(0, input_toggle113);  // cable_table112 -> input_toggle113::Input
		input_toggle114.getWrappedObject().getParameter().connectT(0, input_toggle113); // input_toggle114 -> input_toggle113::Value2
		cable_table113.getWrappedObject().getParameter().connectT(0, input_toggle114);  // cable_table113 -> input_toggle114::Input
		...
		input_toggle110.getWrappedObject().getParameter().connectT(0, pma1);            // input_toggle110 -> pma1::Add
		...
		xfader3_p.getParameterT(0).connectT(0, Switcher8);  // xfader3 -> Switcher8::Value1
		xfader3_p.getParameterT(1).connectT(0, Switcher15); // xfader3 -> Switcher15::Value1
		xfader3_p.getParameterT(2).connectT(0, Switcher14); // xfader3 -> Switcher14::Value1
		xfader3_p.getParameterT(3).connectT(0, Switcher13); // xfader3 -> Switcher13::Value1
		xfader3_p.getParameterT(4).connectT(0, Switcher12); // xfader3 -> Switcher12::Value1
		xfader3_p.getParameterT(5).connectT(0, Switcher11); // xfader3 -> Switcher11::Value1
		xfader3_p.getParameterT(6).connectT(0, Switcher10); // xfader3 -> Switcher10::Value1
		xfader3_p.getParameterT(7).connectT(0, Switcher9);  // xfader3 -> Switcher9::Value1
		auto& xfader5_p = xfader5.getWrappedObject().getParameter();
		xfader5_p.getParameterT(0).connectT(0, Switcher8);  // xfader5 -> Switcher8::Value2
		xfader5_p.getParameterT(1).connectT(0, Switcher15); // xfader5 -> Switcher15::Value2
		xfader5_p.getParameterT(2).connectT(0, Switcher14); // xfader5 -> Switcher14::Value2
		xfader5_p.getParameterT(3).connectT(0, Switcher13); // xfader5 -> Switcher13::Value2
		xfader5_p.getParameterT(4).connectT(0, Switcher12); // xfader5 -> Switcher12::Value2
		xfader5_p.getParameterT(5).connectT(0, Switcher11); // xfader5 -> Switcher11::Value2
		xfader5_p.getParameterT(6).connectT(0, Switcher10); // xfader5 -> Switcher10::Value2
		xfader5_p.getParameterT(7).connectT(0, Switcher9);  // xfader5 -> Switcher9::Value2
		auto& xfader4_p = xfader4.getWrappedObject().getParameter();
		xfader4_p.getParameterT(0).connectT(0, Switcher8);  // xfader4 -> Switcher8::Value3
		xfader4_p.getParameterT(1).connectT(0, Switcher15); // xfader4 -> Switcher15::Value3
		xfader4_p.getParameterT(2).connectT(0, Switcher14); // xfader4 -> Switcher14::Value3
		xfader4_p.getParameterT(3).connectT(0, Switcher13); // xfader4 -> Switcher13::Value3
		xfader4_p.getParameterT(4).connectT(0, Switcher12); // xfader4 -> Switcher12::Value3
		xfader4_p.getParameterT(5).connectT(0, Switcher11); // xfader4 -> Switcher11::Value3
		xfader4_p.getParameterT(6).connectT(0, Switcher10); // xfader4 -> Switcher10::Value3
		xfader4_p.getParameterT(7).connectT(0, Switcher9);  // xfader4 -> Switcher9::Value3
		auto& xfader_p = xfader.getWrappedObject().getParameter();
		xfader_p.getParameterT(0).connectT(0, Switcher8);                           // xfader -> Switcher8::Value4
		xfader_p.getParameterT(1).connectT(0, Switcher15);                          // xfader -> Switcher15::Value4
		xfader_p.getParameterT(2).connectT(0, Switcher14);                          // xfader -> Switcher14::Value4
		xfader_p.getParameterT(3).connectT(0, Switcher13);                          // xfader -> Switcher13::Value4
		xfader_p.getParameterT(4).connectT(0, Switcher12);                          // xfader -> Switcher12::Value4
		xfader_p.getParameterT(5).connectT(0, Switcher11);                          // xfader -> Switcher11::Value4
		xfader_p.getParameterT(6).connectT(0, Switcher10);                          // xfader -> Switcher10::Value4
		xfader_p.getParameterT(7).connectT(0, Switcher9);                           // xfader -> Switcher9::Value4
		...
		; // Switcher8::Value1 is automated
		; // Switcher8::Value2 is automated
		; // Switcher8::Value3 is automated
		; // Switcher8::Value4 is automated
		...
		; // Switcher15::Value1 is automated
		; // Switcher15::Value2 is automated
		; // Switcher15::Value3 is automated
		; // Switcher15::Value4 is automated
		
		; // cable_table126::Value is automated
		
		; // cable_table127::Value is automated
		
		; // cable_table128::Value is automated
		
		; // input_toggle127::Input is automated
		; // input_toggle127::Value1 is automated
		; // input_toggle127::Value2 is automated
		
		; // input_toggle128::Input is automated
		; // input_toggle128::Value1 is automated
		; // input_toggle128::Value2 is automated
		
		; // input_toggle129::Input is automated
		; // input_toggle129::Value1 is automated
		; // input_toggle129::Value2 is automated
		
		; // Switcher14::Value1 is automated
		; // Switcher14::Value2 is automated
		; // Switcher14::Value3 is automated
		; // Switcher14::Value4 is automated
		
		; // cable_table123::Value is automated
		
		; // cable_table124::Value is automated
		
		; // cable_table125::Value is automated
		
		; // input_toggle124::Input is automated
		; // input_toggle124::Value1 is automated
		; // input_toggle124::Value2 is automated
		
		; // input_toggle125::Input is automated
		; // input_toggle125::Value1 is automated
		; // input_toggle125::Value2 is automated
		
		; // input_toggle126::Input is automated
		; // input_toggle126::Value1 is automated
		; // input_toggle126::Value2 is automated
		
		; // Switcher13::Value1 is automated
		; // Switcher13::Value2 is automated
		; // Switcher13::Value3 is automated
		; // Switcher13::Value4 is automated
		
		; // cable_table120::Value is automated
		
		; // cable_table121::Value is automated
		
		; // cable_table122::Value is automated
		
		; // input_toggle121::Input is automated
		; // input_toggle121::Value1 is automated
		; // input_toggle121::Value2 is automated
		
		; // input_toggle122::Input is automated
		; // input_toggle122::Value1 is automated
		; // input_toggle122::Value2 is automated
		
		; // input_toggle123::Input is automated
		; // input_toggle123::Value1 is automated
		; // input_toggle123::Value2 is automated
		
		; // Switcher12::Value1 is automated
		; // Switcher12::Value2 is automated
		; // Switcher12::Value3 is automated
		; // Switcher12::Value4 is automated
		
		; // cable_table117::Value is automated
		
		; // cable_table118::Value is automated
		
		; // cable_table119::Value is automated
		
		; // input_toggle118::Input is automated
		; // input_toggle118::Value1 is automated
		; // input_toggle118::Value2 is automated
		
		; // input_toggle119::Input is automated
		; // input_toggle119::Value1 is automated
		; // input_toggle119::Value2 is automated
		
		; // input_toggle120::Input is automated
		; // input_toggle120::Value1 is automated
		; // input_toggle120::Value2 is automated
		
		; // Switcher11::Value1 is automated
		; // Switcher11::Value2 is automated
		; // Switcher11::Value3 is automated
		; // Switcher11::Value4 is automated
		
		; // cable_table114::Value is automated
		
		; // cable_table115::Value is automated
		
		; // cable_table116::Value is automated
		
		; // input_toggle115::Input is automated
		; // input_toggle115::Value1 is automated
		; // input_toggle115::Value2 is automated
		
		; // input_toggle116::Input is automated
		; // input_toggle116::Value1 is automated
		; // input_toggle116::Value2 is automated
		
		; // input_toggle117::Input is automated
		; // input_toggle117::Value1 is automated
		; // input_toggle117::Value2 is automated
		
		; // Switcher10::Value1 is automated
		; // Switcher10::Value2 is automated
		; // Switcher10::Value3 is automated
		; // Switcher10::Value4 is automated
		
		; // cable_table111::Value is automated
		
		; // cable_table112::Value is automated
		
		; // cable_table113::Value is automated
		
		; // input_toggle112::Input is automated
		; // input_toggle112::Value1 is automated
		; // input_toggle112::Value2 is automated
		
		; // input_toggle113::Input is automated
		; // input_toggle113::Value1 is automated
		; // input_toggle113::Value2 is automated
		
		; // input_toggle114::Input is automated
		; // input_toggle114::Value1 is automated
		; // input_toggle114::Value2 is automated
		
		; // Switcher9::Value1 is automated
		; // Switcher9::Value2 is automated
		; // Switcher9::Value3 is automated
		; // Switcher9::Value4 is automated
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(0).getT(0).getT(0).getT(1).getT(0).getT(0).getT(0).setExternalData(b, index); // HarmFade_impl::cable_table105_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(0).getT(0).getT(1).setExternalData(b, index); // HarmFade_impl::cable_table107_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(0).getT(0).getT(2).setExternalData(b, index); // HarmFade_impl::cable_table106_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(1).getT(0).getT(0).setExternalData(b, index); // HarmFade_impl::cable_table126_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(1).getT(0).getT(1).setExternalData(b, index); // HarmFade_impl::cable_table127_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(1).getT(0).getT(2).setExternalData(b, index); // HarmFade_impl::cable_table128_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(2).getT(0).getT(0).setExternalData(b, index); // HarmFade_impl::cable_table123_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(2).getT(0).getT(1).setExternalData(b, index); // HarmFade_impl::cable_table124_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(2).getT(0).getT(2).setExternalData(b, index); // HarmFade_impl::cable_table125_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(3).getT(0).getT(0).setExternalData(b, index); // HarmFade_impl::cable_table120_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(3).getT(0).getT(1).setExternalData(b, index); // HarmFade_impl::cable_table121_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(3).getT(0).getT(2).setExternalData(b, index); // HarmFade_impl::cable_table122_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(4).getT(0).getT(0).setExternalData(b, index); // HarmFade_impl::cable_table117_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(4).getT(0).getT(1).setExternalData(b, index); // HarmFade_impl::cable_table118_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(4).getT(0).getT(2).setExternalData(b, index); // HarmFade_impl::cable_table119_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(5).getT(0).getT(0).setExternalData(b, index); // HarmFade_impl::cable_table114_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(5).getT(0).getT(1).setExternalData(b, index); // HarmFade_impl::cable_table115_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(5).getT(0).getT(2).setExternalData(b, index); // HarmFade_impl::cable_table116_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(6).getT(0).getT(0).setExternalData(b, index); // HarmFade_impl::cable_table111_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(6).getT(0).getT(1).setExternalData(b, index); // HarmFade_impl::cable_table112_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(6).getT(0).getT(2).setExternalData(b, index); // HarmFade_impl::cable_table113_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(7).getT(0).getT(0).setExternalData(b, index); // HarmFade_impl::cable_table108_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(7).getT(0).getT(1).setExternalData(b, index); // HarmFade_impl::cable_table109_t<NV>
		this->getT(0).getT(0).getT(0).getT(1).getT(7).getT(0).getT(2).setExternalData(b, index); // HarmFade_impl::cable_table110_t<NV>
