...
using branch4_t = container::branch<parameter::empty, 
                                    ...
                                    chain45_t<NV>, 
                                    chain46_t<NV>>;
DECLARE_PARAMETER_RANGE_STEP(cable_table13_modRange, 
                             0., 
                             7., 
                             1.);

template <int NV>
using cable_table13_mod = parameter::from0To1<branch4_t<NV>, 
                                              0, 
                                              cable_table13_modRange>;
...
struct cable_table13_t_data
{
	span<float, 512> data =
	{
		...
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
		0.f, 0.f, 0.f, 0.f, 0.f, 0.0020929f,
		0.00626254f, 0.0104321f, 0.0146018f, 0.0187714f, 0.022941f, 0.0271106f,
		0.0312802f, 0.0354498f, 0.0396194f, 0.043789f, 0.0479587f, 0.0521283f,
		0.0562979f, 0.0604675f, 0.0646371f, 0.0688066f, 0.0729762f, 0.0771458f,
		0.0813156f, 0.0854852f, 0.0896547f, 0.0938243f, 0.0979939f, 0.102164f,
		0.106333f, 0.110503f, 0.114672f, 0.118842f, 0.123012f, 0.127181f,
		0.131351f, 0.13552f, 0.13969f, 0.14386f, 0.148029f, 0.152199f,
		0.156368f, 0.160538f, 0.164708f, 0.168877f, 0.173047f, 0.177216f,
		0.181386f, 0.185556f, 0.189725f, 0.193895f, 0.198065f, 0.202234f,
		0.206404f, 0.210573f, 0.214743f, 0.218913f, 0.223082f, 0.227252f,
		0.231421f, 0.235591f, 0.239761f, 0.24393f, 0.2481f, 0.25227f,
		0.256439f, 0.260609f, 0.264778f, 0.268948f, 0.273117f, 0.277287f,
		0.281457f, 0.285626f, 0.289796f, 0.293966f, 0.298135f, 0.302305f,
		0.306474f, 0.310644f, 0.314814f, 0.318983f, 0.323153f, 0.327322f,
		0.331492f, 0.335662f, 0.339831f, 0.344001f, 0.348171f, 0.35234f,
		0.35651f, 0.360679f, 0.364849f, 0.369018f, 0.373188f, 0.377358f,
		0.381527f, 0.385697f, 0.389867f, 0.394036f, 0.398206f, 0.402375f,
		0.406545f, 0.410715f, 0.414884f, 0.419054f, 0.423223f, 0.427393f,
		0.431563f, 0.435732f, 0.439902f, 0.444071f, 0.448241f, 0.452834f,
		0.457597f, 0.46236f, 0.467123f, 0.471886f, 0.476649f, 0.481411f,
		0.486175f, 0.490938f, 0.4957f, 0.500463f, 0.505226f, 0.509989f,
		0.514752f, 0.519515f, 0.524278f, 0.529041f, 0.533804f, 0.538567f,
		0.54333f, 0.548093f, 0.552856f, 0.557619f, 0.562382f, 0.567145f,
		0.571908f, 0.577332f, 0.582961f, 0.58859f, 0.594219f, 0.599848f,
		0.605477f, 0.611106f, 0.616735f, 0.622364f, 0.627993f, 0.633622f,
		0.639251f, 0.64488f, 0.650509f, 0.656138f, 0.661767f, 0.667396f,
		0.673025f, 0.678654f, 0.684283f, 0.689912f, 0.695541f, 0.70117f,
		0.706799f, 0.712428f, 0.718057f, 0.723686f, 0.729315f, 0.734944f,
		0.740573f, 0.746202f, 0.751831f, 0.757273f, 0.762677f, 0.768081f,
		0.773485f, 0.778889f, 0.784293f, 0.789696f, 0.7951f, 0.800504f,
		0.805908f, 0.811312f, 0.816715f, 0.822119f, 0.827523f, 0.832927f,
		0.838331f, 0.843735f, 0.849138f, 0.854542f, 0.859946f, 0.86535f,
		0.870754f, 0.876157f, 0.881561f, 0.886965f, 0.890924f, 0.894677f,
		0.898429f, 0.902182f, 0.905935f, 0.909687f, 0.91344f, 0.917193f,
		0.920945f, 0.924698f, 0.92845f, 0.932203f, 0.935956f, 0.939708f,
		0.943461f, 0.947214f, 0.950966f, 0.954719f, 0.958472f, 0.962224f,
		0.965977f, 0.96973f, 0.973482f, 0.977235f, 0.980988f, 0.98474f,
		0.988493f, 0.992245f, 0.995998f, 0.999751f, 1.f, 1.f,
...
template <int NV>
using input_toggle1x1_t = control::input_toggle<parameter::plain<pma2_t<NV>, 0>>;
...
template <int NV>
using cable_table14_t = wrap::data<control::cable_table<parameter::plain<input_toggle1x1_t<NV>, 0>>, 
                                   data::embedded::table<cable_table14_t_data>>;

template <int NV>
using event_data_reader8_t = wrap::mod<parameter::plain<input_toggle1x1_t<NV>, 1>, 
                                       routing::event_data_reader<NV>>;

template <int NV>
using peak3_t = wrap::mod<parameter::plain<input_toggle1x1_t<NV>, 2>, 
...
using global_cable1_t_index = runtime_target::indexers::fix_hash<545021415>;

DECLARE_PARAMETER_RANGE(global_cable1_modRange, 
                        5.55112e-17, 
                        1.);

template <int NV>
using global_cable1_mod = parameter::from0To1<pma2_t<NV>, 
                                              2, 
                                              global_cable1_modRange>;
...
using h1_Semi_t = container::chain<parameter::empty, 
...
using chain1_t = container::chain<parameter::empty, 
                                  wrap::fix<1, h1_branch_t<NV>>, 
                                  h1_peak3_t<NV>, 
                                  math::clear<NV>, 
                                  math::add<NV>, 
                                  core::smoother<NV>>;

namespace PitchNu5_t_parameters
{
// Parameter list for PitchNu5_impl::PitchNu5_t ----------------------------------------------------

DECLARE_PARAMETER_RANGE(StageSrc_InputRange, 
                        0., 
                        17.);
DECLARE_PARAMETER_RANGE_STEP(StageSrc_2Range, 
                             0., 
                             16., 
                             1.);

template <int NV>
using StageSrc_2 = parameter::from0To1<PitchNu5_impl::event_data_reader8_t<NV>, 
                                       0, 
                                       StageSrc_2Range>;

template <int NV>
using StageSrc = parameter::chain<StageSrc_InputRange, 
                                  parameter::plain<PitchNu5_impl::cable_table13_t<NV>, 0>, 
                                  parameter::plain<PitchNu5_impl::cable_table14_t<NV>, 0>, 
                                  StageSrc_2<NV>>;

DECLARE_PARAMETER_RANGE_STEP(TuneMode_InputRange, 
                             0., 
                             7., 
                             0.1);
template <int NV>
using TuneMode_0 = parameter::from0To1<PitchNu5_impl::h1_branch_t<NV>, 
                                       0, 
                                       PitchNu5_impl::cable_table13_modRange>;

template <int NV>
using TuneMode = parameter::chain<TuneMode_InputRange, TuneMode_0<NV>>;

template <int NV>
using StageMod = parameter::plain<PitchNu5_impl::pma2_t<NV>, 
                                  1>;
template <int NV>
using Smooth = parameter::plain<core::smoother<NV>, 0>;
template <int NV>
using PitchNu5_t_plist = parameter::list<StageMod<NV>, 
                                         StageSrc<NV>, 
                                         TuneMode<NV>, 
                                         Smooth<NV>>;
}
...
template <int NV>
using PitchNu5_t_ = container::chain<PitchNu5_t_parameters::PitchNu5_t_plist<NV>, 
                                     wrap::fix<1, midichain_t<NV>>, 
                                     chain1_t<NV>>;

// =================================| Root node initialiser class |=================================

template <int NV> struct instance: public PitchNu5_impl::PitchNu5_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ID(PitchNu5);
		SNEX_METADATA_NUM_CHANNELS(1);
		SNEX_METADATA_ENCODED_PARAMETERS(68)
		{
			0x005B, 0x0000, 0x5300, 0x6174, 0x6567, 0x6F4D, 0x0064, 0x0000, 
            0xBF80, 0x0000, 0x3F80, 0x0000, 0x0000, 0x0000, 0x3F80, 0x0000, 
            0x0000, 0x015B, 0x0000, 0x5300, 0x6174, 0x6567, 0x7253, 0x0063, 
            0x0000, 0x0000, 0x0000, 0x4188, 0x0000, 0x3F80, 0x0000, 0x3F80, 
            0x0000, 0x0000, 0x025B, 0x0000, 0x5400, 0x6E75, 0x4D65, 0x646F, 
            0x0065, 0x0000, 0x0000, 0x0000, 0x40E0, 0xCCCD, 0x3DCC, 0x0000, 
            0x3F80, 0xCCCD, 0x3DCC, 0x035B, 0x0000, 0x5300, 0x6F6D, 0x746F, 
            0x0068, 0x0000, 0x0000, 0x0000, 0x44FA, 0x0000, 0x3F80, 0xEE69, 
            0x3E6C, 0xCCCD, 0x3DCC, 0x0000
		};
	};
	...
	instance()
	{
		...
		auto& midichain = this->getT(0);                                                              // PitchNu5_impl::midichain_t<NV>
		auto& modchain = this->getT(0).getT(0);                                                       // PitchNu5_impl::modchain_t<NV>
		auto& chain26 = this->getT(0).getT(0).getT(0);                                                // PitchNu5_impl::chain26_t<NV>
		auto& chain11 = this->getT(0).getT(0).getT(0).getT(0);                                        // PitchNu5_impl::chain11_t<NV>
		auto& cable_table13 = this->getT(0).getT(0).getT(0).getT(0).getT(0);                          // PitchNu5_impl::cable_table13_t<NV>
		auto& cable_table14 = this->getT(0).getT(0).getT(0).getT(0).getT(1);                          // PitchNu5_impl::cable_table14_t<NV>
		auto& split22 = this->getT(0).getT(0).getT(0).getT(0).getT(2);                                // PitchNu5_impl::split22_t<NV>
		auto& event_data_reader8 = this->getT(0).getT(0).getT(0).getT(0).getT(2).getT(0);             // PitchNu5_impl::event_data_reader8_t<NV>
		auto& chain38 = this->getT(0).getT(0).getT(0).getT(0).getT(2).getT(1);                        // PitchNu5_impl::chain38_t<NV>
		auto& branch4 = this->getT(0).getT(0).getT(0).getT(0).getT(2).getT(1).getT(0);                // PitchNu5_impl::branch4_t<NV>
		auto& chain39 = this->getT(0).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::chain39_t<NV>
                        getT(2).getT(1).getT(0).getT(0);
		auto& global_cable24 = this->getT(0).getT(0).getT(0).getT(0).                                 // PitchNu5_impl::global_cable24_t<NV>
                               getT(2).getT(1).getT(0).getT(0).
                               getT(0);
		auto& add24 = this->getT(0).getT(0).getT(0).getT(0).                                          // math::add<NV>
                      getT(2).getT(1).getT(0).getT(0).
                      getT(1);
		auto& chain40 = this->getT(0).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::chain40_t<NV>
                        getT(2).getT(1).getT(0).getT(1);
		auto& global_cable25 = this->getT(0).getT(0).getT(0).getT(0).                                 // PitchNu5_impl::global_cable25_t<NV>
                               getT(2).getT(1).getT(0).getT(1).
                               getT(0);
		auto& add25 = this->getT(0).getT(0).getT(0).getT(0).                                          // math::add<NV>
                      getT(2).getT(1).getT(0).getT(1).
                      getT(1);
		auto& chain41 = this->getT(0).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::chain41_t<NV>
                        getT(2).getT(1).getT(0).getT(2);
		auto& global_cable26 = this->getT(0).getT(0).getT(0).getT(0).                                 // PitchNu5_impl::global_cable26_t<NV>
                               getT(2).getT(1).getT(0).getT(2).
                               getT(0);
		auto& add26 = this->getT(0).getT(0).getT(0).getT(0).                                          // math::add<NV>
                      getT(2).getT(1).getT(0).getT(2).
                      getT(1);
		auto& chain42 = this->getT(0).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::chain42_t<NV>
                        getT(2).getT(1).getT(0).getT(3);
		auto& global_cable27 = this->getT(0).getT(0).getT(0).getT(0).                                 // PitchNu5_impl::global_cable27_t<NV>
                               getT(2).getT(1).getT(0).getT(3).
                               getT(0);
		auto& add27 = this->getT(0).getT(0).getT(0).getT(0).                                          // math::add<NV>
                      getT(2).getT(1).getT(0).getT(3).
                      getT(1);
		auto& chain43 = this->getT(0).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::chain43_t<NV>
                        getT(2).getT(1).getT(0).getT(4);
		auto& global_cable28 = this->getT(0).getT(0).getT(0).getT(0).                                 // PitchNu5_impl::global_cable28_t<NV>
                               getT(2).getT(1).getT(0).getT(4).
                               getT(0);
		auto& add28 = this->getT(0).getT(0).getT(0).getT(0).                                          // math::add<NV>
                      getT(2).getT(1).getT(0).getT(4).
                      getT(1);
		auto& chain44 = this->getT(0).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::chain44_t<NV>
                        getT(2).getT(1).getT(0).getT(5);
		auto& global_cable29 = this->getT(0).getT(0).getT(0).getT(0).                                 // PitchNu5_impl::global_cable29_t<NV>
                               getT(2).getT(1).getT(0).getT(5).
                               getT(0);
		auto& add29 = this->getT(0).getT(0).getT(0).getT(0).                                          // math::add<NV>
                      getT(2).getT(1).getT(0).getT(5).
                      getT(1);
		auto& chain45 = this->getT(0).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::chain45_t<NV>
                        getT(2).getT(1).getT(0).getT(6);
		auto& global_cable30 = this->getT(0).getT(0).getT(0).getT(0).                                 // PitchNu5_impl::global_cable30_t<NV>
                               getT(2).getT(1).getT(0).getT(6).
                               getT(0);
		auto& add30 = this->getT(0).getT(0).getT(0).getT(0).                                          // math::add<NV>
                      getT(2).getT(1).getT(0).getT(6).
                      getT(1);
		auto& chain46 = this->getT(0).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::chain46_t<NV>
                        getT(2).getT(1).getT(0).getT(7);
		auto& global_cable31 = this->getT(0).getT(0).getT(0).getT(0).                                 // PitchNu5_impl::global_cable31_t<NV>
                               getT(2).getT(1).getT(0).getT(7).
                               getT(0);
		auto& add31 = this->getT(0).getT(0).getT(0).getT(0).                                          // math::add<NV>
                      getT(2).getT(1).getT(0).getT(7).
                      getT(1);
		auto& peak3 = this->getT(0).getT(0).getT(0).getT(0).getT(2).getT(1).getT(1);                  // PitchNu5_impl::peak3_t<NV>
		auto& clear1 = this->getT(0).getT(0).getT(0).getT(0).getT(2).getT(1).getT(2);                 // math::clear<NV>
		auto& input_toggle1x1 = this->getT(0).getT(0).getT(1);                                        // PitchNu5_impl::input_toggle1x1_t<NV>
		auto& split = this->getT(0).getT(0).getT(2);                                                  // PitchNu5_impl::split_t<NV>
		auto& chain = this->getT(0).getT(0).getT(2).getT(0);                                          // PitchNu5_impl::chain_t<NV>
		auto& global_cable1 = this->getT(0).getT(0).getT(2).getT(0).getT(0);                          // PitchNu5_impl::global_cable1_t<NV>
		auto& pma2 = this->getT(0).getT(0).getT(2).getT(0).getT(1);                                   // PitchNu5_impl::pma2_t<NV>
		auto& chain1 = this->getT(1);                                                                 // PitchNu5_impl::chain1_t<NV>
		auto& h1_branch = this->getT(1).getT(0);                                                      // PitchNu5_impl::h1_branch_t<NV>
		auto& h1_harm = this->getT(1).getT(0).getT(0);                                                // PitchNu5_impl::h1_harm_t<NV>
		auto& h1_softbypass_switch3 = this->getT(1).getT(0).getT(0).getT(0);                          // PitchNu5_impl::h1_softbypass_switch3_t<NV>
		auto& h1_switcher2 = this->getT(1).getT(0).getT(0).getT(0).getT(0);                           // PitchNu5_impl::h1_switcher2_t<NV>
		auto& h1_sb_container2 = this->getT(1).getT(0).getT(0).getT(0).getT(1);                       // PitchNu5_impl::h1_sb_container2_t<NV>
		auto& h1_sb17 = this->getT(1).getT(0).getT(0).getT(0).getT(1).getT(0);                        // PitchNu5_impl::h1_sb17_t<NV>
		auto& h1_softbypass_switch9 = this->getT(1).getT(0).getT(0).getT(0).getT(1).getT(0).getT(0);  // PitchNu5_impl::h1_softbypass_switch9_t<NV>
		auto& h1_cable_table1 = this->getT(1).getT(0).getT(0).getT(0).                                // PitchNu5_impl::h1_cable_table1_t<NV>
                                getT(1).getT(0).getT(0).getT(0);
		auto& h1_switcher = this->getT(1).getT(0).getT(0).getT(0).                                    // PitchNu5_impl::h1_switcher_t<NV>
                            getT(1).getT(0).getT(0).getT(1);
		auto& h1_sb_container = this->getT(1).getT(0).getT(0).getT(0).                                // PitchNu5_impl::h1_sb_container_t<NV>
                                getT(1).getT(0).getT(0).getT(2);
		auto& h1_sb1 = this->getT(1).getT(0).getT(0).getT(0).                                         // PitchNu5_impl::h1_sb1_t<NV>
                       getT(1).getT(0).getT(0).getT(2).
                       getT(0);
		auto& h1_add2 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                                // math::add<NV>
                        getT(0).getT(0).getT(2).getT(0).getT(0);
		auto& h1_sb2 = this->getT(1).getT(0).getT(0).getT(0).                                         // PitchNu5_impl::h1_sb2_t<NV>
                       getT(1).getT(0).getT(0).getT(2).
                       getT(1);
		auto& h1_add4 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                                // math::add<NV>
                        getT(0).getT(0).getT(2).getT(1).getT(0);
		auto& h1_sb3 = this->getT(1).getT(0).getT(0).getT(0).                                         // PitchNu5_impl::h1_sb3_t<NV>
                       getT(1).getT(0).getT(0).getT(2).
                       getT(2);
		auto& h1_add3 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                                // math::add<NV>
                        getT(0).getT(0).getT(2).getT(2).getT(0);
		auto& h1_sb4 = this->getT(1).getT(0).getT(0).getT(0).                                         // PitchNu5_impl::h1_sb4_t<NV>
                       getT(1).getT(0).getT(0).getT(2).
                       getT(3);
		auto& h1_add6 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                                // math::add<NV>
                        getT(0).getT(0).getT(2).getT(3).getT(0);
		auto& h1_sb5 = this->getT(1).getT(0).getT(0).getT(0).                                         // PitchNu5_impl::h1_sb5_t<NV>
                       getT(1).getT(0).getT(0).getT(2).
                       getT(4);
		auto& h1_add5 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                                // math::add<NV>
                        getT(0).getT(0).getT(2).getT(4).getT(0);
		auto& h1_sb6 = this->getT(1).getT(0).getT(0).getT(0).                                         // PitchNu5_impl::h1_sb6_t<NV>
                       getT(1).getT(0).getT(0).getT(2).
                       getT(5);
		auto& h1_add8 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                                // math::add<NV>
                        getT(0).getT(0).getT(2).getT(5).getT(0);
		auto& h1_sb7 = this->getT(1).getT(0).getT(0).getT(0).                                         // PitchNu5_impl::h1_sb7_t<NV>
                       getT(1).getT(0).getT(0).getT(2).
                       getT(6);
		auto& h1_add7 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                                // math::add<NV>
                        getT(0).getT(0).getT(2).getT(6).getT(0);
		auto& h1_sb8 = this->getT(1).getT(0).getT(0).getT(0).                                         // PitchNu5_impl::h1_sb8_t<NV>
                       getT(1).getT(0).getT(0).getT(2).
                       getT(7);
		auto& h1_add9 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                                // math::add<NV>
                        getT(0).getT(0).getT(2).getT(7).getT(0);
		auto& h1_sb18 = this->getT(1).getT(0).getT(0).getT(0).getT(1).getT(1);                        // PitchNu5_impl::h1_sb18_t<NV>
		auto& h1_softbypass_switch10 = this->getT(1).getT(0).getT(0).getT(0).getT(1).getT(1).getT(0); // PitchNu5_impl::h1_softbypass_switch10_t<NV>
		auto& h1_cable_table2 = this->getT(1).getT(0).getT(0).getT(0).                                // PitchNu5_impl::h1_cable_table2_t<NV>
                                getT(1).getT(1).getT(0).getT(0);
		auto& h1_switcher1 = this->getT(1).getT(0).getT(0).getT(0).                                   // PitchNu5_impl::h1_switcher1_t<NV>
                             getT(1).getT(1).getT(0).getT(1);
		auto& h1_sb_container1 = this->getT(1).getT(0).getT(0).getT(0).                               // PitchNu5_impl::h1_sb_container1_t<NV>
                                 getT(1).getT(1).getT(0).getT(2);
		auto& h1_sb9 = this->getT(1).getT(0).getT(0).getT(0).                                         // PitchNu5_impl::h1_sb9_t<NV>
                       getT(1).getT(1).getT(0).getT(2).
                       getT(0);
		auto& h1_add10 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(0).getT(0);
		auto& h1_sb10 = this->getT(1).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::h1_sb10_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(1);
		auto& h1_add11 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(1).getT(0);
		auto& h1_sb11 = this->getT(1).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::h1_sb11_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(2);
		auto& h1_add12 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(2).getT(0);
		auto& h1_sb12 = this->getT(1).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::h1_sb12_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(3);
		auto& h1_add13 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(3).getT(0);
		auto& h1_sb13 = this->getT(1).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::h1_sb13_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(4);
		auto& h1_add14 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(4).getT(0);
		auto& h1_sb14 = this->getT(1).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::h1_sb14_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(5);
		auto& h1_add15 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(5).getT(0);
		auto& h1_sb15 = this->getT(1).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::h1_sb15_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(6);
		auto& h1_add16 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(6).getT(0);
		auto& h1_sb16 = this->getT(1).getT(0).getT(0).getT(0).                                        // PitchNu5_impl::h1_sb16_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(7);
		auto& h1_add17 = this->getT(1).getT(0).getT(0).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(7).getT(0);
		auto& h1_chromatic = this->getT(1).getT(0).getT(1);                                           // PitchNu5_impl::h1_chromatic_t<NV>
		auto& h1_softbypass_switch5 = this->getT(1).getT(0).getT(1).getT(0);                          // PitchNu5_impl::h1_softbypass_switch5_t<NV>
		auto& h1_switcher6 = this->getT(1).getT(0).getT(1).getT(0).getT(0);                           // PitchNu5_impl::h1_switcher6_t<NV>
		auto& h1_sb_container6 = this->getT(1).getT(0).getT(1).getT(0).getT(1);                       // PitchNu5_impl::h1_sb_container6_t<NV>
		auto& h1_sb37 = this->getT(1).getT(0).getT(1).getT(0).getT(1).getT(0);                        // PitchNu5_impl::h1_sb37_t<NV>
		auto& h1_softbypass_switch13 = this->getT(1).getT(0).getT(1).getT(0).getT(1).getT(0).getT(0); // PitchNu5_impl::h1_softbypass_switch13_t<NV>
		auto& h1_cable_table5 = this->getT(1).getT(0).getT(1).getT(0).                                // PitchNu5_impl::h1_cable_table5_t<NV>
                                getT(1).getT(0).getT(0).getT(0);
		auto& h1_switcher7 = this->getT(1).getT(0).getT(1).getT(0).                                   // PitchNu5_impl::h1_switcher7_t<NV>
                             getT(1).getT(0).getT(0).getT(1);
		auto& h1_sb_container7 = this->getT(1).getT(0).getT(1).getT(0).                               // PitchNu5_impl::h1_sb_container7_t<NV>
                                 getT(1).getT(0).getT(0).getT(2);
		auto& h1_sb38 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb38_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(0);
		auto& h1_add34 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(0).getT(0);
		auto& h1_sb39 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb39_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(1);
		auto& h1_add35 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(1).getT(0);
		auto& h1_sb40 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb40_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(2);
		auto& h1_add36 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(2).getT(0);
		auto& h1_sb41 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb41_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(3);
		auto& h1_add37 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(3).getT(0);
		auto& h1_sb42 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb42_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(4);
		auto& h1_add38 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(4).getT(0);
		auto& h1_sb43 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb43_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(5);
		auto& h1_add39 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(5).getT(0);
		auto& h1_sb44 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb44_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(6);
		auto& h1_add40 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(6).getT(0);
		auto& h1_sb45 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb45_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(7);
		auto& h1_add41 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(7).getT(0);
		auto& h1_sb46 = this->getT(1).getT(0).getT(1).getT(0).getT(1).getT(1);                        // PitchNu5_impl::h1_sb46_t<NV>
		auto& h1_softbypass_switch14 = this->getT(1).getT(0).getT(1).getT(0).getT(1).getT(1).getT(0); // PitchNu5_impl::h1_softbypass_switch14_t<NV>
		auto& h1_cable_table6 = this->getT(1).getT(0).getT(1).getT(0).                                // PitchNu5_impl::h1_cable_table6_t<NV>
                                getT(1).getT(1).getT(0).getT(0);
		auto& h1_switcher8 = this->getT(1).getT(0).getT(1).getT(0).                                   // PitchNu5_impl::h1_switcher8_t<NV>
                             getT(1).getT(1).getT(0).getT(1);
		auto& h1_sb_container8 = this->getT(1).getT(0).getT(1).getT(0).                               // PitchNu5_impl::h1_sb_container8_t<NV>
                                 getT(1).getT(1).getT(0).getT(2);
		auto& h1_sb47 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb47_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(0);
		auto& h1_add42 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(0).getT(0);
		auto& h1_sb48 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb48_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(1);
		auto& h1_add43 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(1).getT(0);
		auto& h1_sb49 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb49_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(2);
		auto& h1_add44 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(2).getT(0);
		auto& h1_sb50 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb50_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(3);
		auto& h1_add45 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(3).getT(0);
		auto& h1_sb51 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb51_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(4);
		auto& h1_add46 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(4).getT(0);
		auto& h1_sb52 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb52_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(5);
		auto& h1_add47 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(5).getT(0);
		auto& h1_sb53 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb53_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(6);
		auto& h1_add48 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(6).getT(0);
		auto& h1_sb54 = this->getT(1).getT(0).getT(1).getT(0).                                        // PitchNu5_impl::h1_sb54_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(7);
		auto& h1_add49 = this->getT(1).getT(0).getT(1).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(7).getT(0);
		auto& h1_min = this->getT(1).getT(0).getT(2);                                                 // PitchNu5_impl::h1_min_t<NV>
		auto& h1_softbypass_switch6 = this->getT(1).getT(0).getT(2).getT(0);                          // PitchNu5_impl::h1_softbypass_switch6_t<NV>
		auto& h1_switcher9 = this->getT(1).getT(0).getT(2).getT(0).getT(0);                           // PitchNu5_impl::h1_switcher9_t<NV>
		auto& h1_sb_container9 = this->getT(1).getT(0).getT(2).getT(0).getT(1);                       // PitchNu5_impl::h1_sb_container9_t<NV>
		auto& h1_sb55 = this->getT(1).getT(0).getT(2).getT(0).getT(1).getT(0);                        // PitchNu5_impl::h1_sb55_t<NV>
		auto& h1_softbypass_switch15 = this->getT(1).getT(0).getT(2).getT(0).getT(1).getT(0).getT(0); // PitchNu5_impl::h1_softbypass_switch15_t<NV>
		auto& h1_cable_table7 = this->getT(1).getT(0).getT(2).getT(0).                                // PitchNu5_impl::h1_cable_table7_t<NV>
                                getT(1).getT(0).getT(0).getT(0);
		auto& h1_switcher10 = this->getT(1).getT(0).getT(2).getT(0).                                  // PitchNu5_impl::h1_switcher10_t<NV>
                              getT(1).getT(0).getT(0).getT(1);
		auto& h1_sb_container10 = this->getT(1).getT(0).getT(2).getT(0).                              // PitchNu5_impl::h1_sb_container10_t<NV>
                                  getT(1).getT(0).getT(0).getT(2);
		auto& h1_sb56 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb56_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(0);
		auto& h1_add50 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(0).getT(0);
		auto& h1_sb57 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb57_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(1);
		auto& h1_add51 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(1).getT(0);
		auto& h1_sb58 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb58_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(2);
		auto& h1_add52 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(2).getT(0);
		auto& h1_sb59 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb59_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(3);
		auto& h1_add53 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(3).getT(0);
		auto& h1_sb60 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb60_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(4);
		auto& h1_add54 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(4).getT(0);
		auto& h1_sb61 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb61_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(5);
		auto& h1_add55 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(5).getT(0);
		auto& h1_sb62 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb62_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(6);
		auto& h1_add56 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(6).getT(0);
		auto& h1_sb63 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb63_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(7);
		auto& h1_add57 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(7).getT(0);
		auto& h1_sb64 = this->getT(1).getT(0).getT(2).getT(0).getT(1).getT(1);                        // PitchNu5_impl::h1_sb64_t<NV>
		auto& h1_softbypass_switch16 = this->getT(1).getT(0).getT(2).getT(0).getT(1).getT(1).getT(0); // PitchNu5_impl::h1_softbypass_switch16_t<NV>
		auto& h1_cable_table8 = this->getT(1).getT(0).getT(2).getT(0).                                // PitchNu5_impl::h1_cable_table8_t<NV>
                                getT(1).getT(1).getT(0).getT(0);
		auto& h1_switcher11 = this->getT(1).getT(0).getT(2).getT(0).                                  // PitchNu5_impl::h1_switcher11_t<NV>
                              getT(1).getT(1).getT(0).getT(1);
		auto& h1_sb_container11 = this->getT(1).getT(0).getT(2).getT(0).                              // PitchNu5_impl::h1_sb_container11_t<NV>
                                  getT(1).getT(1).getT(0).getT(2);
		auto& h1_sb65 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb65_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(0);
		auto& h1_add58 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(0).getT(0);
		auto& h1_sb66 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb66_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(1);
		auto& h1_add59 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(1).getT(0);
		auto& h1_sb67 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb67_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(2);
		auto& h1_add60 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(2).getT(0);
		auto& h1_sb68 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb68_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(3);
		auto& h1_add61 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(3).getT(0);
		auto& h1_sb69 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb69_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(4);
		auto& h1_add62 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(4).getT(0);
		auto& h1_sb70 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb70_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(5);
		auto& h1_add63 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(5).getT(0);
		auto& h1_sb71 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb71_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(6);
		auto& h1_add64 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(6).getT(0);
		auto& h1_sb72 = this->getT(1).getT(0).getT(2).getT(0).                                        // PitchNu5_impl::h1_sb72_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(7);
		auto& h1_add65 = this->getT(1).getT(0).getT(2).getT(0).getT(1).                               // math::add<NV>
                         getT(1).getT(0).getT(2).getT(7).getT(0);
		auto& h1_min1 = this->getT(1).getT(0).getT(3);                                                // PitchNu5_impl::h1_min1_t<NV>
		auto& h1_softbypass_switch12 = this->getT(1).getT(0).getT(3).getT(0);                         // PitchNu5_impl::h1_softbypass_switch12_t<NV>
		auto& h1_switcher18 = this->getT(1).getT(0).getT(3).getT(0).getT(0);                          // PitchNu5_impl::h1_switcher18_t<NV>
		auto& h1_sb_container18 = this->getT(1).getT(0).getT(3).getT(0).getT(1);                      // PitchNu5_impl::h1_sb_container18_t<NV>
		auto& h1_sb109 = this->getT(1).getT(0).getT(3).getT(0).getT(1).getT(0);                       // PitchNu5_impl::h1_sb109_t<NV>
		auto& h1_softbypass_switch21 = this->getT(1).getT(0).getT(3).getT(0).getT(1).getT(0).getT(0); // PitchNu5_impl::h1_softbypass_switch21_t<NV>
		auto& h1_cable_table13 = this->getT(1).getT(0).getT(3).getT(0).                               // PitchNu5_impl::h1_cable_table13_t<NV>
                                 getT(1).getT(0).getT(0).getT(0);
		auto& h1_switcher19 = this->getT(1).getT(0).getT(3).getT(0).                                  // PitchNu5_impl::h1_switcher19_t<NV>
                              getT(1).getT(0).getT(0).getT(1);
		auto& h1_sb_container19 = this->getT(1).getT(0).getT(3).getT(0).                              // PitchNu5_impl::h1_sb_container19_t<NV>
                                  getT(1).getT(0).getT(0).getT(2);
		auto& h1_sb110 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb110_t<NV>
                         getT(1).getT(0).getT(0).getT(2).
                         getT(0);
		auto& h1_add99 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(0).getT(0);
		auto& h1_sb111 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb111_t<NV>
                         getT(1).getT(0).getT(0).getT(2).
                         getT(1);
		auto& h1_add100 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(0).getT(0).getT(2).getT(1).getT(0);
		auto& h1_sb112 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb112_t<NV>
                         getT(1).getT(0).getT(0).getT(2).
                         getT(2);
		auto& h1_add101 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(0).getT(0).getT(2).getT(2).getT(0);
		auto& h1_sb113 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb113_t<NV>
                         getT(1).getT(0).getT(0).getT(2).
                         getT(3);
		auto& h1_add102 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(0).getT(0).getT(2).getT(3).getT(0);
		auto& h1_sb114 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb114_t<NV>
                         getT(1).getT(0).getT(0).getT(2).
                         getT(4);
		auto& h1_add103 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(0).getT(0).getT(2).getT(4).getT(0);
		auto& h1_sb115 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb115_t<NV>
                         getT(1).getT(0).getT(0).getT(2).
                         getT(5);
		auto& h1_add104 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(0).getT(0).getT(2).getT(5).getT(0);
		auto& h1_sb116 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb116_t<NV>
                         getT(1).getT(0).getT(0).getT(2).
                         getT(6);
		auto& h1_add105 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(0).getT(0).getT(2).getT(6).getT(0);
		auto& h1_sb117 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb117_t<NV>
                         getT(1).getT(0).getT(0).getT(2).
                         getT(7);
		auto& h1_add106 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(0).getT(0).getT(2).getT(7).getT(0);
		auto& h1_sb118 = this->getT(1).getT(0).getT(3).getT(0).getT(1).getT(1);                       // PitchNu5_impl::h1_sb118_t<NV>
		auto& h1_softbypass_switch22 = this->getT(1).getT(0).getT(3).getT(0).getT(1).getT(1).getT(0); // PitchNu5_impl::h1_softbypass_switch22_t<NV>
		auto& h1_cable_table14 = this->getT(1).getT(0).getT(3).getT(0).                               // PitchNu5_impl::h1_cable_table14_t<NV>
                                 getT(1).getT(1).getT(0).getT(0);
		auto& h1_switcher20 = this->getT(1).getT(0).getT(3).getT(0).                                  // PitchNu5_impl::h1_switcher20_t<NV>
                              getT(1).getT(1).getT(0).getT(1);
		auto& h1_sb_container20 = this->getT(1).getT(0).getT(3).getT(0).                              // PitchNu5_impl::h1_sb_container20_t<NV>
                                  getT(1).getT(1).getT(0).getT(2);
		auto& h1_sb119 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb119_t<NV>
                         getT(1).getT(1).getT(0).getT(2).
                         getT(0);
		auto& h1_add107 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(1).getT(0).getT(2).getT(0).getT(0);
		auto& h1_sb120 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb120_t<NV>
                         getT(1).getT(1).getT(0).getT(2).
                         getT(1);
		auto& h1_add108 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(1).getT(0).getT(2).getT(1).getT(0);
		auto& h1_sb121 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb121_t<NV>
                         getT(1).getT(1).getT(0).getT(2).
                         getT(2);
		auto& h1_add109 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(1).getT(0).getT(2).getT(2).getT(0);
		auto& h1_sb122 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb122_t<NV>
                         getT(1).getT(1).getT(0).getT(2).
                         getT(3);
		auto& h1_add110 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(1).getT(0).getT(2).getT(3).getT(0);
		auto& h1_sb123 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb123_t<NV>
                         getT(1).getT(1).getT(0).getT(2).
                         getT(4);
		auto& h1_add111 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(1).getT(0).getT(2).getT(4).getT(0);
		auto& h1_sb124 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb124_t<NV>
                         getT(1).getT(1).getT(0).getT(2).
                         getT(5);
		auto& h1_add112 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(1).getT(0).getT(2).getT(5).getT(0);
		auto& h1_sb125 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb125_t<NV>
                         getT(1).getT(1).getT(0).getT(2).
                         getT(6);
		auto& h1_add113 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(1).getT(0).getT(2).getT(6).getT(0);
		auto& h1_sb126 = this->getT(1).getT(0).getT(3).getT(0).                                       // PitchNu5_impl::h1_sb126_t<NV>
                         getT(1).getT(1).getT(0).getT(2).
                         getT(7);
		auto& h1_add114 = this->getT(1).getT(0).getT(3).getT(0).getT(1).                              // math::add<NV>
                          getT(1).getT(0).getT(2).getT(7).getT(0);
		auto& h1_Det = this->getT(1).getT(0).getT(4);                                                 // PitchNu5_impl::h1_Det_t<NV>
		auto& h1_softbypass_switch7 = this->getT(1).getT(0).getT(4).getT(0);                          // PitchNu5_impl::h1_softbypass_switch7_t<NV>
		auto& h1_switcher12 = this->getT(1).getT(0).getT(4).getT(0).getT(0);                          // PitchNu5_impl::h1_switcher12_t<NV>
		auto& h1_sb_container12 = this->getT(1).getT(0).getT(4).getT(0).getT(1);                      // PitchNu5_impl::h1_sb_container12_t<NV>
		auto& h1_sb73 = this->getT(1).getT(0).getT(4).getT(0).getT(1).getT(0);                        // PitchNu5_impl::h1_sb73_t<NV>
		auto& h1_softbypass_switch17 = this->getT(1).getT(0).getT(4).getT(0).getT(1).getT(0).getT(0); // PitchNu5_impl::h1_softbypass_switch17_t<NV>
		auto& h1_cable_table9 = this->getT(1).getT(0).getT(4).getT(0).                                // PitchNu5_impl::h1_cable_table9_t<NV>
                                getT(1).getT(0).getT(0).getT(0);
		auto& h1_switcher13 = this->getT(1).getT(0).getT(4).getT(0).                                  // PitchNu5_impl::h1_switcher13_t<NV>
                              getT(1).getT(0).getT(0).getT(1);
		auto& h1_sb_container13 = this->getT(1).getT(0).getT(4).getT(0).                              // PitchNu5_impl::h1_sb_container13_t<NV>
                                  getT(1).getT(0).getT(0).getT(2);
		auto& h1_sb74 = this->getT(1).getT(0).getT(4).getT(0).                                        // PitchNu5_impl::h1_sb74_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(0);
		auto& h1_add66 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(0).getT(0);
		auto& h1_sb75 = this->getT(1).getT(0).getT(4).getT(0).                                        // PitchNu5_impl::h1_sb75_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(1);
		auto& h1_add67 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(1).getT(0);
		auto& h1_sb76 = this->getT(1).getT(0).getT(4).getT(0).                                        // PitchNu5_impl::h1_sb76_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(2);
		auto& h1_add68 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(2).getT(0);
		auto& h1_sb77 = this->getT(1).getT(0).getT(4).getT(0).                                        // PitchNu5_impl::h1_sb77_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(3);
		auto& h1_add69 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(3).getT(0);
		auto& h1_sb78 = this->getT(1).getT(0).getT(4).getT(0).                                        // PitchNu5_impl::h1_sb78_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(4);
		auto& h1_add70 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(4).getT(0);
		auto& h1_sb79 = this->getT(1).getT(0).getT(4).getT(0).                                        // PitchNu5_impl::h1_sb79_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(5);
		auto& h1_add71 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(5).getT(0);
		auto& h1_sb80 = this->getT(1).getT(0).getT(4).getT(0).                                        // PitchNu5_impl::h1_sb80_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(6);
		auto& h1_add72 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(6).getT(0);
		auto& h1_sb81 = this->getT(1).getT(0).getT(4).getT(0).                                        // PitchNu5_impl::h1_sb81_t<NV>
                        getT(1).getT(0).getT(0).getT(2).
                        getT(7);
		auto& h1_add73 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                               // math::add<NV>
                         getT(0).getT(0).getT(2).getT(7).getT(0);
		auto& h1_sb82 = this->getT(1).getT(0).getT(4).getT(0).getT(1).getT(1);                        // PitchNu5_impl::h1_sb82_t<NV>
		auto& h1_softbypass_switch18 = this->getT(1).getT(0).getT(4).getT(0).getT(1).getT(1).getT(0); // PitchNu5_impl::h1_softbypass_switch18_t<NV>
		auto& h1_cable_table10 = this->getT(1).getT(0).getT(4).getT(0).                               // PitchNu5_impl::h1_cable_table10_t<NV>
                                 getT(1).getT(1).getT(0).getT(0);
		auto& h1_switcher14 = this->getT(1).getT(0).getT(4).getT(0).                    // PitchNu5_impl::h1_switcher14_t<NV>
                              getT(1).getT(1).getT(0).getT(1);
		auto& h1_sb_container14 = this->getT(1).getT(0).getT(4).getT(0).                // PitchNu5_impl::h1_sb_container14_t<NV>
                                  getT(1).getT(1).getT(0).getT(2);
		auto& h1_sb83 = this->getT(1).getT(0).getT(4).getT(0).                          // PitchNu5_impl::h1_sb83_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(0);
		auto& h1_add74 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                 // math::add<NV>
                         getT(1).getT(0).getT(2).getT(0).getT(0);
		auto& h1_sb84 = this->getT(1).getT(0).getT(4).getT(0).                          // PitchNu5_impl::h1_sb84_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(1);
		auto& h1_add75 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                 // math::add<NV>
                         getT(1).getT(0).getT(2).getT(1).getT(0);
		auto& h1_sb85 = this->getT(1).getT(0).getT(4).getT(0).                          // PitchNu5_impl::h1_sb85_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(2);
		auto& h1_add76 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                 // math::add<NV>
                         getT(1).getT(0).getT(2).getT(2).getT(0);
		auto& h1_sb86 = this->getT(1).getT(0).getT(4).getT(0).                          // PitchNu5_impl::h1_sb86_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(3);
		auto& h1_add77 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                 // math::add<NV>
                         getT(1).getT(0).getT(2).getT(3).getT(0);
		auto& h1_sb87 = this->getT(1).getT(0).getT(4).getT(0).                          // PitchNu5_impl::h1_sb87_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(4);
		auto& h1_add78 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                 // math::add<NV>
                         getT(1).getT(0).getT(2).getT(4).getT(0);
		auto& h1_sb88 = this->getT(1).getT(0).getT(4).getT(0).                          // PitchNu5_impl::h1_sb88_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(5);
		auto& h1_add79 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                 // math::add<NV>
                         getT(1).getT(0).getT(2).getT(5).getT(0);
		auto& h1_sb89 = this->getT(1).getT(0).getT(4).getT(0).                          // PitchNu5_impl::h1_sb89_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(6);
		auto& h1_add80 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                 // math::add<NV>
                         getT(1).getT(0).getT(2).getT(6).getT(0);
		auto& h1_sb90 = this->getT(1).getT(0).getT(4).getT(0).                          // PitchNu5_impl::h1_sb90_t<NV>
                        getT(1).getT(1).getT(0).getT(2).
                        getT(7);
		auto& h1_add81 = this->getT(1).getT(0).getT(4).getT(0).getT(1).                 // math::add<NV>
                         getT(1).getT(0).getT(2).getT(7).getT(0);
		auto& h1_5ths = this->getT(1).getT(0).getT(5);                                  // PitchNu5_impl::h1_5ths_t<NV>
		auto& h1_softbypass_switch4 = this->getT(1).getT(0).getT(5).getT(0);            // PitchNu5_impl::h1_softbypass_switch4_t<NV>
		auto& h1_softbypass_switch11 = this->getT(1).getT(0).getT(5).getT(0).getT(0);   // PitchNu5_impl::h1_softbypass_switch11_t<NV>
		auto& h1_switcher4 = this->getT(1).getT(0).getT(5).getT(0).getT(0).getT(0);     // PitchNu5_impl::h1_switcher4_t<NV>
		auto& h1_sb_container4 = this->getT(1).getT(0).getT(5).getT(0).getT(0).getT(1); // PitchNu5_impl::h1_sb_container4_t<NV>
		auto& h1_sb20 = this->getT(1).getT(0).getT(5).getT(0).getT(0).getT(1).getT(0);  // PitchNu5_impl::h1_sb20_t<NV>
		auto& h1_add18 = this->getT(1).getT(0).getT(5).getT(0).                         // math::add<NV>
                         getT(0).getT(1).getT(0).getT(0);
		auto& h1_sb21 = this->getT(1).getT(0).getT(5).getT(0).getT(0).getT(1).getT(1); // PitchNu5_impl::h1_sb21_t<NV>
		auto& h1_add19 = this->getT(1).getT(0).getT(5).getT(0).                        // math::add<NV>
                         getT(0).getT(1).getT(1).getT(0);
		auto& h1_sb22 = this->getT(1).getT(0).getT(5).getT(0).getT(0).getT(1).getT(2); // PitchNu5_impl::h1_sb22_t<NV>
		auto& h1_add20 = this->getT(1).getT(0).getT(5).getT(0).                        // math::add<NV>
                         getT(0).getT(1).getT(2).getT(0);
		auto& h1_sb23 = this->getT(1).getT(0).getT(5).getT(0).getT(0).getT(1).getT(3); // PitchNu5_impl::h1_sb23_t<NV>
		auto& h1_add21 = this->getT(1).getT(0).getT(5).getT(0).                        // math::add<NV>
                         getT(0).getT(1).getT(3).getT(0);
		auto& h1_sb24 = this->getT(1).getT(0).getT(5).getT(0).getT(0).getT(1).getT(4); // PitchNu5_impl::h1_sb24_t<NV>
		auto& h1_add22 = this->getT(1).getT(0).getT(5).getT(0).                        // math::add<NV>
                         getT(0).getT(1).getT(4).getT(0);
		auto& h1_sb25 = this->getT(1).getT(0).getT(5).getT(0).getT(0).getT(1).getT(5); // PitchNu5_impl::h1_sb25_t<NV>
		auto& h1_add23 = this->getT(1).getT(0).getT(5).getT(0).                        // math::add<NV>
                         getT(0).getT(1).getT(5).getT(0);
		auto& h1_sb26 = this->getT(1).getT(0).getT(5).getT(0).getT(0).getT(1).getT(6); // PitchNu5_impl::h1_sb26_t<NV>
		auto& h1_add24 = this->getT(1).getT(0).getT(5).getT(0).                        // math::add<NV>
                         getT(0).getT(1).getT(6).getT(0);
		auto& h1_free = this->getT(1).getT(0).getT(6);          // PitchNu5_impl::h1_free_t<NV>
		auto& h1_add82 = this->getT(1).getT(0).getT(6).getT(0); // math::add<NV>
		auto& h1_Semi = this->getT(1).getT(0).getT(7);          // PitchNu5_impl::h1_Semi_t
		auto& h1_peak3 = this->getT(1).getT(1);                 // PitchNu5_impl::h1_peak3_t<NV>
		auto& h1_clear = this->getT(1).getT(2);                 // math::clear<NV>
		auto& h1_add1 = this->getT(1).getT(3);                  // math::add<NV>
		auto& smoother = this->getT(1).getT(4);                 // core::smoother<NV>
		
		// Parameter Connections -------------------------------------------------------------------
		
		this->getParameterT(0).connectT(0, pma2); // StageMod -> pma2::Multiply
		
		auto& StageSrc_p = this->getParameterT(1);
		StageSrc_p.connectT(0, cable_table13);      // StageSrc -> cable_table13::Value
		StageSrc_p.connectT(1, cable_table14);      // StageSrc -> cable_table14::Value
		StageSrc_p.connectT(2, event_data_reader8); // StageSrc -> event_data_reader8::SlotIndex
		...
		cable_table13.getWrappedObject().getParameter().connectT(0, branch4); // cable_table13 -> branch4::Index
		...
		input_toggle1x1.getWrappedObject().getParameter().connectT(0, pma2);          // input_toggle1x1 -> pma2::Value
		cable_table14.getWrappedObject().getParameter().connectT(0, input_toggle1x1); // cable_table14 -> input_toggle1x1::Input
		event_data_reader8.getParameter().connectT(0, input_toggle1x1);               // event_data_reader8 -> input_toggle1x1::Value1
		peak3.getParameter().connectT(0, input_toggle1x1);                            // peak3 -> input_toggle1x1::Value2
		global_cable1.getWrappedObject().getParameter().connectT(0, pma2);            // global_cable1 -> pma2::Add
		...
		; // input_toggle1x1::Input is automated
		; // input_toggle1x1::Value1 is automated
		; // input_toggle1x1::Value2 is automated
	...
	void connectToRuntimeTarget(bool addConnection, const runtime_target::connection& c)
	{
		...
		this->getT(0).getT(0).getT(0).getT(0).                                                  // PitchNu5_impl::global_cable24_t<NV>
        getT(2).getT(1).getT(0).getT(0).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(0).getT(0).                                                  // PitchNu5_impl::global_cable25_t<NV>
        getT(2).getT(1).getT(0).getT(1).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(0).getT(0).                                                  // PitchNu5_impl::global_cable26_t<NV>
        getT(2).getT(1).getT(0).getT(2).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(0).getT(0).                                                  // PitchNu5_impl::global_cable27_t<NV>
        getT(2).getT(1).getT(0).getT(3).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(0).getT(0).                                                  // PitchNu5_impl::global_cable28_t<NV>
        getT(2).getT(1).getT(0).getT(4).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(0).getT(0).                                                  // PitchNu5_impl::global_cable29_t<NV>
        getT(2).getT(1).getT(0).getT(5).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(0).getT(0).                                                  // PitchNu5_impl::global_cable30_t<NV>
        getT(2).getT(1).getT(0).getT(6).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(0).getT(0).                                                  // PitchNu5_impl::global_cable31_t<NV>
        getT(2).getT(1).getT(0).getT(7).
        getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(2).getT(0).getT(0).connectToRuntimeTarget(addConnection, c); // PitchNu5_impl::global_cable1_t<NV>
	}
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(0).getT(0).getT(0).getT(0).getT(0).setExternalData(b, index);                 // PitchNu5_impl::cable_table13_t<NV>
		this->getT(0).getT(0).getT(0).getT(0).getT(1).setExternalData(b, index);                 // PitchNu5_impl::cable_table14_t<NV>
		this->getT(0).getT(0).getT(0).getT(0).getT(2).getT(1).getT(1).setExternalData(b, index); // PitchNu5_impl::peak3_t<NV>
		this->getT(1).getT(0).getT(0).getT(0).                                                   // PitchNu5_impl::h1_cable_table1_t<NV>
        getT(1).getT(0).getT(0).getT(0).setExternalData(b, index);
		this->getT(1).getT(0).getT(0).getT(0).           // PitchNu5_impl::h1_cable_table2_t<NV>
        getT(1).getT(1).getT(0).getT(0).setExternalData(b, index);
		this->getT(1).getT(0).getT(1).getT(0).           // PitchNu5_impl::h1_cable_table5_t<NV>
        getT(1).getT(0).getT(0).getT(0).setExternalData(b, index);
		this->getT(1).getT(0).getT(1).getT(0).           // PitchNu5_impl::h1_cable_table6_t<NV>
        getT(1).getT(1).getT(0).getT(0).setExternalData(b, index);
		this->getT(1).getT(0).getT(2).getT(0).           // PitchNu5_impl::h1_cable_table7_t<NV>
        getT(1).getT(0).getT(0).getT(0).setExternalData(b, index);
		this->getT(1).getT(0).getT(2).getT(0).           // PitchNu5_impl::h1_cable_table8_t<NV>
        getT(1).getT(1).getT(0).getT(0).setExternalData(b, index);
		this->getT(1).getT(0).getT(3).getT(0).           // PitchNu5_impl::h1_cable_table13_t<NV>
        getT(1).getT(0).getT(0).getT(0).setExternalData(b, index);
		this->getT(1).getT(0).getT(3).getT(0).           // PitchNu5_impl::h1_cable_table14_t<NV>
        getT(1).getT(1).getT(0).getT(0).setExternalData(b, index);
		this->getT(1).getT(0).getT(4).getT(0).           // PitchNu5_impl::h1_cable_table9_t<NV>
        getT(1).getT(0).getT(0).getT(0).setExternalData(b, index);
		this->getT(1).getT(0).getT(4).getT(0).           // PitchNu5_impl::h1_cable_table10_t<NV>
        getT(1).getT(1).getT(0).getT(0).setExternalData(b, index);
		this->getT(1).getT(1).setExternalData(b, index); // PitchNu5_impl::h1_peak3_t<NV>
	}
};
}
...
template <int NV>
using PitchNu5 = wrap::node<PitchNu5_impl::instance<NV>>;
}
