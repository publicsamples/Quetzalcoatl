...
template <int NV>
using smooth_x1_0 = parameter::from0To1<xfade4_impl::smoothed_parameter_x1_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;

template <int NV>
using smooth_x1_1 = parameter::from0To1<xfade4_impl::smoothed_parameter1_x1_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;

template <int NV>
using smooth_x1_2 = parameter::from0To1<xfade4_impl::smoothed_parameter2_x1_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;

template <int NV>
using smooth_x1_3 = parameter::from0To1<xfade4_impl::smoothed_parameter4_x1_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;

template <int NV>
using smooth_x1_4 = parameter::from0To1<xfade4_impl::smoothed_parameter3_x1_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;
...
template <int NV>
using mode_x1 = parameter::plain<xfade4_impl::x1_t<NV>, 0>;
template <int NV>
...
template <int NV>
using one_1 = parameter::from0To1_inv<xfade4_impl::input_toggle_t<NV>, 
                                      0, 
                                      one_1Range>;

template <int NV>
using one = parameter::chain<ranges::Identity, 
                             parameter::plain<xfade4_impl::ramp_t<NV>, 1>, 
                             one_1<NV>>;
...
using modsel = parameter::chain<modsel_InputRange, 
                                parameter::plain<xfade4_impl::cable_table1_t<NV>, 0>>;
...
template <int NV>
using lfomode_0 = parameter::from0To1<xfade4_impl::branch1_t<NV>, 
                                      0, 
                                      lfomode_0Range>;
...
using XfModSrc = parameter::chain<XfModSrc_InputRange, 
                                  parameter::plain<xfade4_impl::branch_t<NV>, 0>>;
...
template <int NV>
using attack1 = parameter::plain<xfade4_impl::ahdsr3_t<NV>, 
                                 0>;
template <int NV>
using decay1 = parameter::plain<xfade4_impl::ahdsr3_t<NV>, 
                                3>;
template <int NV>
using sus1 = parameter::plain<xfade4_impl::ahdsr3_t<NV>, 
                              4>;
template <int NV>
using rel1 = parameter::plain<xfade4_impl::ahdsr3_t<NV>, 
                              5>;
template <int NV>
using tempo = parameter::plain<xfade4_impl::tempo_sync_t<NV>, 
                               0>;
template <int NV>
using mul = parameter::plain<xfade4_impl::tempo_sync_t<NV>, 
                             1>;
template <int NV>
using tempo2 = parameter::plain<xfade4_impl::tempo_sync_t<NV>, 
                                3>;
using Step1 = parameter::plain<xfade4_impl::pack8_writer_t, 
                               0>;
using Step2 = parameter::plain<xfade4_impl::pack8_writer_t, 
                               1>;
using Step3 = parameter::plain<xfade4_impl::pack8_writer_t, 
                               2>;
using Step4 = parameter::plain<xfade4_impl::pack8_writer_t, 
                               3>;
using Step5 = parameter::plain<xfade4_impl::pack8_writer_t, 
                               4>;
using Step6 = parameter::plain<xfade4_impl::pack8_writer_t, 
                               5>;
using Step7 = parameter::plain<xfade4_impl::pack8_writer_t, 
                               6>;
using Step8 = parameter::plain<xfade4_impl::pack8_writer_t, 
                               7>;
using Gate1 = parameter::plain<xfade4_impl::pack8_writer2_t, 
                               0>;
using Gate2 = parameter::plain<xfade4_impl::pack8_writer2_t, 
                               2>;
using Gate3 = parameter::plain<xfade4_impl::pack8_writer2_t, 
                               4>;
using Gate4 = parameter::plain<xfade4_impl::pack8_writer2_t, 
                               6>;
using Gate5 = parameter::plain<xfade4_impl::pack8_writer5_t, 
                               0>;
using Gate6 = parameter::plain<xfade4_impl::pack8_writer5_t, 
                               2>;
using Gate7 = parameter::plain<xfade4_impl::pack8_writer5_t, 
                               4>;
using Gate8 = parameter::plain<xfade4_impl::pack8_writer5_t, 
                               6>;
template <int NV>
using A = parameter::plain<xfade4_impl::simple_ar_t<NV>, 
                           0>;
template <int NV>
using H = parameter::plain<xfade4_impl::simple_ar_t<NV>, 
                           3>;
template <int NV>
using sync = parameter::plain<xfade4_impl::tempo_sync_t<NV>, 
                              2>;
template <int NV>
using R = parameter::plain<xfade4_impl::simple_ar_t<NV>, 
                           1>;
template <int NV>
using XF = parameter::plain<xfade4_impl::pma_t<NV>, 2>;
template <int NV>
using XFsmooth = parameter::plain<xfade4_impl::XF1_t<NV>, 0>;
template <int NV>
using XfMod = parameter::plain<xfade4_impl::pma_t<NV>, 1>;
template <int NV>
using vel = parameter::plain<xfade4_impl::pma1_t<NV>, 
                             1>;
template <int NV>
using trk = parameter::plain<xfade4_impl::pma2_t<NV>, 
                             1>;
template <int NV>
using mw = parameter::plain<xfade4_impl::pma3_t<NV>, 
                            1>;
template <int NV>
using aft = parameter::plain<xfade4_impl::pma4_t<NV>, 
                             1>;
template <int NV>
using xfade4_t_plist = parameter::list<attack1<NV>, 
                                       decay1<NV>, 
                                       sus1<NV>, 
                                       rel1<NV>, 
                                       tempo<NV>, 
...
template <int NV> struct instance: public xfade4_impl::xfade4_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ENCODED_PARAMETERS(598)
		{
            ...
            0x0031, 0x0000, 0x0000, 0x0000, 0x3F80, 0xBB06, 0x3EAE, 0x0000, 
	...
	instance()
	{
		...
		auto& split = this->getT(0).getT(0);                                                  // xfade4_impl::split_t<NV>
		auto& branch = this->getT(0).getT(0).getT(0);                                         // xfade4_impl::branch_t<NV>
		auto& chain8 = this->getT(0).getT(0).getT(0).getT(0);                                 // xfade4_impl::chain8_t<NV>
		auto& clear = this->getT(0).getT(0).getT(0).getT(0).getT(0);                          // math::clear<NV>
		auto& no_midi = this->getT(0).getT(0).getT(0).getT(0).getT(1);                        // xfade4_impl::no_midi_t<NV>
		auto& tempo_sync = this->getT(0).getT(0).getT(0).getT(0).getT(1).getT(0);             // xfade4_impl::tempo_sync_t<NV>
		auto& ramp = this->getT(0).getT(0).getT(0).getT(0).getT(1).getT(1);                   // xfade4_impl::ramp_t<NV>
		auto& clear6 = this->getT(0).getT(0).getT(0).getT(0).getT(2);                         // math::clear<NV>
		auto& softbypass_switch6 = this->getT(0).getT(0).getT(0).getT(0).getT(3);             // xfade4_impl::softbypass_switch6_t<NV>
		auto& cable_table1 = this->getT(0).getT(0).getT(0).getT(0).getT(3).getT(0);           // xfade4_impl::cable_table1_t<NV>
		auto& switcher = this->getT(0).getT(0).getT(0).getT(0).getT(3).getT(1);               // xfade4_impl::switcher_t<NV>
		auto& clear1 = this->getT(0).getT(0).getT(0).getT(0).getT(3).getT(2);                 // math::clear<NV>
		auto& sb_container = this->getT(0).getT(0).getT(0).getT(0).getT(3).getT(3);           // xfade4_impl::sb_container_t<NV>
		auto& sb1 = this->getT(0).getT(0).getT(0).getT(0).getT(3).getT(3).getT(0);            // xfade4_impl::sb1_t<NV>
		auto& minmax = this->getT(0).getT(0).getT(0).getT(0).                                 // xfade4_impl::minmax_t<NV>
                       getT(3).getT(3).getT(0).getT(0);
		auto& clear5 = this->getT(0).getT(0).getT(0).getT(0).                                 // math::clear<NV>
                       getT(3).getT(3).getT(0).getT(1);
		auto& input_toggle = this->getT(0).getT(0).getT(0).getT(0).                           // xfade4_impl::input_toggle_t<NV>
                             getT(3).getT(3).getT(0).getT(2);
		auto& ahdsr3 = this->getT(0).getT(0).getT(0).getT(0).                                 // xfade4_impl::ahdsr3_t<NV>
                       getT(3).getT(3).getT(0).getT(3);
		auto& add12 = this->getT(0).getT(0).getT(0).getT(0).                                  // math::add<NV>
                      getT(3).getT(3).getT(0).getT(4);
		auto& sb2 = this->getT(0).getT(0).getT(0).getT(0).getT(3).getT(3).getT(1);            // xfade4_impl::sb2_t<NV>
		auto& ramp1 = this->getT(0).getT(0).getT(0).getT(0).                                  // xfade4_impl::ramp1_t<NV>
                      getT(3).getT(3).getT(1).getT(0);
		auto& branch1 = this->getT(0).getT(0).getT(0).getT(0).                                // xfade4_impl::branch1_t<NV>
                        getT(3).getT(3).getT(1).getT(1);
		auto& chain1 = this->getT(0).getT(0).getT(0).getT(0).                                 // xfade4_impl::chain1_t<NV>
                       getT(3).getT(3).getT(1).getT(1).
                       getT(0);
		...
		auto& chain3 = this->getT(0).getT(0).getT(0).getT(0).                                 // xfade4_impl::chain3_t<NV>
                       getT(3).getT(3).getT(1).getT(1).
                       getT(1);
		...
		auto& peak = this->getT(0).getT(0).getT(0).getT(0).                                   // xfade4_impl::peak_t<NV>
                     getT(3).getT(3).getT(1).getT(2);
		auto& add1 = this->getT(0).getT(0).getT(0).getT(0).                                   // math::add<NV>
                     getT(3).getT(3).getT(1).getT(3);
		auto& sb6 = this->getT(0).getT(0).getT(0).getT(0).getT(3).getT(3).getT(2);            // xfade4_impl::sb6_t<NV>
		auto& split2 = this->getT(0).getT(0).getT(0).getT(0).                                 // xfade4_impl::split2_t<NV>
                       getT(3).getT(3).getT(2).getT(0);
		auto& chain = this->getT(0).getT(0).getT(0).getT(0).                                  // xfade4_impl::chain_t<NV>
                      getT(3).getT(3).getT(2).getT(0).
                      getT(0);
		auto& pack8_writer = this->getT(0).getT(0).getT(0).getT(0).getT(3).                   // xfade4_impl::pack8_writer_t
                             getT(3).getT(2).getT(0).getT(0).getT(0);
		auto& cable_table8 = this->getT(0).getT(0).getT(0).getT(0).getT(3).                   // xfade4_impl::cable_table8_t
		...
		auto& cable_pack = this->getT(0).getT(0).getT(0).getT(0).getT(3).                     // xfade4_impl::cable_pack_t<NV>
                           getT(3).getT(2).getT(0).getT(0).getT(3);
		auto& add8 = this->getT(0).getT(0).getT(0).getT(0).                                   // math::add<NV>
                     getT(3).getT(3).getT(2).getT(1);
		auto& soft_bypass = this->getT(0).getT(0).getT(0).getT(0).getT(3).getT(3).getT(3);    // xfade4_impl::soft_bypass_t<NV>
		auto& split6 = this->getT(0).getT(0).getT(0).getT(0).                                 // xfade4_impl::split6_t<NV>
                       getT(3).getT(3).getT(3).getT(0);
		auto& chain7 = this->getT(0).getT(0).getT(0).getT(0).                                 // xfade4_impl::chain7_t<NV>
                       getT(3).getT(3).getT(3).getT(0).
                       getT(0);
		auto& cable_table4 = this->getT(0).getT(0).getT(0).getT(0).getT(3).                   // xfade4_impl::cable_table4_t<NV>
                             getT(3).getT(3).getT(0).getT(0).getT(0);
		auto& pack8_writer2 = this->getT(0).getT(0).getT(0).getT(0).getT(3).                  // xfade4_impl::pack8_writer2_t
                              getT(3).getT(3).getT(0).getT(0).getT(1);
		auto& cable_table2 = this->getT(0).getT(0).getT(0).getT(0).getT(3).                   // xfade4_impl::cable_table2_t
                             getT(3).getT(3).getT(0).getT(0).getT(2);
		auto& cable_pack3 = this->getT(0).getT(0).getT(0).getT(0).getT(3).                    // xfade4_impl::cable_pack3_t<NV>
		...
		auto& chain11 = this->getT(0).getT(0).getT(0).getT(0).                                // xfade4_impl::chain11_t<NV>
                        getT(3).getT(3).getT(3).getT(0).
                        getT(1);
		auto& cable_table7 = this->getT(0).getT(0).getT(0).getT(0).getT(3).                   // xfade4_impl::cable_table7_t<NV>
                             getT(3).getT(3).getT(0).getT(1).getT(0);
		auto& pack8_writer5 = this->getT(0).getT(0).getT(0).getT(0).getT(3).                  // xfade4_impl::pack8_writer5_t
                              getT(3).getT(3).getT(0).getT(1).getT(1);
		auto& cable_table3 = this->getT(0).getT(0).getT(0).getT(0).getT(3).                   // xfade4_impl::cable_table3_t
                             getT(3).getT(3).getT(0).getT(1).getT(2);
		auto& cable_pack6 = this->getT(0).getT(0).getT(0).getT(0).getT(3).                    // xfade4_impl::cable_pack6_t<NV>
		...
		auto& peak2 = this->getT(0).getT(0).getT(0).getT(0).                                  // xfade4_impl::peak2_t<NV>
                      getT(3).getT(3).getT(3).getT(1);
		auto& clear2 = this->getT(0).getT(0).getT(0).getT(0).                                 // math::clear<NV>
                       getT(3).getT(3).getT(3).getT(2);
		auto& no_midi1 = this->getT(0).getT(0).getT(0).getT(0).                               // xfade4_impl::no_midi1_t<NV>
                         getT(3).getT(3).getT(3).getT(3);
		auto& simple_ar = this->getT(0).getT(0).getT(0).getT(0).                              // xfade4_impl::simple_ar_t<NV>
                          getT(3).getT(3).getT(3).getT(3).
                          getT(0);
		auto& add13 = this->getT(0).getT(0).getT(0).getT(0).                                  // math::add<NV>
                      getT(3).getT(3).getT(3).getT(3).
                      getT(1);
		auto& split1 = this->getT(0).getT(0).getT(1);                                         // xfade4_impl::split1_t<NV>
		auto& chain4 = this->getT(0).getT(0).getT(1).getT(0);                                 // xfade4_impl::chain4_t<NV>
		auto& midi = this->getT(0).getT(0).getT(1).getT(0).getT(0);                           // xfade4_impl::midi_t<NV>
		auto& pma1 = this->getT(0).getT(0).getT(1).getT(0).getT(1);                           // xfade4_impl::pma1_t<NV>
		auto& add4 = this->getT(0).getT(0).getT(1).getT(0).getT(2);                           // math::add<NV>
		auto& chain5 = this->getT(0).getT(0).getT(1).getT(1);                                 // xfade4_impl::chain5_t<NV>
		auto& midi1 = this->getT(0).getT(0).getT(1).getT(1).getT(0);                          // xfade4_impl::midi1_t<NV>
		auto& pma2 = this->getT(0).getT(0).getT(1).getT(1).getT(1);                           // xfade4_impl::pma2_t<NV>
		auto& add5 = this->getT(0).getT(0).getT(1).getT(1).getT(2);                           // math::add<NV>
		auto& chain6 = this->getT(0).getT(0).getT(1).getT(2);                                 // xfade4_impl::chain6_t<NV>
		auto& midi_cc = this->getT(0).getT(0).getT(1).getT(2).getT(0);                        // xfade4_impl::midi_cc_t<NV>
		auto& pma3 = this->getT(0).getT(0).getT(1).getT(2).getT(1);                           // xfade4_impl::pma3_t<NV>
		auto& add6 = this->getT(0).getT(0).getT(1).getT(2).getT(2);                           // math::add<NV>
		auto& chain9 = this->getT(0).getT(0).getT(1).getT(3);                                 // xfade4_impl::chain9_t<NV>
		auto& midi_cc1 = this->getT(0).getT(0).getT(1).getT(3).getT(0);                       // xfade4_impl::midi_cc1_t<NV>
		auto& pma4 = this->getT(0).getT(0).getT(1).getT(3).getT(1);                           // xfade4_impl::pma4_t<NV>
		auto& add9 = this->getT(0).getT(0).getT(1).getT(3).getT(2);                           // math::add<NV>
		auto& peak1 = this->getT(0).getT(1);                                                  // xfade4_impl::peak1_t<NV>
		auto& pma = this->getT(1);                                                            // xfade4_impl::pma_t<NV>
		auto& XF1 = this->getT(2);                                                            // xfade4_impl::XF1_t<NV>
		auto& x1 = this->getT(2).getT(0);                                                     // xfade4_impl::x1_t<NV>
		auto& switcher_x1 = this->getT(2).getT(0).getT(0);                                    // xfade4_impl::switcher_x1_t<NV>
		auto& sb_container_x1 = this->getT(2).getT(0).getT(1);                                // xfade4_impl::sb_container_x1_t<NV>
		auto& sb1_x1 = this->getT(2).getT(0).getT(1).getT(0);                                 // xfade4_impl::sb1_x1_t<NV>
		auto& chain1_x1 = this->getT(2).getT(0).getT(1).getT(0).getT(0);                      // xfade4_impl::chain1_x1_t<NV>
		auto& xfader_x1 = this->getT(2).getT(0).getT(1).getT(0).getT(0).getT(0);              // xfade4_impl::xfader_x1_t<NV>
		auto& smoothed_parameter_x1 = this->getT(2).getT(0).getT(1).getT(0).getT(0).getT(1);  // xfade4_impl::smoothed_parameter_x1_t<NV>
		auto& gain = this->getT(2).getT(0).getT(1).getT(0).getT(0).getT(2);                   // core::gain<NV>
		auto& sb2_x1 = this->getT(2).getT(0).getT(1).getT(1);                                 // xfade4_impl::sb2_x1_t<NV>
		auto& chain3_x1_x1 = this->getT(2).getT(0).getT(1).getT(1).getT(0);                   // xfade4_impl::chain3_x1_x1_t<NV>
		auto& xfader2_x1 = this->getT(2).getT(0).getT(1).getT(1).getT(0).getT(0);             // xfade4_impl::xfader2_x1_t<NV>
		auto& smoothed_parameter1_x1 = this->getT(2).getT(0).getT(1).getT(1).getT(0).getT(1); // xfade4_impl::smoothed_parameter1_x1_t<NV>
		auto& gain1 = this->getT(2).getT(0).getT(1).getT(1).getT(0).getT(2);                  // core::gain<NV>
		auto& sb3_x1 = this->getT(2).getT(0).getT(1).getT(2);                                 // xfade4_impl::sb3_x1_t<NV>
		auto& chain2_x1 = this->getT(2).getT(0).getT(1).getT(2).getT(0);                      // xfade4_impl::chain2_x1_t<NV>
		auto& xfader1_x1 = this->getT(2).getT(0).getT(1).getT(2).getT(0).getT(0);             // xfade4_impl::xfader1_x1_t<NV>
		auto& smoothed_parameter2_x1 = this->getT(2).getT(0).getT(1).getT(2).getT(0).getT(1); // xfade4_impl::smoothed_parameter2_x1_t<NV>
		auto& gain2 = this->getT(2).getT(0).getT(1).getT(2).getT(0).getT(2);                  // core::gain<NV>
		auto& sb4_x1 = this->getT(2).getT(0).getT(1).getT(3);                                 // xfade4_impl::sb4_x1_t<NV>
		auto& chain4_x1 = this->getT(2).getT(0).getT(1).getT(3).getT(0);                      // xfade4_impl::chain4_x1_t<NV>
		auto& xfader3_x1 = this->getT(2).getT(0).getT(1).getT(3).getT(0).getT(0);             // xfade4_impl::xfader3_x1_t<NV>
		auto& smoothed_parameter4_x1 = this->getT(2).getT(0).getT(1).getT(3).getT(0).getT(1); // xfade4_impl::smoothed_parameter4_x1_t<NV>
		auto& gain3 = this->getT(2).getT(0).getT(1).getT(3).getT(0).getT(2);                  // core::gain<NV>
		auto& sb5_x1 = this->getT(2).getT(0).getT(1).getT(4);                                 // xfade4_impl::sb5_x1_t<NV>
		auto& chain5_x1 = this->getT(2).getT(0).getT(1).getT(4).getT(0);                      // xfade4_impl::chain5_x1_t<NV>
		auto& xfader4_x1 = this->getT(2).getT(0).getT(1).getT(4).getT(0).getT(0);             // xfade4_impl::xfader4_x1_t<NV>
		auto& smoothed_parameter3_x1 = this->getT(2).getT(0).getT(1).getT(4).getT(0).getT(1); // xfade4_impl::smoothed_parameter3_x1_t<NV>
		...
		xfader_x1_p.getParameterT(3).connectT(0, smoothed_parameter_x1); // xfader_x1 -> smoothed_parameter_x1::Value
		...
		xfader2_x1_p.getParameterT(3).connectT(0, smoothed_parameter1_x1); // xfader2_x1 -> smoothed_parameter1_x1::Value
		...
		xfader1_x1_p.getParameterT(3).connectT(0, smoothed_parameter2_x1); // xfader1_x1 -> smoothed_parameter2_x1::Value
		...
		xfader3_x1_p.getParameterT(3).connectT(0, smoothed_parameter4_x1); // xfader3_x1 -> smoothed_parameter4_x1::Value
		...
		xfader4_x1_p.getParameterT(3).connectT(0, smoothed_parameter3_x1); // xfader4_x1 -> smoothed_parameter3_x1::Value
		...
		this->setParameterT(10, 0.341271);
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(0).getT(0).getT(0).getT(0).getT(1).getT(1).setExternalData(b, index); // xfade4_impl::ramp_t<NV>
		this->getT(0).getT(0).getT(0).getT(0).getT(3).getT(0).setExternalData(b, index); // xfade4_impl::cable_table1_t<NV>
		this->getT(0).getT(0).getT(0).getT(0).                                           // xfade4_impl::ahdsr3_t<NV>
        getT(3).getT(3).getT(0).getT(3).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).           // xfade4_impl::ramp1_t<NV>
        getT(3).getT(3).getT(1).getT(0).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).getT(3).   // xfade4_impl::oscillator_t<NV>
        getT(3).getT(1).getT(1).getT(3).getT(1).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).           // xfade4_impl::peak_t<NV>
        getT(3).getT(3).getT(1).getT(2).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).getT(3).   // xfade4_impl::pack8_writer_t
        getT(3).getT(2).getT(0).getT(0).getT(0).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).getT(3).   // xfade4_impl::cable_table8_t
        getT(3).getT(2).getT(0).getT(0).getT(1).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).getT(3).   // xfade4_impl::cable_pack_t<NV>
        getT(3).getT(2).getT(0).getT(0).getT(3).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).getT(3).   // xfade4_impl::cable_table4_t<NV>
        getT(3).getT(3).getT(0).getT(0).getT(0).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).getT(3).   // xfade4_impl::pack8_writer2_t
        getT(3).getT(3).getT(0).getT(0).getT(1).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).getT(3).   // xfade4_impl::cable_table2_t
        getT(3).getT(3).getT(0).getT(0).getT(2).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).getT(3).   // xfade4_impl::cable_pack3_t<NV>
        getT(3).getT(3).getT(0).getT(0).getT(3).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).getT(3).   // xfade4_impl::cable_table7_t<NV>
        getT(3).getT(3).getT(0).getT(1).getT(0).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).getT(3).   // xfade4_impl::pack8_writer5_t
        getT(3).getT(3).getT(0).getT(1).getT(1).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).getT(3).   // xfade4_impl::cable_table3_t
        getT(3).getT(3).getT(0).getT(1).getT(2).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).getT(3).   // xfade4_impl::cable_pack6_t<NV>
        getT(3).getT(3).getT(0).getT(1).getT(3).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).           // xfade4_impl::peak2_t<NV>
        getT(3).getT(3).getT(3).getT(1).setExternalData(b, index);
		this->getT(0).getT(0).getT(0).getT(0).           // xfade4_impl::simple_ar_t<NV>
        getT(3).getT(3).getT(3).getT(3).
        getT(0).setExternalData(b, index);
		this->getT(0).getT(1).setExternalData(b, index); // xfade4_impl::peak1_t<NV>
	}
};
}
