...
using FoldSub = parameter::chain<ranges::Identity, 
                                 parameter::plain<FilterNew6_impl::branch_t<NV>, 0>, 
                                 parameter::plain<FilterNew6_impl::branch6_t<NV>, 0>>;
...
using FoldSmooth = parameter::chain<ranges::Identity, 
                                    parameter::plain<FilterNew6_impl::smoothed_parameter_t<NV>, 1>, 
                                    parameter::plain<FilterNew6_impl::smoothed_parameter6_t<NV>, 1>>;
...
using FoldOffset = parameter::plain<FilterNew6_impl::pma1_t<NV>, 
                                    2>;
using NumSliders = parameter::plain<FilterNew6_impl::pack_resizer1_t, 
                                    0>;
template <int NV>
...
using RangeMod = parameter::plain<FilterNew6_impl::pma1_t<NV>, 
                                  1>;
template <int NV>
using FreqSteps = parameter::plain<FilterNew6_impl::minmax2_t<NV>, 
                                   4>;
template <int NV>
...
template <int NV> struct instance: public FilterNew6_impl::FilterNew6_t_<NV>
{
	...
	instance()
	{
		...
		auto& minmax2 = this->getT(2);                                                     // FilterNew6_impl::minmax2_t<NV>
		auto& pma1 = this->getT(3);                                                        // FilterNew6_impl::pma1_t<NV>
		auto& xfader = this->getT(4);                                                      // FilterNew6_impl::xfader_t<NV>
		auto& softbypass_switch3 = this->getT(5);                                          // FilterNew6_impl::softbypass_switch3_t<NV>
		auto& switcher1 = this->getT(5).getT(0);                                           // FilterNew6_impl::switcher1_t<NV>
		auto& sb_container1 = this->getT(5).getT(1);                                       // FilterNew6_impl::sb_container1_t<NV>
		auto& sb5 = this->getT(5).getT(1).getT(0);                                         // FilterNew6_impl::sb5_t<NV>
		auto& split = this->getT(5).getT(1).getT(0).getT(0);                               // FilterNew6_impl::split_t<NV>
		auto& chain4 = this->getT(5).getT(1).getT(0).getT(0).getT(0);                      // FilterNew6_impl::chain4_t<NV>
		auto& smoothed_parameter = this->getT(5).getT(1).getT(0).getT(0).getT(0).getT(0);  // FilterNew6_impl::smoothed_parameter_t<NV>
		auto& split1 = this->getT(5).getT(1).getT(0).getT(0).getT(0).getT(1);              // FilterNew6_impl::split1_t<NV>
		auto& chain2 = this->getT(5).getT(1).getT(0).getT(0).getT(0).getT(1).getT(0);      // FilterNew6_impl::chain2_t<NV>
		auto& gain1 = this->getT(5).getT(1).getT(0).getT(0).                               // core::gain<NV>
                      getT(0).getT(1).getT(0).getT(0);
		auto& chain62 = this->getT(5).getT(1).getT(0).getT(0).getT(0).getT(1).getT(1);     // FilterNew6_impl::chain62_t<NV>
		auto& branch = this->getT(5).getT(1).getT(0).getT(0).                              // FilterNew6_impl::branch_t<NV>
                       getT(0).getT(1).getT(1).getT(0);
		auto& chain47 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew6_impl::chain47_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(0);
		auto& expr2 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                       // math::expr<NV, custom::expr2>
                      getT(1).getT(1).getT(0).getT(0).getT(0);
		auto& chain61 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew6_impl::chain61_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(1);
		auto& expr = this->getT(5).getT(1).getT(0).getT(0).getT(0).                        // math::expr<NV, custom::expr>
                     getT(1).getT(1).getT(0).getT(1).getT(0);
		auto& chain63 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew6_impl::chain63_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(2);
		auto& expr1 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                       // math::expr<NV, custom::expr1>
                      getT(1).getT(1).getT(0).getT(2).getT(0);
		auto& chain64 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew6_impl::chain64_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(3);
		auto& expr3 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                       // math::expr<NV, custom::expr3>
                      getT(1).getT(1).getT(0).getT(3).getT(0);
		auto& chain65 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew6_impl::chain65_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(4);
		auto& expr4 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                       // math::expr<NV, custom::expr4>
                      getT(1).getT(1).getT(0).getT(4).getT(0);
		auto& chain66 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew6_impl::chain66_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(5);
		auto& expr6 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                       // math::expr<NV, custom::expr6>
                      getT(1).getT(1).getT(0).getT(5).getT(0);
		auto& chain71 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew6_impl::chain71_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(6);
		auto& expr11 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                      // math::expr<NV, custom::expr11>
                       getT(1).getT(1).getT(0).getT(6).getT(0);
		auto& chain70 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew6_impl::chain70_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(7);
		auto& expr10 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                      // math::expr<NV, custom::expr10>
                       getT(1).getT(1).getT(0).getT(7).getT(0);
		auto& chain73 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew6_impl::chain73_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(8);
		auto& expr13 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                      // math::expr<NV, custom::expr13>
                       getT(1).getT(1).getT(0).getT(8).getT(0);
		auto& chain72 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew6_impl::chain72_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(9);
		auto& expr12 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                      // math::expr<NV, custom::expr12>
                       getT(1).getT(1).getT(0).getT(9).getT(0);
		auto& chain69 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew6_impl::chain69_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(10);
		auto& expr9 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                       // math::expr<NV, custom::expr9>
                      getT(1).getT(1).getT(0).getT(10).getT(0);
		auto& chain68 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew6_impl::chain68_t<NV>
                        getT(0).getT(1).getT(1).getT(0).
                        getT(11);
		...
		auto& filter1 = this->getT(5).getT(1).getT(0).getT(0).getT(0).getT(2);             // FilterNew6_impl::filter1_t<NV>
		auto& dry_path = this->getT(5).getT(1).getT(0).getT(0).getT(0).getT(2).getT(0);    // FilterNew6_impl::dry_path_t<NV>
		auto& pma10 = this->getT(5).getT(1).getT(0).getT(0).                               // FilterNew6_impl::pma10_t<NV>
                      getT(0).getT(2).getT(0).getT(0);
		auto& xfader1 = this->getT(5).getT(1).getT(0).getT(0).                             // FilterNew6_impl::xfader1_t<NV>
                        getT(0).getT(2).getT(0).getT(1);
		auto& gain = this->getT(5).getT(1).getT(0).getT(0).                                // core::gain<NV>
                     getT(0).getT(2).getT(0).getT(2);
		auto& wet_path = this->getT(5).getT(1).getT(0).getT(0).getT(0).getT(2).getT(1);    // FilterNew6_impl::wet_path_t<NV>
		auto& softbypass_switch5 = this->getT(5).getT(1).getT(0).getT(0).                  // FilterNew6_impl::softbypass_switch5_t<NV>
                                   getT(0).getT(2).getT(1).getT(0);
		auto& pma12 = this->getT(5).getT(1).getT(0).getT(0).                               // FilterNew6_impl::pma12_t<NV>
                      getT(0).getT(2).getT(1).getT(0).
                      getT(0);
		auto& switcher = this->getT(5).getT(1).getT(0).getT(0).                            // FilterNew6_impl::switcher_t<NV>
                         getT(0).getT(2).getT(1).getT(0).
                         getT(1);
		auto& sb_container = this->getT(5).getT(1).getT(0).getT(0).                        // FilterNew6_impl::sb_container_t<NV>
                             getT(0).getT(2).getT(1).getT(0).
                             getT(2);
		auto& sb1 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                         // FilterNew6_impl::sb1_t<NV>
                    getT(2).getT(1).getT(0).getT(2).getT(0);
		auto& svf = this->getT(5).getT(1).getT(0).getT(0).getT(0).                         // filters::svf<NV>
                    getT(2).getT(1).getT(0).getT(2).getT(0).
                    getT(0);
		auto& sb2 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                         // FilterNew6_impl::sb2_t<NV>
                    getT(2).getT(1).getT(0).getT(2).getT(1);
		auto& svf1 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                        // filters::svf<NV>
                     getT(2).getT(1).getT(0).getT(2).getT(1).
                     getT(0);
		auto& sb3 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                         // FilterNew6_impl::sb3_t<NV>
                    getT(2).getT(1).getT(0).getT(2).getT(2);
		auto& svf2 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                        // filters::svf<NV>
                     getT(2).getT(1).getT(0).getT(2).getT(2).
                     getT(0);
		auto& soft_bypass = this->getT(5).getT(1).getT(0).getT(0).getT(0).                 // FilterNew6_impl::soft_bypass_t<NV>
                            getT(2).getT(1).getT(0).getT(2).getT(3);
		auto& allpass = this->getT(5).getT(1).getT(0).getT(0).getT(0).                     // filters::allpass<NV>
                        getT(2).getT(1).getT(0).getT(2).getT(3).
                        getT(0);
		auto& soft_bypass1 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                // FilterNew6_impl::soft_bypass1_t<NV>
                             getT(2).getT(1).getT(0).getT(2).getT(4);
		auto& ring_mod = this->getT(5).getT(1).getT(0).getT(0).getT(0).                    // filters::ring_mod<NV>
                         getT(2).getT(1).getT(0).getT(2).getT(4).
                         getT(0);
		auto& sb4 = this->getT(5).getT(1).getT(0).getT(0).getT(0).                         // FilterNew6_impl::sb4_t
                    getT(2).getT(1).getT(0).getT(2).getT(5);
		auto& gain17 = this->getT(5).getT(1).getT(0).getT(0).                              // core::gain<NV>
                       getT(0).getT(2).getT(1).getT(1);
		auto& sb6 = this->getT(5).getT(1).getT(1);                                         // FilterNew6_impl::sb6_t<NV>
		auto& split11 = this->getT(5).getT(1).getT(1).getT(0);                             // FilterNew6_impl::split11_t<NV>
		auto& chain54 = this->getT(5).getT(1).getT(1).getT(0).getT(0);                     // FilterNew6_impl::chain54_t<NV>
		auto& filter4 = this->getT(5).getT(1).getT(1).getT(0).getT(0).getT(0);             // FilterNew6_impl::filter4_t<NV>
		auto& dry_path3 = this->getT(5).getT(1).getT(1).getT(0).getT(0).getT(0).getT(0);   // FilterNew6_impl::dry_path3_t<NV>
		auto& pma13 = this->getT(5).getT(1).getT(1).getT(0).                               // FilterNew6_impl::pma13_t<NV>
                      getT(0).getT(0).getT(0).getT(0);
		auto& xfader4 = this->getT(5).getT(1).getT(1).getT(0).                             // FilterNew6_impl::xfader4_t<NV>
                        getT(0).getT(0).getT(0).getT(1);
		auto& gain11 = this->getT(5).getT(1).getT(1).getT(0).                              // core::gain<NV>
                       getT(0).getT(0).getT(0).getT(2);
		auto& wet_path3 = this->getT(5).getT(1).getT(1).getT(0).getT(0).getT(0).getT(1);   // FilterNew6_impl::wet_path3_t<NV>
		auto& softbypass_switch8 = this->getT(5).getT(1).getT(1).getT(0).                  // FilterNew6_impl::softbypass_switch8_t<NV>
                                   getT(0).getT(0).getT(1).getT(0);
		auto& pma14 = this->getT(5).getT(1).getT(1).getT(0).                               // FilterNew6_impl::pma14_t<NV>
                      getT(0).getT(0).getT(1).getT(0).
                      getT(0);
		auto& switcher4 = this->getT(5).getT(1).getT(1).getT(0).                           // FilterNew6_impl::switcher4_t<NV>
                          getT(0).getT(0).getT(1).getT(0).
                          getT(1);
		auto& sb_container4 = this->getT(5).getT(1).getT(1).getT(0).                       // FilterNew6_impl::sb_container4_t<NV>
                              getT(0).getT(0).getT(1).getT(0).
                              getT(2);
		auto& sb15 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                        // FilterNew6_impl::sb15_t<NV>
                     getT(0).getT(1).getT(0).getT(2).getT(0);
		auto& svf9 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                        // filters::svf<NV>
                     getT(0).getT(1).getT(0).getT(2).getT(0).
                     getT(0);
		auto& sb16 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                        // FilterNew6_impl::sb16_t<NV>
                     getT(0).getT(1).getT(0).getT(2).getT(1);
		auto& svf10 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                       // filters::svf<NV>
                      getT(0).getT(1).getT(0).getT(2).getT(1).
                      getT(0);
		auto& sb17 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                        // FilterNew6_impl::sb17_t<NV>
                     getT(0).getT(1).getT(0).getT(2).getT(2);
		auto& svf11 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                       // filters::svf<NV>
                      getT(0).getT(1).getT(0).getT(2).getT(2).
                      getT(0);
		auto& soft_bypass6 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                // FilterNew6_impl::soft_bypass6_t<NV>
                             getT(0).getT(1).getT(0).getT(2).getT(3);
		auto& allpass3 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                    // filters::allpass<NV>
                         getT(0).getT(1).getT(0).getT(2).getT(3).
                         getT(0);
		auto& soft_bypass7 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                // FilterNew6_impl::soft_bypass7_t<NV>
                             getT(0).getT(1).getT(0).getT(2).getT(4);
		auto& ring_mod3 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                   // filters::ring_mod<NV>
                          getT(0).getT(1).getT(0).getT(2).getT(4).
                          getT(0);
		auto& sb18 = this->getT(5).getT(1).getT(1).getT(0).getT(0).                        // FilterNew6_impl::sb18_t
                     getT(0).getT(1).getT(0).getT(2).getT(5);
		auto& gain20 = this->getT(5).getT(1).getT(1).getT(0).                              // core::gain<NV>
                       getT(0).getT(0).getT(1).getT(1);
		auto& smoothed_parameter6 = this->getT(5).getT(1).getT(1).getT(0).getT(0).getT(1); // FilterNew6_impl::smoothed_parameter6_t<NV>
		auto& split12 = this->getT(5).getT(1).getT(1).getT(0).getT(0).getT(2);             // FilterNew6_impl::split12_t<NV>
		auto& chain55 = this->getT(5).getT(1).getT(1).getT(0).getT(0).getT(2).getT(0);     // FilterNew6_impl::chain55_t<NV>
		auto& gain9 = this->getT(5).getT(1).getT(1).getT(0).                               // core::gain<NV>
                      getT(0).getT(2).getT(0).getT(0);
		auto& chain56 = this->getT(5).getT(1).getT(1).getT(0).getT(0).getT(2).getT(1); // FilterNew6_impl::chain56_t<NV>
		auto& branch6 = this->getT(5).getT(1).getT(1).getT(0).                         // FilterNew6_impl::branch6_t<NV>
                        getT(0).getT(2).getT(1).getT(0);
		auto& chain75 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew6_impl::chain75_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(0);
		auto& expr14 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr14>
                       getT(2).getT(1).getT(0).getT(0).getT(0);
		auto& chain76 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew6_impl::chain76_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(1);
		auto& expr15 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr15>
                       getT(2).getT(1).getT(0).getT(1).getT(0);
		auto& chain77 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew6_impl::chain77_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(2);
		auto& expr16 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr16>
                       getT(2).getT(1).getT(0).getT(2).getT(0);
		auto& chain78 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew6_impl::chain78_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(3);
		auto& expr17 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr17>
                       getT(2).getT(1).getT(0).getT(3).getT(0);
		auto& chain87 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew6_impl::chain87_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(4);
		auto& expr26 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr26>
                       getT(2).getT(1).getT(0).getT(4).getT(0);
		auto& chain80 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew6_impl::chain80_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(5);
		auto& expr19 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr19>
                       getT(2).getT(1).getT(0).getT(5).getT(0);
		auto& chain81 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew6_impl::chain81_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(6);
		auto& expr20 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr20>
                       getT(2).getT(1).getT(0).getT(6).getT(0);
		auto& chain82 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew6_impl::chain82_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(7);
		auto& expr21 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr21>
                       getT(2).getT(1).getT(0).getT(7).getT(0);
		auto& chain83 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew6_impl::chain83_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(8);
		auto& expr22 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr22>
                       getT(2).getT(1).getT(0).getT(8).getT(0);
		auto& chain84 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew6_impl::chain84_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(9);
		auto& expr23 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr23>
                       getT(2).getT(1).getT(0).getT(9).getT(0);
		auto& chain85 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew6_impl::chain85_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(10);
		auto& expr24 = this->getT(5).getT(1).getT(1).getT(0).getT(0).  // math::expr<NV, custom::expr24>
                       getT(2).getT(1).getT(0).getT(10).getT(0);
		auto& chain86 = this->getT(5).getT(1).getT(1).getT(0).         // FilterNew6_impl::chain86_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(11);
