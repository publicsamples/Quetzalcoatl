...
template <int NV>
using _3rdParam_2 = parameter::from0To1<FilterNew_impl::event_data_reader6_t<NV>, 
                                        0, 
                                        _3rdParam_2Range>;
...
using FoldRes = parameter::from0To1<project::FoldTests<NV>, 
                                    2, 
                                    FilterNew_impl::pma9_mod_1Range>;

template <int NV>
using MainParam = parameter::plain<FilterNew_impl::pma7_t<NV>, 
                                   2>;
template <int NV>
using _2ndParam = parameter::plain<FilterNew_impl::pma9_t<NV>, 
                                   2>;
template <int NV>
...
using StageMod = parameter::plain<FilterNew_impl::pma8_t<NV>, 
                                  1>;
template <int NV>
using Stage1 = parameter::plain<FilterNew_impl::pma10_t<NV>, 
                                2>;
template <int NV>
using Stage2 = parameter::plain<FilterNew_impl::pma10_t<NV>, 
                                1>;
template <int NV>
...
template <int NV> struct instance: public FilterNew_impl::FilterNew_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ENCODED_PARAMETERS(330)
		{
			0x005B, 0x0000, 0x4D00, 0x6961, 0x506E, 0x7261, 0x6D61, 0x0000, 
            0x8000, 0x0024, 0x8000, 0x313F, 0x2408, 0x003E, 0x8000, 0x003F, 
            0x0000, 0x5B00, 0x0001, 0x0000, 0x325F, 0x646E, 0x6150, 0x6172, 
            0x006D, 0x0000, 0x2480, 0x0000, 0x3F80, 0xE148, 0x3F05, 0x0000, 
            0x3F80, 0x0000, 0x0000, 0x025B, 0x0000, 0x5F00, 0x7233, 0x5064, 
            0x7261, 0x6D61, 0x0000, 0x0000, 0x0000, 0x8000, 0x3341, 0x2333, 
            0x0041, 0x8000, 0xCD3F, 0xCCCC, 0x5B3D, 0x0003, 0x0000, 0x345F, 
            0x6874, 0x6150, 0x6172, 0x006D, 0x0000, 0xBF80, 0x0000, 0x3F80, 
            0xA7F0, 0x3D96, 0x0000, 0x3F80, 0x0000, 0x0000, 0x045B, 0x0000, 
            ...
            0x0000, 0x0000, 0x4180, 0x0000, 0x4110, 0x0000, 0x3F80, 0xCCCD, 
            ...
            0x0064, 0x0000, 0xBF80, 0x0000, 0x3F80, 0x5CBC, 0x3F26, 0x0000, 
            ...
            0x6F46, 0x646C, 0x664F, 0x7366, 0x7465, 0x0000, 0x0000, 0x0000, 
            0x8000, 0xF93F, 0x1116, 0x003F, 0x8000, 0x003F, 0x0000, 0x5B00, 
            0x0011, 0x0000, 0x6F46, 0x646C, 0x6552, 0x0073, 0x0000, 0x0000, 
            0x0000, 0x3F80, 0x7FE3, 0x3EFE, 0x0000, 0x3F80, 0x0000, 0x0000, 
            0x125B, 0x0000, 0x5300, 0x6174, 0x6567, 0x0036, 0x0000, 0x0000, 
            0x0000, 0x3F80, 0x0E71, 0x3F0A, 0x0000, 0x3F80, 0x0000, 0x0000, 
            0x135B, 0x0000, 0x5500, 0x736E, 0x7375, 0x6465, 0x0032, 0x0000, 
            0x0000, 0x0000, 0x4300, 0x0000, 0x4100, 0x0000, 0x3F80, 0x0000, 
            0x3F80, 0x0000
		};
	};
	...
	instance()
	{
		...
		auto& branch1 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(0);              // FilterNew_impl::branch1_t<NV>
		auto& chain = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(0).getT(0);        // FilterNew_impl::chain_t<NV>
		...
		auto& add = this->getT(0).getT(0).getT(3).getT(0).                                  // math::add<NV>
                    getT(1).getT(0).getT(0).getT(1);
		auto& chain1 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(0).getT(1);       // FilterNew_impl::chain1_t<NV>
		...
		auto& add1 = this->getT(0).getT(0).getT(3).getT(0).                                 // math::add<NV>
                     getT(1).getT(0).getT(1).getT(1);
		auto& chain12 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(0).getT(2);      // FilterNew_impl::chain12_t<NV>
		...
		auto& add2 = this->getT(0).getT(0).getT(3).getT(0).                                 // math::add<NV>
                     getT(1).getT(0).getT(2).getT(1);
		auto& chain13 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(0).getT(3);      // FilterNew_impl::chain13_t<NV>
		...
		auto& add3 = this->getT(0).getT(0).getT(3).getT(0).                                 // math::add<NV>
                     getT(1).getT(0).getT(3).getT(1);
		auto& chain15 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(0).getT(4);      // FilterNew_impl::chain15_t<NV>
		...
		auto& add4 = this->getT(0).getT(0).getT(3).getT(0).                                 // math::add<NV>
                     getT(1).getT(0).getT(4).getT(1);
		auto& chain16 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(0).getT(5);      // FilterNew_impl::chain16_t<NV>
		...
		auto& add5 = this->getT(0).getT(0).getT(3).getT(0).                                 // math::add<NV>
                     getT(1).getT(0).getT(5).getT(1);
		auto& chain17 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(0).getT(6);      // FilterNew_impl::chain17_t<NV>
		...
		auto& add6 = this->getT(0).getT(0).getT(3).getT(0).                                 // math::add<NV>
                     getT(1).getT(0).getT(6).getT(1);
		auto& chain18 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(0).getT(7);      // FilterNew_impl::chain18_t<NV>
		...
		auto& add7 = this->getT(0).getT(0).getT(3).getT(0).                                 // math::add<NV>
                     getT(1).getT(0).getT(7).getT(1);
		auto& peak = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(1);                 // FilterNew_impl::peak_t<NV>
		auto& clear1 = this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(2);               // math::clear<NV>
		auto& pma8 = this->getT(0).getT(0).getT(3).getT(1);                                 // FilterNew_impl::pma8_t<NV>
		auto& cable_table9 = this->getT(0).getT(0).getT(3).getT(2);                         // FilterNew_impl::cable_table9_t<NV>
		auto& cable_table10 = this->getT(0).getT(0).getT(3).getT(3);                        // FilterNew_impl::cable_table10_t<NV>
		auto& input_toggle = this->getT(0).getT(0).getT(3).getT(4);                         // FilterNew_impl::input_toggle_t<NV>
		auto& split = this->getT(1);                                                        // FilterNew_impl::split_t<NV>
		auto& chain4 = this->getT(1).getT(0);                                               // FilterNew_impl::chain4_t<NV>
		auto& filter1 = this->getT(1).getT(0).getT(0);                                      // FilterNew_impl::filter1_t<NV>
		auto& dry_path = this->getT(1).getT(0).getT(0).getT(0);                             // FilterNew_impl::dry_path_t<NV>
		auto& pma10 = this->getT(1).getT(0).getT(0).getT(0).getT(0);                        // FilterNew_impl::pma10_t<NV>
		auto& xfader1 = this->getT(1).getT(0).getT(0).getT(0).getT(1);                      // FilterNew_impl::xfader1_t<NV>
		auto& gain = this->getT(1).getT(0).getT(0).getT(0).getT(2);                         // core::gain<NV>
		auto& wet_path = this->getT(1).getT(0).getT(0).getT(1);                             // FilterNew_impl::wet_path_t<NV>
		auto& pma9 = this->getT(1).getT(0).getT(0).getT(1).getT(0);                         // FilterNew_impl::pma9_t<NV>
		auto& softbypass_switch5 = this->getT(1).getT(0).getT(0).getT(1).getT(1);           // FilterNew_impl::softbypass_switch5_t<NV>
		auto& switcher = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(0);             // FilterNew_impl::switcher_t<NV>
		auto& sb_container = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(1);         // FilterNew_impl::sb_container_t<NV>
		auto& sb1 = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(1).getT(0);          // FilterNew_impl::sb1_t<NV>
		auto& svf = this->getT(1).getT(0).getT(0).getT(1).                                  // filters::svf<NV>
                    getT(1).getT(1).getT(0).getT(0);
		auto& sb2 = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(1).getT(1);          // FilterNew_impl::sb2_t<NV>
		auto& svf1 = this->getT(1).getT(0).getT(0).getT(1).                                 // filters::svf<NV>
                     getT(1).getT(1).getT(1).getT(0);
		auto& sb3 = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(1).getT(2);          // FilterNew_impl::sb3_t<NV>
		auto& svf2 = this->getT(1).getT(0).getT(0).getT(1).                                 // filters::svf<NV>
                     getT(1).getT(1).getT(2).getT(0);
		auto& soft_bypass = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(1).getT(3);  // FilterNew_impl::soft_bypass_t<NV>
		auto& allpass = this->getT(1).getT(0).getT(0).getT(1).                              // filters::allpass<NV>
                        getT(1).getT(1).getT(3).getT(0);
		auto& soft_bypass1 = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(1).getT(4); // FilterNew_impl::soft_bypass1_t<NV>
		auto& ring_mod = this->getT(1).getT(0).getT(0).getT(1).                             // filters::ring_mod<NV>
                         getT(1).getT(1).getT(4).getT(0);
		auto& sb4 = this->getT(1).getT(0).getT(0).getT(1).getT(1).getT(1).getT(5); // FilterNew_impl::sb4_t<NV>
		...
		this->getParameterT(13).connectT(0, pma10); // Stage1 -> pma10::Add
		
		this->getParameterT(14).connectT(0, pma10); // Stage2 -> pma10::Multiply
		...
		this->getParameterT(16).connectT(0, FoldTests); // FoldOffset -> FoldTests::Offset
		
		this->getParameterT(17).connectT(0, FoldTests); // FoldRes -> FoldTests::Res
		
		this->getParameterT(18).connectT(0, FoldTests); // Stage6 -> FoldTests::sub
		
		this->getParameterT(19).connectT(0, pack_resizer1); // Unsused2 -> pack_resizer1::NumSliders
		...
		this->setParameterT(0, 0.160188);
		this->setParameterT(1, 0.522969);
		this->setParameterT(2, 10.2);
		this->setParameterT(3, 0.0735625);
		this->setParameterT(4, 8.);
		this->setParameterT(5, 1.);
		this->setParameterT(6, 9.);
		this->setParameterT(7, 0.);
		this->setParameterT(8, 0.);
		this->setParameterT(9, 0.);
		this->setParameterT(10, 0.);
		this->setParameterT(11, 0.649853);
		this->setParameterT(12, 9.2);
		this->setParameterT(13, 0.549376);
		this->setParameterT(14, 0.);
		this->setParameterT(15, 1.);
		this->setParameterT(16, 0.566757);
		this->setParameterT(17, 0.497069);
		this->setParameterT(18, 0.539283);
		this->setParameterT(19, 8.);
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(0).getT(0).getT(3).getT(0).getT(1).getT(1).setExternalData(b, index); // FilterNew_impl::peak_t<NV>
		this->getT(0).getT(0).getT(3).getT(2).setExternalData(b, index);                 // FilterNew_impl::cable_table9_t<NV>
		this->getT(0).getT(0).getT(3).getT(3).setExternalData(b, index);                 // FilterNew_impl::cable_table10_t<NV>
	}
};
}
