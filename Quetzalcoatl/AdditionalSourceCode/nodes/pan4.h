...
using global_cable_t_index = runtime_target::indexers::fix_hash<3433271>;
...
template <int NV>
using pan4_t_ = container::chain<parameter::empty, 
                                 wrap::fix<2, chain_t<NV>>, 
                                 core::gain<NV>>;

// =================================| Root node initialiser class |=================================

template <int NV> struct instance: public pan4_impl::pan4_t_<NV>
{
	...
	instance()
	{
		...
		auto& chain = this->getT(0);                // pan4_impl::chain_t<NV>
		auto& global_cable = this->getT(0).getT(0); // pan4_impl::global_cable_t<NV>
	...
	void connectToRuntimeTarget(bool addConnection, const runtime_target::connection& c)
	{
		...
		this->getT(0).getT(0).connectToRuntimeTarget(addConnection, c); // pan4_impl::global_cable_t<NV>
	}
};
}
...
template <int NV>
using pan4 = wrap::node<pan4_impl::instance<NV>>;
}
