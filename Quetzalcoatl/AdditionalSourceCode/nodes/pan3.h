...
using global_cable_t_index = runtime_target::indexers::fix_hash<3433270>;
...
template <int NV>
using pan3_t_ = container::chain<parameter::empty, 
                                 wrap::fix<2, chain_t<NV>>, 
                                 core::gain<NV>>;

// =================================| Root node initialiser class |=================================

template <int NV> struct instance: public pan3_impl::pan3_t_<NV>
{
	...
	instance()
	{
		...
		auto& chain = this->getT(0);                // pan3_impl::chain_t<NV>
		auto& global_cable = this->getT(0).getT(0); // pan3_impl::global_cable_t<NV>
	...
	void connectToRuntimeTarget(bool addConnection, const runtime_target::connection& c)
	{
		...
		this->getT(0).getT(0).connectToRuntimeTarget(addConnection, c); // pan3_impl::global_cable_t<NV>
	}
};
}
...
template <int NV>
using pan3 = wrap::node<pan3_impl::instance<NV>>;
}
