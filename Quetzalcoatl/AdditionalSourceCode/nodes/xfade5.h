...
using Global = parameter::plain<xfade5_impl::pma7_t<NV>, 
                                1>;
template <int NV>
using GlobalSrc = parameter::plain<xfade5_impl::event_data_reader7_t<NV>, 
                                   0>;
template <int NV>
...
using AT = parameter::plain<xfade5_impl::pma6_t<NV>, 
                            1>;
template <int NV>
using MonoSrc = parameter::plain<xfade5_impl::branch3_t<NV>, 
                                 0>;
template <int NV>
...
template <int NV> struct instance: public xfade5_impl::xfade5_t_<NV>
{
	...
	instance()
	{
		...
		auto& chain29 = this->getT(0).getT(0).getT(1).getT(4).getT(0).getT(0).getT(1);            // xfade5_impl::chain29_t<NV>
