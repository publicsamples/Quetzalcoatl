...
DECLARE_PARAMETER_RANGE(xfader_x1_c5Range, 
                        5.55112e-17, 
                        1.);

template <int NV>
using xfader_x1_c5 = parameter::from0To1<pma8_t<NV>, 
                                         2, 
                                         xfader_x1_c5Range>;
...
template <int NV>
using xfader2_x1_c5 = parameter::from0To1<pma10_t<NV>, 
                                          2, 
                                          xfader_x1_c5Range>;
...
template <int NV>
using xfader1_x1_c5 = parameter::from0To1<pma12_t<NV>, 
                                          2, 
                                          xfader_x1_c5Range>;
...
template <int NV>
using xfader3_x1_c5 = parameter::from0To1<pma17_t<NV>, 
                                          2, 
                                          xfader_x1_c5Range>;
...
template <int NV>
using xfader4_x1_c5 = parameter::from0To1<pma14_t<NV>, 
                                          2, 
                                          xfader_x1_c5Range>;
...
struct cable_table11_t_data
{
	span<float, 512> data =
	{
		...
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
		0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
		0.f, 0.f, 0.00264663f, 0.0074178f, 0.012189f, 0.0169602f,
		0.0217314f, 0.0265026f, 0.0312738f, 0.036045f, 0.0408164f, 0.0455876f,
		0.0503588f, 0.05513f, 0.0599012f, 0.0646724f, 0.0694436f, 0.0742148f,
		0.0789862f, 0.0837574f, 0.0885286f, 0.0932998f, 0.098071f, 0.102842f,
		0.107613f, 0.112385f, 0.117156f, 0.121927f, 0.126698f, 0.13147f,
		0.136241f, 0.141012f, 0.145783f, 0.150554f, 0.155326f, 0.160097f,
		0.164868f, 0.169639f, 0.174411f, 0.179182f, 0.183953f, 0.188724f,
		0.193496f, 0.198267f, 0.203038f, 0.207809f, 0.21258f, 0.217352f,
		0.222123f, 0.226894f, 0.231665f, 0.236437f, 0.241208f, 0.245979f,
		0.25075f, 0.255521f, 0.260293f, 0.265064f, 0.269835f, 0.274606f,
		0.279378f, 0.284149f, 0.28892f, 0.293691f, 0.298462f, 0.303234f,
		0.308005f, 0.312776f, 0.317547f, 0.322319f, 0.32709f, 0.331861f,
		0.336632f, 0.341403f, 0.346175f, 0.350946f, 0.355717f, 0.360488f,
		0.36526f, 0.370031f, 0.374802f, 0.379573f, 0.384344f, 0.389116f,
		0.393887f, 0.398658f, 0.403429f, 0.408201f, 0.412972f, 0.417743f,
		0.422514f, 0.427285f, 0.432057f, 0.436828f, 0.441599f, 0.44637f,
		0.451141f, 0.455913f, 0.460684f, 0.465455f, 0.470226f, 0.474998f,
		0.479769f, 0.48454f, 0.489311f, 0.494083f, 0.498854f, 0.503625f,
		0.508396f, 0.513167f, 0.517939f, 0.52271f, 0.527481f, 0.532252f,
		0.537024f, 0.541795f, 0.546566f, 0.551337f, 0.556108f, 0.56088f,
		0.565651f, 0.570422f, 0.575193f, 0.579965f, 0.584736f, 0.589507f,
		0.594278f, 0.599049f, 0.603821f, 0.608592f, 0.613363f, 0.618134f,
		0.622906f, 0.627677f, 0.632448f, 0.637219f, 0.64199f, 0.646762f,
		0.651533f, 0.656304f, 0.661075f, 0.665847f, 0.670618f, 0.675389f,
		0.68016f, 0.684931f, 0.689703f, 0.694474f, 0.699245f, 0.704016f,
		0.708788f, 0.713559f, 0.71833f, 0.723101f, 0.727873f, 0.732644f,
		0.737415f, 0.742186f, 0.746957f, 0.751729f, 0.7565f, 0.761271f,
		0.766042f, 0.770814f, 0.775585f, 0.780356f, 0.785127f, 0.789898f,
		0.79467f, 0.799441f, 0.804212f, 0.808983f, 0.813755f, 0.818526f,
		0.823297f, 0.828068f, 0.832839f, 0.837611f, 0.842382f, 0.847153f,
		0.851924f, 0.856696f, 0.861467f, 0.866238f, 0.871009f, 0.87578f,
		0.880552f, 0.885323f, 0.890094f, 0.894865f, 0.899637f, 0.904408f,
		0.909179f, 0.91395f, 0.918721f, 0.923493f, 0.928264f, 0.933035f,
		0.937806f, 0.942578f, 0.947349f, 0.95212f, 0.956891f, 0.961662f,
		0.966434f, 0.971205f, 0.975976f, 0.980747f, 0.985519f, 0.99029f,
		0.995061f, 0.999832f, 1.f, 1.f, 1.f, 1.f,
...
{
// Parameter list for xfade6_impl::XF1_t -----------------------------------------------------------
...
template <int NV>
using smooth_x1_0 = parameter::from0To1<xfade6_impl::smoothed_parameter2_x1_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;

template <int NV>
using smooth_x1_1 = parameter::from0To1<xfade6_impl::smoothed_parameter4_x1_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;

template <int NV>
using smooth_x1_2 = parameter::from0To1<xfade6_impl::smoothed_parameter3_x1_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;

template <int NV>
using smooth_x1_3 = parameter::from0To1<xfade6_impl::smoothed_parameter3_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;

template <int NV>
using smooth_x1_4 = parameter::from0To1<xfade6_impl::smoothed_parameter4_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;

template <int NV>
using smooth_x1_5 = parameter::from0To1<xfade6_impl::smoothed_parameter2_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;

template <int NV>
using smooth_x1_6 = parameter::from0To1<xfade6_impl::smoothed_parameter1_x4_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;

template <int NV>
using smooth_x1_7 = parameter::from0To1<xfade6_impl::smoothed_parameter17_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;

template <int NV>
using smooth_x1_8 = parameter::from0To1<xfade6_impl::smoothed_parameter1_x1_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;

template <int NV>
using smooth_x1_9 = parameter::from0To1<xfade6_impl::smoothed_parameter1_t<NV>, 
                                        1, 
                                        smooth_x1_0Range>;
...
using SmoothType = parameter::chain<ranges::Identity, 
                                    parameter::plain<xfade6_impl::input_toggle2_t<NV>, 0>, 
                                    parameter::plain<xfade6_impl::input_toggle4_t<NV>, 0>, 
                                    parameter::plain<xfade6_impl::input_toggle5_t<NV>, 0>, 
                                    parameter::plain<xfade6_impl::input_toggle3_t<NV>, 0>, 
                                    parameter::plain<xfade6_impl::input_toggle16_t<NV>, 0>>;
...
namespace xfade6_t_parameters
{
// Parameter list for xfade6_impl::xfade6_t --------------------------------------------------------

DECLARE_PARAMETER_RANGE(MainParam_InputRange, 
                        1., 
                        8.);
template <int NV>
using MainParam_0 = parameter::from0To1<xfade6_impl::pma7_t<NV>, 
                                        2, 
                                        xfade6_impl::xfader_x1_c5Range>;
...
using _3rdParam = parameter::chain<_3rdParam_InputRange, 
                                   parameter::plain<xfade6_impl::switcher_x1_t<NV>, 0>>;
...
using _5thParam = parameter::chain<_5thParam_InputRange, 
                                   parameter::plain<xfade6_impl::switcher1_t<NV>, 0>>;
...
template <int NV>
using GlobalSrc_0 = parameter::from0To1<xfade6_impl::event_data_reader7_t<NV>, 
                                        0, 
                                        GlobalSrc_0Range>;
...
using GlobalSrc = parameter::chain<GlobalSrc_InputRange, 
                                   GlobalSrc_0<NV>, 
                                   parameter::plain<xfade6_impl::cable_table12_t<NV>, 0>, 
                                   parameter::plain<xfade6_impl::cable_table11_t<NV>, 0>>;

template <int NV>
using _2ndParam = parameter::plain<xfade6_impl::XF1_t<NV>, 0>;
template <int NV>
using _4thParam = parameter::plain<xfade6_impl::XF1_t<NV>, 2>;
using Env1 = parameter::empty;
using Env2 = Env1;
template <int NV>
using Poly = parameter::plain<xfade6_impl::pma_t<NV>, 1>;
template <int NV>
using Global = parameter::plain<xfade6_impl::pma7_t<NV>, 
                                1>;
template <int NV>
using Vel = parameter::plain<xfade6_impl::pma3_t<NV>, 
                             1>;
template <int NV>
using Trk = parameter::plain<xfade6_impl::pma4_t<NV>, 
                             1>;
template <int NV>
using MW = parameter::plain<xfade6_impl::pma5_t<NV>, 
                            1>;
template <int NV>
using AT = parameter::plain<xfade6_impl::pma6_t<NV>, 
                            1>;
template <int NV>
using xfade6_t_plist = parameter::list<MainParam<NV>, 
                                       _2ndParam<NV>, 
                                       _3rdParam<NV>, 
                                       _4thParam<NV>, 
                                       _5thParam<NV>, 
...
template <int NV>
using xfade6_t_ = container::chain<xfade6_t_parameters::xfade6_t_plist<NV>, 
                                   wrap::fix<2, modchain_t<NV>>, 
                                   XF1_t<NV>>;

// =================================| Root node initialiser class |=================================

template <int NV> struct instance: public xfade6_impl::xfade6_t_<NV>
{
	...
	instance()
	{
		...
		auto& modchain = this->getT(0);                                                           // xfade6_impl::modchain_t<NV>
		auto& split19 = this->getT(0).getT(0);                                                    // xfade6_impl::split19_t<NV>
		auto& pma = this->getT(0).getT(0).getT(0);                                                // xfade6_impl::pma_t<NV>
		auto& split7 = this->getT(0).getT(0).getT(1);                                             // xfade6_impl::split7_t<NV>
		auto& chain5 = this->getT(0).getT(0).getT(1).getT(0);                                     // xfade6_impl::chain5_t<NV>
		auto& midi = this->getT(0).getT(0).getT(1).getT(0).getT(0);                               // xfade6_impl::midi_t<NV>
		auto& pma3 = this->getT(0).getT(0).getT(1).getT(0).getT(1);                               // xfade6_impl::pma3_t<NV>
		auto& chain6 = this->getT(0).getT(0).getT(1).getT(1);                                     // xfade6_impl::chain6_t<NV>
		auto& midi1 = this->getT(0).getT(0).getT(1).getT(1).getT(0);                              // xfade6_impl::midi1_t<NV>
		auto& pma4 = this->getT(0).getT(0).getT(1).getT(1).getT(1);                               // xfade6_impl::pma4_t<NV>
		auto& chain9 = this->getT(0).getT(0).getT(1).getT(2);                                     // xfade6_impl::chain9_t<NV>
		auto& midi_cc = this->getT(0).getT(0).getT(1).getT(2).getT(0);                            // xfade6_impl::midi_cc_t<NV>
		auto& pma5 = this->getT(0).getT(0).getT(1).getT(2).getT(1);                               // xfade6_impl::pma5_t<NV>
		auto& chain14 = this->getT(0).getT(0).getT(1).getT(3);                                    // xfade6_impl::chain14_t<NV>
		auto& midi_cc1 = this->getT(0).getT(0).getT(1).getT(3).getT(0);                           // xfade6_impl::midi_cc1_t<NV>
		auto& pma6 = this->getT(0).getT(0).getT(1).getT(3).getT(1);                               // xfade6_impl::pma6_t<NV>
		auto& chain25 = this->getT(0).getT(0).getT(1).getT(4);                                    // xfade6_impl::chain25_t<NV>
		auto& chain10 = this->getT(0).getT(0).getT(1).getT(4).getT(0);                            // xfade6_impl::chain10_t<NV>
		auto& cable_table11 = this->getT(0).getT(0).getT(1).getT(4).getT(0).getT(0);              // xfade6_impl::cable_table11_t<NV>
		auto& cable_table12 = this->getT(0).getT(0).getT(1).getT(4).getT(0).getT(1);              // xfade6_impl::cable_table12_t<NV>
		auto& split21 = this->getT(0).getT(0).getT(1).getT(4).getT(0).getT(2);                    // xfade6_impl::split21_t<NV>
		auto& event_data_reader7 = this->getT(0).getT(0).getT(1).getT(4).getT(0).getT(2).getT(0); // xfade6_impl::event_data_reader7_t<NV>
		auto& chain29 = this->getT(0).getT(0).getT(1).getT(4).getT(0).getT(2).getT(1);            // xfade6_impl::chain29_t<NV>
		auto& branch3 = this->getT(0).getT(0).getT(1).getT(4).                                    // xfade6_impl::branch3_t<NV>
                        getT(0).getT(2).getT(1).getT(0);
		auto& chain30 = this->getT(0).getT(0).getT(1).getT(4).                                 // xfade6_impl::chain30_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(0);
		auto& global_cable16 = this->getT(0).getT(0).getT(1).getT(4).getT(0).                  // xfade6_impl::global_cable16_t<NV>
		...
		auto& chain31 = this->getT(0).getT(0).getT(1).getT(4).                                 // xfade6_impl::chain31_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(1);
		auto& global_cable17 = this->getT(0).getT(0).getT(1).getT(4).getT(0).                  // xfade6_impl::global_cable17_t<NV>
		...
		auto& chain32 = this->getT(0).getT(0).getT(1).getT(4).                                 // xfade6_impl::chain32_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(2);
		auto& global_cable18 = this->getT(0).getT(0).getT(1).getT(4).getT(0).                  // xfade6_impl::global_cable18_t<NV>
		...
		auto& chain33 = this->getT(0).getT(0).getT(1).getT(4).                                 // xfade6_impl::chain33_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(3);
		auto& global_cable19 = this->getT(0).getT(0).getT(1).getT(4).getT(0).                  // xfade6_impl::global_cable19_t<NV>
		...
		auto& chain34 = this->getT(0).getT(0).getT(1).getT(4).                                 // xfade6_impl::chain34_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(4);
		auto& global_cable20 = this->getT(0).getT(0).getT(1).getT(4).getT(0).                  // xfade6_impl::global_cable20_t<NV>
		...
		auto& chain35 = this->getT(0).getT(0).getT(1).getT(4).                                 // xfade6_impl::chain35_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(5);
		auto& global_cable21 = this->getT(0).getT(0).getT(1).getT(4).getT(0).                  // xfade6_impl::global_cable21_t<NV>
		...
		auto& chain36 = this->getT(0).getT(0).getT(1).getT(4).                                 // xfade6_impl::chain36_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(6);
		auto& global_cable22 = this->getT(0).getT(0).getT(1).getT(4).getT(0).                  // xfade6_impl::global_cable22_t<NV>
		...
		auto& chain37 = this->getT(0).getT(0).getT(1).getT(4).                                 // xfade6_impl::chain37_t<NV>
                        getT(0).getT(2).getT(1).getT(0).
                        getT(7);
		auto& global_cable23 = this->getT(0).getT(0).getT(1).getT(4).getT(0).                  // xfade6_impl::global_cable23_t<NV>
		...
		auto& peak2 = this->getT(0).getT(0).getT(1).getT(4).                                   // xfade6_impl::peak2_t<NV>
                      getT(0).getT(2).getT(1).getT(1);
		auto& clear = this->getT(0).getT(0).getT(1).getT(4).                                   // math::clear<NV>
                      getT(0).getT(2).getT(1).getT(2);
		auto& input_toggle1x = this->getT(0).getT(0).getT(1).getT(4).getT(0).getT(3);          // xfade6_impl::input_toggle1x_t<NV>
		auto& pma7 = this->getT(0).getT(0).getT(1).getT(4).getT(1);                            // xfade6_impl::pma7_t<NV>
		auto& XF1 = this->getT(1);                                                             // xfade6_impl::XF1_t<NV>
		auto& fix8_block = this->getT(1).getT(0);                                              // xfade6_impl::fix8_block_t<NV>
		auto& softbypass_switch4 = this->getT(1).getT(0).getT(0);                              // xfade6_impl::softbypass_switch4_t<NV>
		auto& switcher1 = this->getT(1).getT(0).getT(0).getT(0);                               // xfade6_impl::switcher1_t<NV>
		auto& sb_container1 = this->getT(1).getT(0).getT(0).getT(1);                           // xfade6_impl::sb_container1_t<NV>
		auto& sb3 = this->getT(1).getT(0).getT(0).getT(1).getT(0);                             // xfade6_impl::sb3_t<NV>
		auto& x1 = this->getT(1).getT(0).getT(0).getT(1).getT(0).getT(0);                      // xfade6_impl::x1_t<NV>
		auto& switcher_x1 = this->getT(1).getT(0).getT(0).getT(1).getT(0).getT(0).getT(0);     // xfade6_impl::switcher_x1_t<NV>
		auto& sb_container_x1 = this->getT(1).getT(0).getT(0).getT(1).getT(0).getT(0).getT(1); // xfade6_impl::sb_container_x1_t<NV>
		auto& sb1_x1 = this->getT(1).getT(0).getT(0).getT(1).                                  // xfade6_impl::sb1_x1_t<NV>
                       getT(0).getT(0).getT(1).getT(0);
		auto& chain1_x1 = this->getT(1).getT(0).getT(0).getT(1).                               // xfade6_impl::chain1_x1_t<NV>
                          getT(0).getT(0).getT(1).getT(0).
                          getT(0);
		auto& xfader_x1 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                       // xfade6_impl::xfader_x1_t<NV>
                          getT(0).getT(1).getT(0).getT(0).getT(0);
		auto& pma8 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                            // xfade6_impl::pma8_t<NV>
                     getT(0).getT(1).getT(0).getT(0).getT(1);
		auto& chain26 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                         // xfade6_impl::chain26_t<NV>
                        getT(0).getT(1).getT(0).getT(0).getT(2);
		auto& split20 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                         // xfade6_impl::split20_t<NV>
                        getT(0).getT(1).getT(0).getT(0).getT(2).
                        getT(0);
		auto& smoothed_parameter1_x4 = this->getT(1).getT(0).getT(0).getT(1).getT(0).getT(0).  // xfade6_impl::smoothed_parameter1_x4_t<NV>
                                       getT(1).getT(0).getT(0).getT(2).getT(0).getT(0);
		auto& smoothed_parameter17 = this->getT(1).getT(0).getT(0).getT(1).getT(0).getT(0).    // xfade6_impl::smoothed_parameter17_t<NV>
                                     getT(1).getT(0).getT(0).getT(2).getT(0).getT(1);
		auto& input_toggle16 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                  // xfade6_impl::input_toggle16_t<NV>
                               getT(0).getT(1).getT(0).getT(0).getT(2).
                               getT(1);
		auto& pma9 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                            // xfade6_impl::pma9_t<NV>
                     getT(0).getT(1).getT(0).getT(0).getT(2).
                     getT(2);
		auto& gain16 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                          // core::gain<NV>
                       getT(0).getT(1).getT(0).getT(0).getT(2).
                       getT(3);
		auto& sb2_x1 = this->getT(1).getT(0).getT(0).getT(1).                                  // xfade6_impl::sb2_x1_t<NV>
                       getT(0).getT(0).getT(1).getT(1);
		auto& chain3_x1_x1 = this->getT(1).getT(0).getT(0).getT(1).                            // xfade6_impl::chain3_x1_x1_t<NV>
                             getT(0).getT(0).getT(1).getT(1).
                             getT(0);
		auto& xfader2_x1 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                      // xfade6_impl::xfader2_x1_t<NV>
                           getT(0).getT(1).getT(1).getT(0).getT(0);
		auto& pma10 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                           // xfade6_impl::pma10_t<NV>
                      getT(0).getT(1).getT(1).getT(0).getT(1);
		auto& chain7 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                          // xfade6_impl::chain7_t<NV>
                       getT(0).getT(1).getT(1).getT(0).getT(2);
		auto& split4 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                          // xfade6_impl::split4_t<NV>
                       getT(0).getT(1).getT(1).getT(0).getT(2).
                       getT(0);
		auto& smoothed_parameter1_x1 = this->getT(1).getT(0).getT(0).getT(1).getT(0).getT(0).  // xfade6_impl::smoothed_parameter1_x1_t<NV>
                                       getT(1).getT(1).getT(0).getT(2).getT(0).getT(0);
		auto& smoothed_parameter1 = this->getT(1).getT(0).getT(0).getT(1).getT(0).getT(0).     // xfade6_impl::smoothed_parameter1_t<NV>
                                    getT(1).getT(1).getT(0).getT(2).getT(0).getT(1);
		auto& input_toggle2 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                   // xfade6_impl::input_toggle2_t<NV>
                              getT(0).getT(1).getT(1).getT(0).getT(2).
                              getT(1);
		auto& pma11 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                           // xfade6_impl::pma11_t<NV>
                      getT(0).getT(1).getT(1).getT(0).getT(2).
                      getT(2);
		auto& gain1 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                           // core::gain<NV>
                      getT(0).getT(1).getT(1).getT(0).getT(2).
                      getT(3);
		auto& sb3_x1 = this->getT(1).getT(0).getT(0).getT(1).                                  // xfade6_impl::sb3_x1_t<NV>
                       getT(0).getT(0).getT(1).getT(2);
		auto& chain2_x1 = this->getT(1).getT(0).getT(0).getT(1).                               // xfade6_impl::chain2_x1_t<NV>
                          getT(0).getT(0).getT(1).getT(2).
                          getT(0);
		auto& xfader1_x1 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                      // xfade6_impl::xfader1_x1_t<NV>
                           getT(0).getT(1).getT(2).getT(0).getT(0);
		auto& pma12 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                           // xfade6_impl::pma12_t<NV>
                      getT(0).getT(1).getT(2).getT(0).getT(1);
		auto& chain12 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                         // xfade6_impl::chain12_t<NV>
                        getT(0).getT(1).getT(2).getT(0).getT(2);
		auto& split6 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                          // xfade6_impl::split6_t<NV>
                       getT(0).getT(1).getT(2).getT(0).getT(2).
                       getT(0);
		auto& smoothed_parameter2_x1 = this->getT(1).getT(0).getT(0).getT(1).getT(0).getT(0).  // xfade6_impl::smoothed_parameter2_x1_t<NV>
                                       getT(1).getT(2).getT(0).getT(2).getT(0).getT(0);
		auto& smoothed_parameter3 = this->getT(1).getT(0).getT(0).getT(1).getT(0).getT(0).     // xfade6_impl::smoothed_parameter3_t<NV>
                                    getT(1).getT(2).getT(0).getT(2).getT(0).getT(1);
		auto& input_toggle4 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                   // xfade6_impl::input_toggle4_t<NV>
                              getT(0).getT(1).getT(2).getT(0).getT(2).
                              getT(1);
		auto& pma13 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                           // xfade6_impl::pma13_t<NV>
		...
		auto& sb4_x1 = this->getT(1).getT(0).getT(0).getT(1).                                  // xfade6_impl::sb4_x1_t<NV>
                       getT(0).getT(0).getT(1).getT(3);
		auto& chain4_x1 = this->getT(1).getT(0).getT(0).getT(1).                               // xfade6_impl::chain4_x1_t<NV>
                          getT(0).getT(0).getT(1).getT(3).
                          getT(0);
		auto& xfader3_x1 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                      // xfade6_impl::xfader3_x1_t<NV>
                           getT(0).getT(1).getT(3).getT(0).getT(0);
		auto& pma17 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                           // xfade6_impl::pma17_t<NV>
                      getT(0).getT(1).getT(3).getT(0).getT(1);
		auto& chain13 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                         // xfade6_impl::chain13_t<NV>
                        getT(0).getT(1).getT(3).getT(0).getT(2);
		auto& split8 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                          // xfade6_impl::split8_t<NV>
                       getT(0).getT(1).getT(3).getT(0).getT(2).
                       getT(0);
		auto& smoothed_parameter4_x1 = this->getT(1).getT(0).getT(0).getT(1).getT(0).getT(0).  // xfade6_impl::smoothed_parameter4_x1_t<NV>
                                       getT(1).getT(3).getT(0).getT(2).getT(0).getT(0);
		auto& smoothed_parameter4 = this->getT(1).getT(0).getT(0).getT(1).getT(0).getT(0).     // xfade6_impl::smoothed_parameter4_t<NV>
                                    getT(1).getT(3).getT(0).getT(2).getT(0).getT(1);
		auto& input_toggle5 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                   // xfade6_impl::input_toggle5_t<NV>
                              getT(0).getT(1).getT(3).getT(0).getT(2).
                              getT(1);
		auto& pma15 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                           // xfade6_impl::pma15_t<NV>
                      getT(0).getT(1).getT(3).getT(0).getT(2).
                      getT(2);
		auto& gain3 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                           // core::gain<NV>
                      getT(0).getT(1).getT(3).getT(0).getT(3);
		auto& sb5_x1 = this->getT(1).getT(0).getT(0).getT(1).                                  // xfade6_impl::sb5_x1_t<NV>
                       getT(0).getT(0).getT(1).getT(4);
		auto& chain5_x1 = this->getT(1).getT(0).getT(0).getT(1).                               // xfade6_impl::chain5_x1_t<NV>
                          getT(0).getT(0).getT(1).getT(4).
                          getT(0);
		auto& xfader4_x1 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                      // xfade6_impl::xfader4_x1_t<NV>
                           getT(0).getT(1).getT(4).getT(0).getT(0);
		auto& pma14 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                           // xfade6_impl::pma14_t<NV>
                      getT(0).getT(1).getT(4).getT(0).getT(1);
		auto& chain11 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                         // xfade6_impl::chain11_t<NV>
                        getT(0).getT(1).getT(4).getT(0).getT(2);
		auto& split5 = this->getT(1).getT(0).getT(0).getT(1).getT(0).                          // xfade6_impl::split5_t<NV>
                       getT(0).getT(1).getT(4).getT(0).getT(2).
                       getT(0);
		auto& smoothed_parameter3_x1 = this->getT(1).getT(0).getT(0).getT(1).getT(0).getT(0).  // xfade6_impl::smoothed_parameter3_x1_t<NV>
                                       getT(1).getT(4).getT(0).getT(2).getT(0).getT(0);
		auto& smoothed_parameter2 = this->getT(1).getT(0).getT(0).getT(1).getT(0).getT(0).  // xfade6_impl::smoothed_parameter2_t<NV>
                                    getT(1).getT(4).getT(0).getT(2).getT(0).getT(1);
		auto& input_toggle3 = this->getT(1).getT(0).getT(0).getT(1).getT(0).  // xfade6_impl::input_toggle3_t<NV>
                              getT(0).getT(1).getT(4).getT(0).getT(2).
                              getT(1);
		auto& pma16 = this->getT(1).getT(0).getT(0).getT(1).getT(0).  // xfade6_impl::pma16_t<NV>
                      getT(0).getT(1).getT(4).getT(0).getT(2).
                      getT(2);
		auto& gain4 = this->getT(1).getT(0).getT(0).getT(1).getT(0).  // core::gain<NV>
                      getT(0).getT(1).getT(4).getT(0).getT(3);
		auto& sb4 = this->getT(1).getT(0).getT(0).getT(1).getT(1); // xfade6_impl::sb4_t
		auto& sb5 = this->getT(1).getT(0).getT(0).getT(1).getT(2); // xfade6_impl::sb5_t
		...
		xfader_x1_p.getParameterT(5).connectT(0, pma8);                              // xfader_x1 -> pma8::Add
		...
		xfader2_x1_p.getParameterT(5).connectT(0, pma10);                            // xfader2_x1 -> pma10::Add
		...
		xfader1_x1_p.getParameterT(5).connectT(0, pma12);                            // xfader1_x1 -> pma12::Add
		...
		xfader3_x1_p.getParameterT(5).connectT(0, pma17);                            // xfader3_x1 -> pma17::Add
		...
		xfader4_x1_p.getParameterT(5).connectT(0, pma14);                            // xfader4_x1 -> pma14::Add
	...
	void connectToRuntimeTarget(bool addConnection, const runtime_target::connection& c)
	{
		...
		this->getT(0).getT(0).getT(1).getT(4).getT(0).  // xfade6_impl::global_cable16_t<NV>
        getT(2).getT(1).getT(0).getT(0).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(4).getT(0).  // xfade6_impl::global_cable17_t<NV>
        getT(2).getT(1).getT(0).getT(1).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(4).getT(0).  // xfade6_impl::global_cable18_t<NV>
        getT(2).getT(1).getT(0).getT(2).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(4).getT(0).  // xfade6_impl::global_cable19_t<NV>
        getT(2).getT(1).getT(0).getT(3).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(4).getT(0).  // xfade6_impl::global_cable20_t<NV>
        getT(2).getT(1).getT(0).getT(4).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(4).getT(0).  // xfade6_impl::global_cable21_t<NV>
        getT(2).getT(1).getT(0).getT(5).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(4).getT(0).  // xfade6_impl::global_cable22_t<NV>
        getT(2).getT(1).getT(0).getT(6).getT(0).connectToRuntimeTarget(addConnection, c);
		this->getT(0).getT(0).getT(1).getT(4).getT(0).  // xfade6_impl::global_cable23_t<NV>
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(0).getT(0).getT(1).getT(4).getT(0).getT(0).setExternalData(b, index); // xfade6_impl::cable_table11_t<NV>
		this->getT(0).getT(0).getT(1).getT(4).getT(0).getT(1).setExternalData(b, index); // xfade6_impl::cable_table12_t<NV>
		this->getT(0).getT(0).getT(1).getT(4).                                           // xfade6_impl::peak2_t<NV>
...
template <int NV>
using xfade6 = wrap::node<xfade6_impl::instance<NV>>;
}
