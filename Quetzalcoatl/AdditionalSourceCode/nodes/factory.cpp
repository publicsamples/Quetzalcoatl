...
struct Factory: public scriptnode::dll::StaticLibraryHostFactory
{
	Factory()
	{
		...
		registerPolyNode<project::PanSliders2<1>, project::PanSliders2<NUM_POLYPHONIC_VOICES>>();
		registerPolyNode<project::PitchSliders<1>, project::PitchSliders<NUM_POLYPHONIC_VOICES>>();
		registerPolyNode<project::PreSliders2<1>, project::PreSliders2<NUM_POLYPHONIC_VOICES>>();
