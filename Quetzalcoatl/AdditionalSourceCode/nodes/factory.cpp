...
struct Factory: public scriptnode::dll::StaticLibraryHostFactory
{
	Factory()
	{
		...
		registerPolyNode<project::SimpleRamp1<1>, wrap::illegal_poly<project::SimpleRamp1<1>>>();
		registerPolyNode<project::StageDelay<1>, wrap::illegal_poly<project::StageDelay<1>>>();
		registerPolyNode<project::WtMod2<1>, project::WtMod2<NUM_POLYPHONIC_VOICES>>();
