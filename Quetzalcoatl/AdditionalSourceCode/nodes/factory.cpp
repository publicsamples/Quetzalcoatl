...
struct Factory: public scriptnode::dll::StaticLibraryHostFactory
{
	Factory()
	{
		...
		registerDataNode<project::chorus_networkdata>();
		registerDataNode<project::clones_networkdata>();
		...
		registerDataNode<project::filterB_networkdata>();
		...
		registerDataNode<project::o_networkdata>();
		registerDataNode<project::o2_networkdata>();
		registerDataNode<project::oscin1_networkdata>();
		...
		registerDataNode<project::QArrange_networkdata>();
		registerDataNode<project::QArrange2_networkdata>();
		registerDataNode<project::qqq_networkdata>();
		...
		registerDataNode<project::VecOsc_networkdata>();
