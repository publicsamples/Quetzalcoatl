...
using global_cable54_t_index = global_cable15_t_index;
...
namespace modtest6_t_parameters
{
// Parameter list for modtest6_impl::modtest6_t ----------------------------------------------------
...
template <int NV>
using Tempo_0 = parameter::from0To1<modtest6_impl::pma1_t<NV>, 
                                    2, 
                                    Tempo_0Range>;
...
template <int NV>
using TempoSrc_0 = parameter::from0To1<modtest6_impl::branch3_t<NV>, 
                                       0, 
                                       TempoSrc_0Range>;
...
template <int NV>
using Shape_0 = parameter::from0To1<modtest6_impl::branch_t<NV>, 
                                    0, 
                                    Shape_0Range>;
...
template <int NV>
using Modifiers_0 = parameter::from0To1<modtest6_impl::branch1_t<NV>, 
                                        0, 
                                        Modifiers_0Range>;
...
template <int NV>
using ModiferShape = parameter::from0To1<modtest6_impl::pma_t<NV>, 
                                         2, 
                                         Tempo_0Range>;
...
DECLARE_PARAMETER_RANGE(ModifierShapeModSrc_InputRange, 
                        ...
                        16.);
template <int NV>
using ModifierShapeModSrc_0 = parameter::from0To1<modtest6_impl::branch5_t<NV>, 
                                                  0, 
                                                  TempoSrc_0Range>;
...
DECLARE_PARAMETER_RANGE_STEP(trigmode_InputRange, 
                             ...
                             0.1);
template <int NV>
using trigmode_0 = parameter::from0To1<modtest6_impl::branch6_t<NV>, 
                                       0, 
                                       TempoSrc_0Range>;
...
template <int NV>
using TempoMod = parameter::plain<modtest6_impl::pma1_t<NV>, 
                                  1>;
template <int NV>
using Div = parameter::plain<modtest6_impl::tempo_sync_t<NV>, 
                             1>;
template <int NV>
using ModifierShapeMod = parameter::plain<modtest6_impl::pma_t<NV>, 
                                          1>;
using out = parameter::empty;
template <int NV>
using oneshot = parameter::plain<modtest6_impl::ramp_t<NV>, 
                                 1>;
template <int NV>
using modtest6_t_plist = parameter::list<Tempo<NV>, 
                                         TempoMod<NV>, 
                                         TempoSrc<NV>, 
                                         Div<NV>, 
                                         Shape<NV>, 
...
template <int NV>
using modtest6_t_ = container::chain<modtest6_t_parameters::modtest6_t_plist<NV>, 
...
template <int NV> struct instance: public modtest6_impl::modtest6_t_<NV>
{
	...
	instance()
	{
		...
		auto& chain12 = this->getT(0);                                 // modtest6_impl::chain12_t<NV>
		auto& branch3 = this->getT(0).getT(0);                         // modtest6_impl::branch3_t<NV>
		auto& chain = this->getT(0).getT(0).getT(0);                   // modtest6_impl::chain_t<NV>
		auto& global_cable1 = this->getT(0).getT(0).getT(0).getT(0);   // modtest6_impl::global_cable1_t<NV>
		auto& add2 = this->getT(0).getT(0).getT(0).getT(1);            // math::add<NV>
		auto& chain2 = this->getT(0).getT(0).getT(1);                  // modtest6_impl::chain2_t<NV>
		auto& global_cable2 = this->getT(0).getT(0).getT(1).getT(0);   // modtest6_impl::global_cable2_t<NV>
		auto& add4 = this->getT(0).getT(0).getT(1).getT(1);            // math::add<NV>
		auto& chain3 = this->getT(0).getT(0).getT(2);                  // modtest6_impl::chain3_t<NV>
		auto& global_cable3 = this->getT(0).getT(0).getT(2).getT(0);   // modtest6_impl::global_cable3_t<NV>
		auto& add5 = this->getT(0).getT(0).getT(2).getT(1);            // math::add<NV>
		auto& chain4 = this->getT(0).getT(0).getT(3);                  // modtest6_impl::chain4_t<NV>
		auto& global_cable4 = this->getT(0).getT(0).getT(3).getT(0);   // modtest6_impl::global_cable4_t<NV>
		auto& add6 = this->getT(0).getT(0).getT(3).getT(1);            // math::add<NV>
		auto& chain6 = this->getT(0).getT(0).getT(4);                  // modtest6_impl::chain6_t<NV>
		auto& global_cable5 = this->getT(0).getT(0).getT(4).getT(0);   // modtest6_impl::global_cable5_t<NV>
		auto& add7 = this->getT(0).getT(0).getT(4).getT(1);            // math::add<NV>
		auto& chain7 = this->getT(0).getT(0).getT(5);                  // modtest6_impl::chain7_t<NV>
		auto& global_cable6 = this->getT(0).getT(0).getT(5).getT(0);   // modtest6_impl::global_cable6_t<NV>
		auto& add8 = this->getT(0).getT(0).getT(5).getT(1);            // math::add<NV>
		auto& chain9 = this->getT(0).getT(0).getT(6);                  // modtest6_impl::chain9_t<NV>
		auto& global_cable7 = this->getT(0).getT(0).getT(6).getT(0);   // modtest6_impl::global_cable7_t<NV>
		auto& add9 = this->getT(0).getT(0).getT(6).getT(1);            // math::add<NV>
		auto& chain10 = this->getT(0).getT(0).getT(7);                 // modtest6_impl::chain10_t<NV>
		auto& global_cable8 = this->getT(0).getT(0).getT(7).getT(0);   // modtest6_impl::global_cable8_t<NV>
		auto& add10 = this->getT(0).getT(0).getT(7).getT(1);           // math::add<NV>
		auto& chain14 = this->getT(0).getT(0).getT(8);                 // modtest6_impl::chain14_t<NV>
		auto& global_cable10 = this->getT(0).getT(0).getT(8).getT(0);  // modtest6_impl::global_cable10_t<NV>
		auto& add12 = this->getT(0).getT(0).getT(8).getT(1);           // math::add<NV>
		auto& chain15 = this->getT(0).getT(0).getT(9);                 // modtest6_impl::chain15_t<NV>
		auto& global_cable11 = this->getT(0).getT(0).getT(9).getT(0);  // modtest6_impl::global_cable11_t<NV>
		auto& add13 = this->getT(0).getT(0).getT(9).getT(1);           // math::add<NV>
		auto& chain25 = this->getT(0).getT(0).getT(10);                // modtest6_impl::chain25_t<NV>
		auto& global_cable12 = this->getT(0).getT(0).getT(10).getT(0); // modtest6_impl::global_cable12_t<NV>
		auto& add14 = this->getT(0).getT(0).getT(10).getT(1);          // math::add<NV>
		auto& chain17 = this->getT(0).getT(0).getT(11);                // modtest6_impl::chain17_t<NV>
		auto& global_cable13 = this->getT(0).getT(0).getT(11).getT(0); // modtest6_impl::global_cable13_t<NV>
		auto& add15 = this->getT(0).getT(0).getT(11).getT(1);          // math::add<NV>
		auto& chain18 = this->getT(0).getT(0).getT(12);                // modtest6_impl::chain18_t<NV>
		auto& global_cable14 = this->getT(0).getT(0).getT(12).getT(0); // modtest6_impl::global_cable14_t<NV>
		auto& add16 = this->getT(0).getT(0).getT(12).getT(1);          // math::add<NV>
		auto& chain19 = this->getT(0).getT(0).getT(13);                // modtest6_impl::chain19_t<NV>
		auto& global_cable15 = this->getT(0).getT(0).getT(13).getT(0); // modtest6_impl::global_cable15_t<NV>
		auto& add17 = this->getT(0).getT(0).getT(13).getT(1);          // math::add<NV>
		auto& chain21 = this->getT(0).getT(0).getT(14);                // modtest6_impl::chain21_t<NV>
		auto& global_cable16 = this->getT(0).getT(0).getT(14).getT(0); // modtest6_impl::global_cable16_t<NV>
		auto& add18 = this->getT(0).getT(0).getT(14).getT(1);          // math::add<NV>
		auto& chain22 = this->getT(0).getT(0).getT(15);                // modtest6_impl::chain22_t<NV>
		auto& global_cable17 = this->getT(0).getT(0).getT(15).getT(0); // modtest6_impl::global_cable17_t<NV>
		auto& add19 = this->getT(0).getT(0).getT(15).getT(1);          // math::add<NV>
		auto& peak1 = this->getT(0).getT(1);                           // modtest6_impl::peak1_t<NV>
		auto& clear = this->getT(0).getT(2);                           // math::clear<NV>
		auto& chain27 = this->getT(1);                                 // modtest6_impl::chain27_t<NV>
		auto& branch5 = this->getT(1).getT(0);                         // modtest6_impl::branch5_t<NV>
		auto& chain28 = this->getT(1).getT(0).getT(0);                 // modtest6_impl::chain28_t<NV>
		auto& global_cable19 = this->getT(1).getT(0).getT(0).getT(0);  // modtest6_impl::global_cable19_t<NV>
		auto& add21 = this->getT(1).getT(0).getT(0).getT(1);           // math::add<NV>
		auto& chain30 = this->getT(1).getT(0).getT(1);                 // modtest6_impl::chain30_t<NV>
		auto& global_cable20 = this->getT(1).getT(0).getT(1).getT(0);  // modtest6_impl::global_cable20_t<NV>
		auto& add22 = this->getT(1).getT(0).getT(1).getT(1);           // math::add<NV>
		auto& chain31 = this->getT(1).getT(0).getT(2);                 // modtest6_impl::chain31_t<NV>
		auto& global_cable21 = this->getT(1).getT(0).getT(2).getT(0);  // modtest6_impl::global_cable21_t<NV>
		auto& add23 = this->getT(1).getT(0).getT(2).getT(1);           // math::add<NV>
		auto& chain33 = this->getT(1).getT(0).getT(3);                 // modtest6_impl::chain33_t<NV>
		auto& global_cable22 = this->getT(1).getT(0).getT(3).getT(0);  // modtest6_impl::global_cable22_t<NV>
		auto& add24 = this->getT(1).getT(0).getT(3).getT(1);           // math::add<NV>
		auto& chain34 = this->getT(1).getT(0).getT(4);                 // modtest6_impl::chain34_t<NV>
		auto& global_cable23 = this->getT(1).getT(0).getT(4).getT(0);  // modtest6_impl::global_cable23_t<NV>
		auto& add25 = this->getT(1).getT(0).getT(4).getT(1);           // math::add<NV>
		auto& chain36 = this->getT(1).getT(0).getT(5);                 // modtest6_impl::chain36_t<NV>
		auto& global_cable24 = this->getT(1).getT(0).getT(5).getT(0);  // modtest6_impl::global_cable24_t<NV>
		auto& add26 = this->getT(1).getT(0).getT(5).getT(1);           // math::add<NV>
		auto& chain37 = this->getT(1).getT(0).getT(6);                 // modtest6_impl::chain37_t<NV>
		auto& global_cable25 = this->getT(1).getT(0).getT(6).getT(0);  // modtest6_impl::global_cable25_t<NV>
		auto& add27 = this->getT(1).getT(0).getT(6).getT(1);           // math::add<NV>
		auto& chain38 = this->getT(1).getT(0).getT(7);                 // modtest6_impl::chain38_t<NV>
		auto& global_cable26 = this->getT(1).getT(0).getT(7).getT(0);  // modtest6_impl::global_cable26_t<NV>
		auto& add28 = this->getT(1).getT(0).getT(7).getT(1);           // math::add<NV>
		auto& chain39 = this->getT(1).getT(0).getT(8);                 // modtest6_impl::chain39_t<NV>
		auto& global_cable27 = this->getT(1).getT(0).getT(8).getT(0);  // modtest6_impl::global_cable27_t<NV>
		auto& add29 = this->getT(1).getT(0).getT(8).getT(1);           // math::add<NV>
		auto& chain40 = this->getT(1).getT(0).getT(9);                 // modtest6_impl::chain40_t<NV>
		auto& global_cable28 = this->getT(1).getT(0).getT(9).getT(0);  // modtest6_impl::global_cable28_t<NV>
		auto& add30 = this->getT(1).getT(0).getT(9).getT(1);           // math::add<NV>
		auto& chain42 = this->getT(1).getT(0).getT(10);                // modtest6_impl::chain42_t<NV>
		auto& global_cable29 = this->getT(1).getT(0).getT(10).getT(0); // modtest6_impl::global_cable29_t<NV>
		auto& add31 = this->getT(1).getT(0).getT(10).getT(1);          // math::add<NV>
		auto& chain43 = this->getT(1).getT(0).getT(11);                // modtest6_impl::chain43_t<NV>
		auto& global_cable30 = this->getT(1).getT(0).getT(11).getT(0); // modtest6_impl::global_cable30_t<NV>
		auto& add32 = this->getT(1).getT(0).getT(11).getT(1);          // math::add<NV>
		auto& chain52 = this->getT(1).getT(0).getT(12);                // modtest6_impl::chain52_t<NV>
		auto& global_cable31 = this->getT(1).getT(0).getT(12).getT(0); // modtest6_impl::global_cable31_t<NV>
		auto& add33 = this->getT(1).getT(0).getT(12).getT(1);          // math::add<NV>
		auto& chain53 = this->getT(1).getT(0).getT(13);                // modtest6_impl::chain53_t<NV>
		auto& global_cable32 = this->getT(1).getT(0).getT(13).getT(0); // modtest6_impl::global_cable32_t<NV>
		auto& add34 = this->getT(1).getT(0).getT(13).getT(1);          // math::add<NV>
		auto& chain54 = this->getT(1).getT(0).getT(14);                // modtest6_impl::chain54_t<NV>
		auto& global_cable33 = this->getT(1).getT(0).getT(14).getT(0); // modtest6_impl::global_cable33_t<NV>
		auto& add35 = this->getT(1).getT(0).getT(14).getT(1);          // math::add<NV>
		auto& chain55 = this->getT(1).getT(0).getT(15);                // modtest6_impl::chain55_t<NV>
		auto& global_cable34 = this->getT(1).getT(0).getT(15).getT(0); // modtest6_impl::global_cable34_t<NV>
		auto& add36 = this->getT(1).getT(0).getT(15).getT(1);          // math::add<NV>
		auto& peak4 = this->getT(1).getT(1);                           // modtest6_impl::peak4_t<NV>
		auto& clear6 = this->getT(2);                                  // math::clear<NV>
		auto& chain46 = this->getT(3);                                 // modtest6_impl::chain46_t<NV>
		auto& branch6 = this->getT(3).getT(0);                         // modtest6_impl::branch6_t<NV>
		auto& chain11 = this->getT(3).getT(0).getT(0);                 // modtest6_impl::chain11_t<NV>
		auto& add11 = this->getT(3).getT(0).getT(0).getT(0);           // math::add<NV>
		auto& midichain = this->getT(3).getT(0).getT(1);               // modtest6_impl::midichain_t<NV>
		auto& simple_ar = this->getT(3).getT(0).getT(1).getT(0);       // modtest6_impl::simple_ar_t<NV>
		auto& add20 = this->getT(3).getT(0).getT(1).getT(1);           // math::add<NV>
		auto& chain47 = this->getT(3).getT(0).getT(2);                 // modtest6_impl::chain47_t<NV>
		auto& global_cable48 = this->getT(3).getT(0).getT(2).getT(0);  // modtest6_impl::global_cable48_t<NV>
		auto& add37 = this->getT(3).getT(0).getT(2).getT(1);           // math::add<NV>
		auto& chain48 = this->getT(3).getT(0).getT(3);                 // modtest6_impl::chain48_t<NV>
		auto& global_cable49 = this->getT(3).getT(0).getT(3).getT(0);  // modtest6_impl::global_cable49_t<NV>
		auto& add38 = this->getT(3).getT(0).getT(3).getT(1);           // math::add<NV>
		auto& chain49 = this->getT(3).getT(0).getT(4);                 // modtest6_impl::chain49_t<NV>
		auto& global_cable50 = this->getT(3).getT(0).getT(4).getT(0);  // modtest6_impl::global_cable50_t<NV>
		auto& add39 = this->getT(3).getT(0).getT(4).getT(1);           // math::add<NV>
		auto& chain56 = this->getT(3).getT(0).getT(5);                 // modtest6_impl::chain56_t<NV>
		auto& global_cable51 = this->getT(3).getT(0).getT(5).getT(0);  // modtest6_impl::global_cable51_t<NV>
		auto& add40 = this->getT(3).getT(0).getT(5).getT(1);           // math::add<NV>
		auto& chain57 = this->getT(3).getT(0).getT(6);                 // modtest6_impl::chain57_t<NV>
		auto& global_cable52 = this->getT(3).getT(0).getT(6).getT(0);  // modtest6_impl::global_cable52_t<NV>
		auto& add41 = this->getT(3).getT(0).getT(6).getT(1);           // math::add<NV>
		auto& chain58 = this->getT(3).getT(0).getT(7);                 // modtest6_impl::chain58_t<NV>
		auto& global_cable53 = this->getT(3).getT(0).getT(7).getT(0);  // modtest6_impl::global_cable53_t<NV>
		auto& add42 = this->getT(3).getT(0).getT(7).getT(1);           // math::add<NV>
		auto& chain61 = this->getT(3).getT(0).getT(8);                 // modtest6_impl::chain61_t<NV>
		auto& global_cable56 = this->getT(3).getT(0).getT(8).getT(0);  // modtest6_impl::global_cable56_t<NV>
		auto& add45 = this->getT(3).getT(0).getT(8).getT(1);           // math::add<NV>
		auto& chain62 = this->getT(3).getT(0).getT(9);                 // modtest6_impl::chain62_t<NV>
		auto& global_cable57 = this->getT(3).getT(0).getT(9).getT(0);  // modtest6_impl::global_cable57_t<NV>
		auto& add46 = this->getT(3).getT(0).getT(9).getT(1);           // math::add<NV>
		auto& chain63 = this->getT(3).getT(0).getT(10);                // modtest6_impl::chain63_t<NV>
		auto& global_cable58 = this->getT(3).getT(0).getT(10).getT(0); // modtest6_impl::global_cable58_t<NV>
		auto& add47 = this->getT(3).getT(0).getT(10).getT(1);          // math::add<NV>
		auto& chain64 = this->getT(3).getT(0).getT(11);                // modtest6_impl::chain64_t<NV>
		auto& global_cable59 = this->getT(3).getT(0).getT(11).getT(0); // modtest6_impl::global_cable59_t<NV>
		auto& add48 = this->getT(3).getT(0).getT(11).getT(1);          // math::add<NV>
		auto& chain65 = this->getT(3).getT(0).getT(12);                // modtest6_impl::chain65_t<NV>
		auto& global_cable60 = this->getT(3).getT(0).getT(12).getT(0); // modtest6_impl::global_cable60_t<NV>
		auto& add49 = this->getT(3).getT(0).getT(12).getT(1);          // math::add<NV>
		auto& chain66 = this->getT(3).getT(0).getT(13);                // modtest6_impl::chain66_t<NV>
		auto& global_cable61 = this->getT(3).getT(0).getT(13).getT(0); // modtest6_impl::global_cable61_t<NV>
		auto& add50 = this->getT(3).getT(0).getT(13).getT(1);          // math::add<NV>
		auto& chain67 = this->getT(3).getT(0).getT(14);                // modtest6_impl::chain67_t<NV>
		auto& global_cable62 = this->getT(3).getT(0).getT(14).getT(0); // modtest6_impl::global_cable62_t<NV>
		auto& add51 = this->getT(3).getT(0).getT(14).getT(1);          // math::add<NV>
		auto& chain68 = this->getT(3).getT(0).getT(15);                // modtest6_impl::chain68_t<NV>
		auto& global_cable63 = this->getT(3).getT(0).getT(15).getT(0); // modtest6_impl::global_cable63_t<NV>
		auto& add52 = this->getT(3).getT(0).getT(15).getT(1);          // math::add<NV>
		auto& peak6 = this->getT(3).getT(1);                           // modtest6_impl::peak6_t<NV>
		auto& clear7 = this->getT(3).getT(2);                          // math::clear<NV>
		auto& clear2 = this->getT(4);                                  // math::clear<NV>
		auto& pma1 = this->getT(5);                                    // modtest6_impl::pma1_t<NV>
		auto& tempo_sync = this->getT(6);                              // modtest6_impl::tempo_sync_t<NV>
		auto& ramp = this->getT(7);                                    // modtest6_impl::ramp_t<NV>
		auto& fmod1 = this->getT(8);                                   // wrap::no_process<math::fmod<NV>>
		auto& branch = this->getT(9);                                  // modtest6_impl::branch_t<NV>
		auto& chain23 = this->getT(9).getT(0);                         // modtest6_impl::chain23_t<NV>
		...
		auto& chain8 = this->getT(9).getT(1);                          // modtest6_impl::chain8_t<NV>
		...
		auto& chain5 = this->getT(9).getT(2);                          // modtest6_impl::chain5_t<NV>
		...
		auto& chain41 = this->getT(9).getT(3);                         // modtest6_impl::chain41_t<NV>
		...
		auto& peak5 = this->getT(9).getT(3).getT(3);                   // modtest6_impl::peak5_t
		auto& chain32 = this->getT(9).getT(4);                         // modtest6_impl::chain32_t<NV>
		auto& oscillator = this->getT(9).getT(4).getT(0);              // modtest6_impl::oscillator_t<NV>
		...
		auto& chain20 = this->getT(9).getT(5);                         // modtest6_impl::chain20_t<NV>
		auto& clear15 = this->getT(9).getT(5).getT(0);                 // math::clear<NV>
		auto& cable_table = this->getT(9).getT(5).getT(1);             // modtest6_impl::cable_table_t<NV>
		auto& add = this->getT(9).getT(5).getT(2);                     // math::add<NV>
		auto& chain26 = this->getT(9).getT(6);                         // modtest6_impl::chain26_t<NV>
		auto& clear5 = this->getT(9).getT(6).getT(0);                  // math::clear<NV>
		auto& cable_pack = this->getT(9).getT(6).getT(1);              // modtest6_impl::cable_pack_t<NV>
		auto& add1 = this->getT(9).getT(6).getT(2);                    // math::add<NV>
		auto& peak = this->getT(10);                                   // modtest6_impl::peak_t
		auto& pma = this->getT(11);                                    // modtest6_impl::pma_t<NV>
		auto& branch1 = this->getT(12);                                // modtest6_impl::branch1_t<NV>
		auto& chain1 = this->getT(12).getT(0);                         // modtest6_impl::chain1_t
		auto& chain29 = this->getT(12).getT(1);                        // modtest6_impl::chain29_t<NV>
		auto& expr3 = this->getT(12).getT(1).getT(0);                  // math::expr<NV, custom::expr3>
		auto& chain35 = this->getT(12).getT(2);                        // modtest6_impl::chain35_t<NV>
		auto& expr5 = this->getT(12).getT(2).getT(0);                  // math::expr<NV, custom::expr5>
		auto& chain44 = this->getT(12).getT(3);                        // modtest6_impl::chain44_t<NV>
		auto& expr8 = this->getT(12).getT(3).getT(0);                  // math::expr<NV, custom::expr8>
		auto& chain45 = this->getT(12).getT(4);                        // modtest6_impl::chain45_t<NV>
		auto& expr9 = this->getT(12).getT(4).getT(0);                  // math::expr<NV, custom::expr9>
		auto& peak2 = this->getT(13);                                  // modtest6_impl::peak2_t
	...
	void connectToRuntimeTarget(bool addConnection, const runtime_target::connection& c)
	{
		...
		this->getT(0).getT(0).getT(0).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable1_t<NV>
		this->getT(0).getT(0).getT(1).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable2_t<NV>
		this->getT(0).getT(0).getT(2).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable3_t<NV>
		this->getT(0).getT(0).getT(3).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable4_t<NV>
		this->getT(0).getT(0).getT(4).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable5_t<NV>
		this->getT(0).getT(0).getT(5).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable6_t<NV>
		this->getT(0).getT(0).getT(6).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable7_t<NV>
		this->getT(0).getT(0).getT(7).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable8_t<NV>
		this->getT(0).getT(0).getT(8).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable10_t<NV>
		this->getT(0).getT(0).getT(9).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable11_t<NV>
		this->getT(0).getT(0).getT(10).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable12_t<NV>
		this->getT(0).getT(0).getT(11).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable13_t<NV>
		this->getT(0).getT(0).getT(12).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable14_t<NV>
		this->getT(0).getT(0).getT(13).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable15_t<NV>
		this->getT(0).getT(0).getT(14).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable16_t<NV>
		this->getT(0).getT(0).getT(15).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable17_t<NV>
		this->getT(1).getT(0).getT(0).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable19_t<NV>
		this->getT(1).getT(0).getT(1).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable20_t<NV>
		this->getT(1).getT(0).getT(2).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable21_t<NV>
		this->getT(1).getT(0).getT(3).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable22_t<NV>
		this->getT(1).getT(0).getT(4).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable23_t<NV>
		this->getT(1).getT(0).getT(5).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable24_t<NV>
		this->getT(1).getT(0).getT(6).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable25_t<NV>
		this->getT(1).getT(0).getT(7).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable26_t<NV>
		this->getT(1).getT(0).getT(8).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable27_t<NV>
		this->getT(1).getT(0).getT(9).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable28_t<NV>
		this->getT(1).getT(0).getT(10).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable29_t<NV>
		this->getT(1).getT(0).getT(11).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable30_t<NV>
		this->getT(1).getT(0).getT(12).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable31_t<NV>
		this->getT(1).getT(0).getT(13).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable32_t<NV>
		this->getT(1).getT(0).getT(14).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable33_t<NV>
		this->getT(1).getT(0).getT(15).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable34_t<NV>
		this->getT(3).getT(0).getT(2).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable48_t<NV>
		this->getT(3).getT(0).getT(3).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable49_t<NV>
		this->getT(3).getT(0).getT(4).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable50_t<NV>
		this->getT(3).getT(0).getT(5).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable51_t<NV>
		this->getT(3).getT(0).getT(6).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable52_t<NV>
		this->getT(3).getT(0).getT(7).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable53_t<NV>
		this->getT(3).getT(0).getT(8).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable56_t<NV>
		this->getT(3).getT(0).getT(9).getT(0).connectToRuntimeTarget(addConnection, c);  // modtest6_impl::global_cable57_t<NV>
		this->getT(3).getT(0).getT(10).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable58_t<NV>
		this->getT(3).getT(0).getT(11).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable59_t<NV>
		this->getT(3).getT(0).getT(12).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable60_t<NV>
		this->getT(3).getT(0).getT(13).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable61_t<NV>
		this->getT(3).getT(0).getT(14).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable62_t<NV>
		this->getT(3).getT(0).getT(15).getT(0).connectToRuntimeTarget(addConnection, c); // modtest6_impl::global_cable63_t<NV>
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(0).getT(1).setExternalData(b, index);                 // modtest6_impl::peak1_t<NV>
		this->getT(1).getT(1).setExternalData(b, index);                 // modtest6_impl::peak4_t<NV>
		this->getT(3).getT(0).getT(1).getT(0).setExternalData(b, index); // modtest6_impl::simple_ar_t<NV>
		this->getT(3).getT(1).setExternalData(b, index);                 // modtest6_impl::peak6_t<NV>
		this->getT(7).setExternalData(b, index);                         // modtest6_impl::ramp_t<NV>
		this->getT(9).getT(3).getT(3).setExternalData(b, index);         // modtest6_impl::peak5_t
		this->getT(9).getT(4).getT(0).setExternalData(b, index);         // modtest6_impl::oscillator_t<NV>
		this->getT(9).getT(5).getT(1).setExternalData(b, index);         // modtest6_impl::cable_table_t<NV>
		this->getT(9).getT(6).getT(1).setExternalData(b, index);         // modtest6_impl::cable_pack_t<NV>
		this->getT(10).setExternalData(b, index);                        // modtest6_impl::peak_t
		this->getT(13).setExternalData(b, index);                        // modtest6_impl::peak2_t
	}
};
}
...
template <int NV>
using modtest6 = wrap::node<modtest6_impl::instance<NV>>;
}
