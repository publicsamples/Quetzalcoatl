...
using global_cable_t_index = runtime_target::indexers::fix_hash<3433274>;
...
template <int NV>
using pan7_t_ = container::chain<parameter::empty, 
                                 wrap::fix<2, chain_t<NV>>, 
                                 core::gain<NV>>;

// =================================| Root node initialiser class |=================================

template <int NV> struct instance: public pan7_impl::pan7_t_<NV>
{
	...
	instance()
	{
		...
		auto& chain = this->getT(0);                // pan7_impl::chain_t<NV>
		auto& global_cable = this->getT(0).getT(0); // pan7_impl::global_cable_t<NV>
	...
	void connectToRuntimeTarget(bool addConnection, const runtime_target::connection& c)
	{
		...
		this->getT(0).getT(0).connectToRuntimeTarget(addConnection, c); // pan7_impl::global_cable_t<NV>
	}
};
}
...
template <int NV>
using pan7 = wrap::node<pan7_impl::instance<NV>>;
}
