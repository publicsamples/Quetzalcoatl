...
Compilation options: -lang cpp -rui -nvi -ct 1 -cn _Folder -scn ::faust::dsp -es 1 -mcd 16 -uim -single -ftz 0
------------------------------------------------------------ */
...
class _Folder final : public ::faust::dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -rui -nvi -ct 1 -cn _Folder -scn ::faust::dsp -es 1 -mcd 16 -uim -single -ftz 0");
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = 0.001f * _Folder_faustpower2_f(std::max<float>(0.0f, std::min<float>(1.0f, float(fHslider2))));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fVec14[0] = fTemp34;
			fRec24[0] = (fTemp34 + fVec14[1] - fTemp17 * fRec24[1]) / fTemp18;
	...
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -nvi -ct 1 -cn _Folder -scn ::faust::dsp -es 1 -mcd 16 -uim -single -ftz 0"
