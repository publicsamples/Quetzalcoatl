...
class _b259wf final : public ::faust::dsp {
 ...
 public:
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = 0.001f * _b259wf_faustpower2_f(std::max<float>(0.0f, std::min<float>(1.0f, float(fHslider0))));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp7 = ((fTemp5 > 0.6f) ? fTemp4 : 0.6f * fTemp6);
			float fTemp8 = 0.6f * float((fTemp7 > 0.0f) - (fTemp7 < 0.0f)) - fTemp7;
			fVec1[0] = fTemp8;
			fRec5[0] = 7.250317f * (fTemp8 + fVec1[1]) - 0.45006347f * fRec5[1];
			...
			float fTemp9 = ((fTemp5 > 2.994f) ? fTemp4 : 2.994f * fTemp6);
			float fTemp10 = 2.994f * float((fTemp9 > 0.0f) - (fTemp9 < 0.0f)) - fTemp9;
			fVec2[0] = fTemp10;
			fRec10[0] = 7.5879817f * (fTemp10 + fVec2[1]) - 0.45006347f * fRec10[1];
			...
			float fTemp11 = ((fTemp5 > 5.46f) ? fTemp4 : 5.46f * fTemp6);
			float fTemp12 = 5.46f * float((fTemp11 > 0.0f) - (fTemp11 < 0.0f)) - fTemp11;
			fVec3[0] = fTemp12;
			fRec13[0] = 4.394902f * (fTemp12 + fVec3[1]) - 0.45006347f * fRec13[1];
			...
			float fTemp13 = ((fTemp5 > 1.8f) ? fTemp4 : 1.8f * fTemp6);
			...
			float fTemp15 = ((fTemp5 > 4.08f) ? fTemp4 : 4.08f * fTemp6);
			...
			fRec1[0] = -((fRec1[1] * fTemp1 - (fTemp17 + fVec6[1])) / fTemp18);
			...
			float fTemp34 = 0.7255736f * (fRec25[0] + fRec25[2] + fRec28[0] + fRec28[2] + fRec31[0] + fRec31[2] + fRec34[0] + fRec34[2] + fRec37[0] + fRec37[2] + fRec40[0] + fRec40[2]) + 1.4511472f * (fRec25[1] + fRec28[1] + fRec31[1] + fRec34[1] + fRec37[1] + fRec40[1]);
			fVec14[0] = fTemp34;
			fRec24[0] = -((fTemp1 * fRec24[1] - (fTemp34 + fVec14[1])) / fTemp18);
