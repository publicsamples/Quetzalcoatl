...
Compilation options: -lang cpp -rui -nvi -ct 1 -cn _b259wf -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */

#ifndef  ___b259wf_H__
#define  ___b259wf_H__
...
static float _b259wf_faustpower2_f(float value) {
	return value * value;
}

class _b259wf final : public ::faust::dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-lang cpp -rui -nvi -ct 1 -cn _b259wf -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
		m->declare("filename", "b259wf.dsp");
	...
	void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("b259wf");
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = 0.001f * std::max<float>(0.0f, std::min<float>(1.0f, float(fHslider0)));
		float fSlow1 = 0.001f * std::max<float>(-1.0f, std::min<float>(1.0f, float(fHslider1)));
		float fSlow2 = 0.001f * _b259wf_faustpower2_f(std::max<float>(0.0f, std::min<float>(1.0f, float(fHslider2))));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec5[0] = fSlow0 + 0.999f * fRec5[1];
			float fTemp0 = 19.0f * fRec5[0] + 1.0f;
			fRec6[0] = fSlow1 + 0.999f * fRec6[1];
			float fTemp1 = 5.46f * (fRec6[0] + 1.0f + -1.0f);
			float fTemp2 = 0.6f * float(input0[i0]) * fTemp0 + fTemp1;
			fVec0[0] = fTemp2;
			float fTemp3 = std::fabs(fTemp2);
			float fTemp4 = float((fTemp2 > 0.0f) - (fTemp2 < 0.0f));
			float fTemp5 = ((fTemp3 > 0.6f) ? fTemp2 : 0.6f * fTemp4);
			float fTemp6 = 0.6f * float((fTemp5 > 0.0f) - (fTemp5 < 0.0f)) - fTemp5;
			fVec1[0] = fTemp6;
			fRec4[0] = 7.250317f * (fTemp6 + fVec1[1]) - 0.45006347f * fRec4[1];
			...
			float fTemp7 = ((fTemp3 > 2.994f) ? fTemp2 : 2.994f * fTemp4);
			float fTemp8 = 2.994f * float((fTemp7 > 0.0f) - (fTemp7 < 0.0f)) - fTemp7;
			fVec2[0] = fTemp8;
			fRec9[0] = 7.5879817f * (fTemp8 + fVec2[1]) - 0.45006347f * fRec9[1];
			...
			float fTemp9 = ((fTemp3 > 5.46f) ? fTemp2 : 5.46f * fTemp4);
			float fTemp10 = 5.46f * float((fTemp9 > 0.0f) - (fTemp9 < 0.0f)) - fTemp9;
			fVec3[0] = fTemp10;
			fRec12[0] = 4.394902f * (fTemp10 + fVec3[1]) - 0.45006347f * fRec12[1];
			...
			float fTemp11 = ((fTemp3 > 1.8f) ? fTemp2 : 1.8f * fTemp4);
			...
			float fTemp13 = ((fTemp3 > 4.08f) ? fTemp2 : 4.08f * fTemp4);
			...
			float fTemp15 = 1.4511472f * (fRec2[1] + fRec7[1] + fRec10[1] + fRec13[1] + fRec16[1] + fRec19[1]) + 0.7255736f * (fRec2[0] + fRec2[2] + fRec7[0] + fRec7[2] + fRec10[0] + fRec10[2] + fRec13[0] + fRec13[2] + fRec16[0] + fRec16[2] + fRec19[0] + fRec19[2]);
			fVec6[0] = fTemp15;
			...
			float fTemp20 = fTemp19 * (1.0f - 0.33333334f * _b259wf_faustpower2_f(fTemp19));
			fVec7[0] = fTemp20;
			fRec0[0] = fConst2 * (fTemp20 - fVec7[1] + fConst5 * fRec0[1]);
			output0[i0] = FAUSTFLOAT(fRec0[0]);
			float fTemp21 = fTemp1 + 0.6f * float(input1[i0]) * fTemp0;
			fVec8[0] = fTemp21;
			float fTemp22 = std::fabs(fTemp21);
			float fTemp23 = float((fTemp21 > 0.0f) - (fTemp21 < 0.0f));
			float fTemp24 = ((fTemp22 > 0.6f) ? fTemp21 : 0.6f * fTemp23);
			float fTemp25 = 0.6f * float((fTemp24 > 0.0f) - (fTemp24 < 0.0f)) - fTemp24;
			fVec9[0] = fTemp25;
			fRec27[0] = 7.250317f * (fTemp25 + fVec9[1]) - 0.45006347f * fRec27[1];
			...
			float fTemp26 = ((fTemp22 > 2.994f) ? fTemp21 : 2.994f * fTemp23);
			float fTemp27 = 2.994f * float((fTemp26 > 0.0f) - (fTemp26 < 0.0f)) - fTemp26;
			fVec10[0] = fTemp27;
			fRec30[0] = 7.5879817f * (fTemp27 + fVec10[1]) - 0.45006347f * fRec30[1];
			...
			float fTemp28 = ((fTemp22 > 5.46f) ? fTemp21 : 5.46f * fTemp23);
			float fTemp29 = 5.46f * float((fTemp28 > 0.0f) - (fTemp28 < 0.0f)) - fTemp28;
			fVec11[0] = fTemp29;
			fRec33[0] = 4.394902f * (fTemp29 + fVec11[1]) - 0.45006347f * fRec33[1];
			...
			float fTemp30 = ((fTemp22 > 1.8f) ? fTemp21 : 1.8f * fTemp23);
			...
			float fTemp32 = ((fTemp22 > 4.08f) ? fTemp21 : 4.08f * fTemp23);
			...
			fVec14[0] = fTemp34;
			fRec24[0] = -((fTemp17 * fRec24[1] - (fTemp34 + fVec14[1])) / fTemp18);
			float fTemp35 = std::max<float>(-1.0f, std::min<float>(1.0f, 0.16666667f * fRec24[0]));
			float fTemp36 = fTemp35 * (1.0f - 0.33333334f * _b259wf_faustpower2_f(fTemp35));
			fVec15[0] = fTemp36;
	...
	#define FAUST_FILE_NAME "b259wf.dsp"
	#define FAUST_CLASS_NAME "_b259wf"
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -nvi -ct 1 -cn _b259wf -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
	#define FAUST_INPUTS 2
	#define FAUST_OUTPUTS 2
	#define FAUST_ACTIVES 3
	#define FAUST_PASSIVES 0

	FAUST_ADDHORIZONTALSLIDER("fold", fHslider0, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("lowpass", fHslider2, 0.0f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("offset", fHslider1, 0.0f, -1.0f, 1.0f, 0.001f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, fold, "fold", fHslider0, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, lowpass, "lowpass", fHslider2, 0.0f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, offset, "offset", fHslider1, 0.0f, -1.0f, 1.0f, 0.001f) \
