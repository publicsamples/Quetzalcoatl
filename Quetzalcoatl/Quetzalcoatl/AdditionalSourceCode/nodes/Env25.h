...
using input_toggle_t = control::input_toggle<NV, 
                                             parameter::plain<flex_ahdsr_t<NV>, 0>>;
template <int NV>
using tempo_sync_t = wrap::mod<parameter::plain<input_toggle_t<NV>, 2>, 
...
using input_toggle3_t = control::input_toggle<NV, 
                                              parameter::plain<flex_ahdsr_t<NV>, 1>>;
template <int NV>
using tempo_sync3_t = wrap::mod<parameter::plain<input_toggle3_t<NV>, 2>, 
                                control::tempo_sync<NV>>;
...
template <int NV>
using tempo_sync2_mod = parameter::plain<control::input_toggle<NV, parameter::empty>, 
                                         2>;
template <int NV>
...
using input_toggle1_t = control::input_toggle<NV, 
                                              parameter::plain<flex_ahdsr_t<NV>, 4>>;
template <int NV>
using tempo_sync1_t = wrap::mod<parameter::plain<input_toggle1_t<NV>, 2>, 
                                control::tempo_sync<NV>>;
...
template <int NV> using chain7_t = chain6_t<NV>;

template <int NV> using chain8_t = chain6_t<NV>;
template <int NV>
...
using peak_mod = parameter::chain<ranges::Identity, 
                                  ...
                                  parameter::plain<flex_ahdsr_t<NV>, 3>>;
...
template <int NV>
using cable_table3_mod = parameter::chain<ranges::Identity, 
                                          parameter::plain<flex_ahdsr_t<NV>, 8>, 
                                          parameter::plain<flex_ahdsr_t<NV>, 9>>;
...
template <int NV> using chain9_t = chain6_t<NV>;
...
template <int NV>
using wrapmidi1_t_ = container::chain<parameter::empty, 
                                      wrap::fix<1, midi_t<NV>>>;

template <int NV>
using wrapmidi1_t = wrap::event<wrapmidi1_t_<NV>>;
...
template <int NV>
using cable_table2_t = wrap::data<control::cable_table<parameter::plain<pma_t<NV>, 2>>, 
...
template <int NV>
using peak1_t = wrap::mod<parameter::plain<routing::event_data_writer<NV>, 1>, 
                          wrap::no_data<core::peak>>;

template <int NV>
using wrapevent_data_writer2_t_ = container::chain<parameter::empty, 
                                                   wrap::fix<1, routing::event_data_writer<NV>>>;

template <int NV>
using wrapevent_data_writer2_t = wrap::event<wrapevent_data_writer2_t_<NV>>;
...
using chain5_t = container::chain<parameter::empty, 
                                  ...
                                  core::gain<NV>, 
                                  peak1_t<NV>, 
                                  wrapevent_data_writer2_t<NV>, 
                                  envelope::voice_manager>;

namespace Env25_t_parameters
{
// Parameter list for Env25_impl::Env25_t ----------------------------------------------------------

template <int NV>
using d = parameter::chain<ranges::Identity, 
                           parameter::plain<control::input_toggle<NV, parameter::empty>, 1>, 
                           parameter::plain<Env25_impl::flex_ahdsr_t<NV>, 2>>;

template <int NV>
using Sync = parameter::chain<ranges::Identity, 
                              parameter::plain<Env25_impl::input_toggle_t<NV>, 0>, 
                              parameter::plain<Env25_impl::input_toggle3_t<NV>, 0>, 
                              parameter::plain<control::input_toggle<NV, parameter::empty>, 0>, 
                              parameter::plain<Env25_impl::input_toggle1_t<NV>, 0>>;

DECLARE_PARAMETER_RANGE_STEP(Loop_1Range, 
                             0., 
                             2., 
                             1.);

template <int NV>
using Loop_1 = parameter::from0To1<Env25_impl::flex_ahdsr_t<NV>, 
                                   5, 
                                   Loop_1Range>;
...
template <int NV>
using StepSmooth = parameter::from0To1<Env25_impl::smoothed_parameter_t<NV>, 
                                       1, 
                                       StepSmoothRange>;

template <int NV>
using EnvDiv = parameter::chain<ranges::Identity, 
                                parameter::plain<Env25_impl::tempo_sync_t<NV>, 1>, 
                                parameter::plain<Env25_impl::tempo_sync3_t<NV>, 1>, 
                                parameter::plain<Env25_impl::tempo_sync2_t<NV>, 1>, 
                                parameter::plain<Env25_impl::tempo_sync1_t<NV>, 1>, 
                                parameter::plain<Env25_impl::tempo_sync4_t<NV>, 1>>;

template <int NV>
using Vel = parameter::chain<ranges::Identity, 
                             parameter::plain<Env25_impl::cable_table2_t<NV>, 0>, 
                             parameter::plain<Env25_impl::pma_t<NV>, 1>>;

template <int NV>
using Curver = parameter::chain<ranges::Identity, 
                                parameter::plain<Env25_impl::cable_table3_t<NV>, 0>, 
                                parameter::plain<Env25_impl::flex_ahdsr_t<NV>, 7>>;

template <int NV>
using a = parameter::plain<Env25_impl::input_toggle_t<NV>, 
                           1>;
template <int NV>
using aClk = parameter::plain<Env25_impl::tempo_sync_t<NV>, 
                              0>;
template <int NV>
using h = parameter::plain<Env25_impl::input_toggle3_t<NV>, 
                           1>;
template <int NV>
using hClk = parameter::plain<Env25_impl::tempo_sync3_t<NV>, 
                              0>;
template <int NV>
using dClk = parameter::plain<Env25_impl::tempo_sync2_t<NV>, 
                              0>;
template <int NV>
using s = parameter::plain<math::add<NV>, 0>;
template <int NV>
using r = parameter::plain<Env25_impl::input_toggle1_t<NV>, 
                           1>;
template <int NV>
using rClk = parameter::plain<Env25_impl::tempo_sync1_t<NV>, 
                              0>;
template <int NV>
using StepTempo = parameter::plain<Env25_impl::tempo_sync4_t<NV>, 
                                   0>;
template <int NV>
using stage = parameter::plain<routing::event_data_writer<NV>, 
                               0>;
template <int NV>
using SusMode = parameter::plain<Env25_impl::branch1_t<NV>, 
                                 0>;
using Steps = parameter::plain<Env25_impl::pack_resizer_t, 
                               0>;
template <int NV>
using Env25_t_plist = parameter::list<a<NV>, 
                                      aClk<NV>, 
                                      h<NV>, 
                                      hClk<NV>, 
                                      d<NV>, 
...
template <int NV>
using Env25_t_ = container::chain<Env25_t_parameters::Env25_t_plist<NV>, 
                                  wrap::fix<1, chain5_t<NV>>>;

// =================================| Root node initialiser class |=================================

template <int NV> struct instance: public Env25_impl::Env25_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ID(Env25);
		SNEX_METADATA_NUM_CHANNELS(1);
		SNEX_METADATA_ENCODED_PARAMETERS(308)
		{
			0x025C, 0x0000, 0x0000, 0x0061, 0x0000, 0x0000, 0x0000, 0xEA60, 
            0x1F46, 0x1B85, 0xEE40, 0x830C, 0x003E, 0x0000, 0x5C00, 0x0100, 
            0x0000, 0x6100, 0x6C43, 0x006B, 0x0000, 0x0000, 0x0000, 0x9000, 
            0x0041, 0x0000, 0x0000, 0x8000, 0x003F, 0x8000, 0x5C3F, 0x0202, 
            0x0000, 0x6800, 0x0000, 0x0000, 0x0000, 0x6000, 0x46EA, 0x0000, 
            0x0000, 0x0CEE, 0x3E83, 0x0000, 0x0000, 0x005C, 0x0003, 0x0000, 
            0x4368, 0x6B6C, 0x0000, 0x0000, 0x0000, 0x0000, 0x4190, 0x0000, 
            0x4190, 0x0000, 0x3F80, 0x0000, 0x3F80, 0x025C, 0x0004, 0x0000, 
            0x0064, 0x0000, 0x0000, 0x0000, 0xEA60, 0x5246, 0x7BB8, 0xEE46, 
            0x830C, 0x003E, 0x0000, 0x5C00, 0x0500, 0x0000, 0x6400, 0x6C43, 
            0x006B, 0x0000, 0x0000, 0x0000, 0x9000, 0x0041, 0x8000, 0x003F, 
            0x8000, 0x003F, 0x8000, 0x5C3F, 0x0600, 0x0000, 0x7300, 0x0000, 
            0x0000, 0x0000, 0x0000, 0x3F80, 0x0000, 0x0000, 0x0000, 0x3F80, 
            0x0000, 0x0000, 0x025C, 0x0007, 0x0000, 0x0072, 0x0000, 0x0000, 
            0x0000, 0xEA60, 0xB846, 0x4E3B, 0xEE46, 0x830C, 0x003E, 0x0000, 
            0x5C00, 0x0800, 0x0000, 0x7200, 0x6C43, 0x006B, 0x0000, 0x0000, 
            0x0000, 0x9000, 0x0041, 0x0000, 0x0000, 0x8000, 0x003F, 0x8000, 
            0x5C3F, 0x0900, 0x0000, 0x5300, 0x6E79, 0x0063, 0x0000, 0x0000, 
            0x0000, 0x8000, 0x003F, 0x0000, 0x0000, 0x8000, 0x003F, 0x8000, 
            0x5C3F, 0x0A00, 0x0000, 0x4C00, 0x6F6F, 0x0070, 0x0000, 0x0000, 
            0x0000, 0x8000, 0x003F, 0x0000, 0x0000, 0x8000, 0x003F, 0x8000, 
            0x5C3F, 0x0B00, 0x0000, 0x5300, 0x6574, 0x5370, 0x6F6D, 0x746F, 
            0x0068, 0x0000, 0x0000, 0x0000, 0x8000, 0x003F, 0x0000, 0x0000, 
            0x8000, 0x003F, 0x0000, 0x5C00, 0x0C00, 0x0000, 0x5300, 0x6574, 
            0x5470, 0x6D65, 0x6F70, 0x0000, 0x0000, 0x0000, 0x0000, 0x4190, 
            0x0000, 0x4190, 0x0000, 0x3F80, 0x0000, 0x3F80, 0x005C, 0x000D, 
            0x0000, 0x6E45, 0x4476, 0x7669, 0x0000, 0x0000, 0x3F80, 0x0000, 
            0x4200, 0x0000, 0x41A8, 0x0000, 0x3F80, 0x0000, 0x3F80, 0x005C, 
            0x000E, 0x0000, 0x7473, 0x6761, 0x0065, 0x0000, 0x0000, 0x0000, 
            0xE000, 0x0040, 0x0000, 0x0000, 0x8000, 0x003F, 0x8000, 0x5C3F, 
            0x0F00, 0x0000, 0x5300, 0x7375, 0x6F4D, 0x6564, 0x0000, 0x0000, 
            0x0000, 0x0000, 0x4000, 0x0000, 0x4000, 0x0000, 0x3F80, 0x0000, 
            0x3F80, 0x005C, 0x0010, 0x0000, 0x7453, 0x7065, 0x0073, 0x0000, 
            0x0000, 0x0040, 0x0000, 0x0042, 0x0000, 0x0041, 0x8000, 0x003F, 
            0x8000, 0x5C3F, 0x1100, 0x0000, 0x5600, 0x6C65, 0x0000, 0x0000, 
            0x0000, 0x0000, 0x3F80, 0x0000, 0x0000, 0x0000, 0x3F80, 0x0000, 
            0x0000, 0x005C, 0x0012, 0x0000, 0x7543, 0x7672, 0x7265, 0x0000, 
            0x0000, 0x0000, 0x0000, 0x3F80, 0x9DB3, 0x3EFD, 0x0000, 0x3F80, 
	...
	instance()
	{
		...
		this->getParameterT(0).connectT(0, input_toggle); // a -> input_toggle::Value1
		
		this->getParameterT(1).connectT(0, tempo_sync); // aClk -> tempo_sync::Tempo
		
		this->getParameterT(2).connectT(0, input_toggle3); // h -> input_toggle3::Value1
		
		this->getParameterT(3).connectT(0, tempo_sync3); // hClk -> tempo_sync3::Tempo
		
		auto& d_p = this->getParameterT(4);
		d_p.connectT(0, input_toggle2); // d -> input_toggle2::Value1
		d_p.connectT(1, flex_ahdsr);    // d -> flex_ahdsr::Decay
		
		this->getParameterT(5).connectT(0, tempo_sync2); // dClk -> tempo_sync2::Tempo
		
		this->getParameterT(6).connectT(0, add3); // s -> add3::Value
		
		this->getParameterT(7).connectT(0, input_toggle1); // r -> input_toggle1::Value1
		
		this->getParameterT(8).connectT(0, tempo_sync1); // rClk -> tempo_sync1::Tempo
		
		auto& Sync_p = this->getParameterT(9);
		Sync_p.connectT(0, input_toggle);  // Sync -> input_toggle::Input
		Sync_p.connectT(1, input_toggle3); // Sync -> input_toggle3::Input
		Sync_p.connectT(2, input_toggle2); // Sync -> input_toggle2::Input
		Sync_p.connectT(3, input_toggle1); // Sync -> input_toggle1::Input
		...
		this->getParameterT(12).connectT(0, tempo_sync4); // StepTempo -> tempo_sync4::Tempo
		
		auto& EnvDiv_p = this->getParameterT(13);
		EnvDiv_p.connectT(0, tempo_sync);  // EnvDiv -> tempo_sync::Multiplier
		EnvDiv_p.connectT(1, tempo_sync3); // EnvDiv -> tempo_sync3::Multiplier
		EnvDiv_p.connectT(2, tempo_sync2); // EnvDiv -> tempo_sync2::Multiplier
		EnvDiv_p.connectT(3, tempo_sync1); // EnvDiv -> tempo_sync1::Multiplier
		EnvDiv_p.connectT(4, tempo_sync4); // EnvDiv -> tempo_sync4::Multiplier
		
		this->getParameterT(14).connectT(0, event_data_writer); // stage -> event_data_writer::SlotIndex
		
		this->getParameterT(15).connectT(0, branch1); // SusMode -> branch1::Index
		
		this->getParameterT(16).connectT(0, pack_resizer); // Steps -> pack_resizer::NumSliders
		
		auto& Vel_p = this->getParameterT(17);
		Vel_p.connectT(0, cable_table2); // Vel -> cable_table2::Value
		Vel_p.connectT(1, pma);          // Vel -> pma::Multiply
		
		auto& Curver_p = this->getParameterT(18);
		Curver_p.connectT(0, cable_table3); // Curver -> cable_table3::Value
		Curver_p.connectT(1, flex_ahdsr);   // Curver -> flex_ahdsr::AttackCurve
		
		// Modulation Connections ------------------------------------------------------------------
		
		auto& flex_ahdsr_p = flex_ahdsr.getWrappedObject().getParameter();
		flex_ahdsr_p.getParameterT(0).connectT(0, add);                               // flex_ahdsr -> add::Value
		flex_ahdsr_p.getParameterT(1).connectT(0, voice_manager);                     // flex_ahdsr -> voice_manager::KillVoice
		input_toggle.getWrappedObject().getParameter().connectT(0, flex_ahdsr);       // input_toggle -> flex_ahdsr::Attack
		tempo_sync.getParameter().connectT(0, input_toggle);                          // tempo_sync -> input_toggle::Value2
		input_toggle3.getWrappedObject().getParameter().connectT(0, flex_ahdsr);      // input_toggle3 -> flex_ahdsr::Hold
		tempo_sync3.getParameter().connectT(0, input_toggle3);                        // tempo_sync3 -> input_toggle3::Value2
		tempo_sync2.getParameter().connectT(0, input_toggle2);                        // tempo_sync2 -> input_toggle2::Value2
		input_toggle1.getWrappedObject().getParameter().connectT(0, flex_ahdsr);      // input_toggle1 -> flex_ahdsr::Release
		tempo_sync1.getParameter().connectT(0, input_toggle1);                        // tempo_sync1 -> input_toggle1::Value2
		...
		cable_table3.getWrappedObject().getParameter().connectT(1, flex_ahdsr);       // cable_table3 -> flex_ahdsr::ReleaseCurve
		pma.getWrappedObject().getParameter().connectT(0, gain);                      // pma -> gain::Gain
		midi.getParameter().connectT(0, pma);                                         // midi -> pma::Value
		cable_table2.getWrappedObject().getParameter().connectT(0, pma);              // cable_table2 -> pma::Add
		peak1.getParameter().connectT(0, event_data_writer);                          // peak1 -> event_data_writer::Value
		...
		;                                // flex_ahdsr::AttackCurve is automated
		;                                // flex_ahdsr::DecayCurve is automated
		;                                // flex_ahdsr::ReleaseCurve is automated
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(0).getT(8).setExternalData(b, index);                  // Env25_impl::cable_table4_t
		this->getT(0).getT(11).setExternalData(b, index);                 // Env25_impl::peak1_t<NV>
	}
};
}
...
template <int NV>
using Env25 = wrap::node<Env25_impl::instance<NV>>;
}
