...
const var FmModA1 = Synth.getModulator("FmModA1");
const var FmModA2 = Synth.getModulator("FmModA2");
const var FmModA3 = Synth.getModulator("FmModA3");
const var FmModA4 = Synth.getModulator("FmModA4");
const var FmModA5 = Synth.getModulator("FmModA5");
const var FmModA6 = Synth.getModulator("FmModA6");
const var FmModA7 = Synth.getModulator("FmModA7");
const var FmModA8 = Synth.getModulator("FmModA8");
{
...
{
	FmModA1.setIntensity(value);
	FmModA2.setIntensity(value);
	FmModA3.setIntensity(value);
	FmModA4.setIntensity(value);
	FmModA5.setIntensity(value);
	FmModA6.setIntensity(value);
	FmModA7.setIntensity(value);
	FmModA8.setIntensity(value);
...
const var FmModB1 = Synth.getModulator("FmModB1");
const var FmModB2 = Synth.getModulator("FmModB2");
const var FmModB3 = Synth.getModulator("FmModB3");
const var FmModB4 = Synth.getModulator("FmModB4");
const var FmModB5 = Synth.getModulator("FmModB5");
const var FmModB6 = Synth.getModulator("FmModB6");
const var FmModB7 = Synth.getModulator("FmModB7");
const var FmModB8 = Synth.getModulator("FmModB8");
{
...
{
	FmModB1.setIntensity(value);
	FmModB2.setIntensity(value);
	FmModB3.setIntensity(value);
	FmModB4.setIntensity(value);
	FmModB5.setIntensity(value);
	FmModB6.setIntensity(value);
	FmModB7.setIntensity(value);
	FmModB8.setIntensity(value);
